--------------------------------------------------------
--  DDL for Table WRMS$_SNAPSHOT
--------------------------------------------------------

  CREATE TABLE "SYS"."WRMS$_SNAPSHOT" SHARING=METADATA 
   (	"SNAP_ID" NUMBER, 
	"DBID" NUMBER, 
 ...
 NOCOMPRESS LOGGING
  TABLESPACE "SYSTEM" ;
  GRANT DELETE ON "SYS"."WRMS$_SNAPSHOT" TO "SYSUMF_ROLE";
  GRANT INSERT ON "SYS"."WRMS$_SNAPSHOT" TO "SYSUMF_ROLE";
  GRANT SELECT ON "SYS"."WRMS$_SNAPSHOT" TO "SYSUMF_ROLE";
  GRANT UPDATE ON "SYS"."WRMS$_SNAPSHOT" TO "SYSUMF_ROLE";
