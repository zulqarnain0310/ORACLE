--------------------------------------------------------
--  DDL for Table KU$_DATAPUMP_MASTER_12_2
--------------------------------------------------------

  CREATE GLOBAL TEMPORARY TABLE "SYS"."KU$_DATAPUMP_MASTER_12_2" SHARING=METADATA 
   (	"ABORT_STEP" NUMBER, 
 ...
 LOB ("XML_CLOB") STORE AS BASICFILE (
  ENABLE STORAGE IN ROW CHUNK 8192 RETENTION 
  NOCACHE ) ;
  GRANT DELETE ON "SYS"."KU$_DATAPUMP_MASTER_12_2" TO PUBLIC;
  GRANT INSERT ON "SYS"."KU$_DATAPUMP_MASTER_12_2" TO PUBLIC;
  GRANT SELECT ON "SYS"."KU$_DATAPUMP_MASTER_12_2" TO PUBLIC;
  GRANT UPDATE ON "SYS"."KU$_DATAPUMP_MASTER_12_2" TO PUBLIC;
