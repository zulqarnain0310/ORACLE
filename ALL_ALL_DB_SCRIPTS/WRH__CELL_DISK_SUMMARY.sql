--------------------------------------------------------
--  DDL for Table WRH$_CELL_DISK_SUMMARY
--------------------------------------------------------

  CREATE TABLE "SYS"."WRH$_CELL_DISK_SUMMARY" SHARING=METADATA 
   (	"SNAP_ID" NUMBER, 
	"DBID" NUMBER, 
	"CELL_HASH" NUMBER, 
 ...
 (PARTITION "WRH$_CELL_DISK_SUMMARY_692950692_0"  VALUES LESS THAN (692950692, MAXVALUE) 
  PCTFREE 1 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING 
  STORAGE(
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
 ...
 NOCOMPRESS LOGGING 
  ...
  GRANT DELETE ON "SYS"."WRH$_CELL_DISK_SUMMARY" TO "SYSUMF_ROLE";
  GRANT INSERT ON "SYS"."WRH$_CELL_DISK_SUMMARY" TO "SYSUMF_ROLE";
  GRANT SELECT ON "SYS"."WRH$_CELL_DISK_SUMMARY" TO "SYSUMF_ROLE";
  GRANT UPDATE ON "SYS"."WRH$_CELL_DISK_SUMMARY" TO "SYSUMF_ROLE";
