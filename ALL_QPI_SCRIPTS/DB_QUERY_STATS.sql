--------------------------------------------------------
--  DDL for View DB_QUERY_STATS
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "QPI_RBL_MISDB_PROD"."DB_QUERY_STATS" ("TEXT", "PARAMS", "EXECUTION_TYPE_DESC", "QUERY_ID", "COUNT_EXECUTIONS", "DURATION_S", "CPU_TIME_MS", "WAIT_TIME_MS", "LOG_BYTES_USED_KB", "LOGICAL_IO_READS_KB", "LOGICAL_IO_WRITES_KB", "PHYSICAL_IO_READS_KB", "CLR_TIME_MS", "START_TIME", "QUERY_HASH") AS 
