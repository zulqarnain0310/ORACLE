...
BEGIN
   ...
   IF tt_DimThresholdMaster  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_DimThresholdMaster;
   UTILS.IDENTITY_RESET('tt_DimThresholdMaster');

   INSERT INTO tt_DimThresholdMaster ( 
   ...
   FROM A ,tt_DimThresholdMaster A
          JOIN ( SELECT tt_DimThresholdMaster.Location ,
                        tt_DimThresholdMaster.LocationCode ,
                        tt_DimThresholdMaster.MasterNameAlt_Key ,
                        MAX(tt_DimThresholdMaster.EffectiveDt)  EffectiveDt  
                 FROM tt_DimThresholdMaster 
                   GROUP BY tt_DimThresholdMaster.Location,tt_DimThresholdMaster.LocationCode,tt_DimThresholdMaster.MasterNameAlt_Key ) B   ON A.Location = B.Location
   ...
   OPEN  v_cursor FOR
      SELECT Threshold_SetId ,
        ...
        FROM ALERT_RBL_MISDB_PROD.DImMasterName M
               LEFT JOIN tt_DimThresholdMaster D   ON M.MasterNameAlt_Key = D.MasterNameAlt_Key
