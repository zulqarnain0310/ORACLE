   ...
   BEGIN
      ...
      BEGIN
         ...
         ELSE
            ...
            BEGIN
               IF utils.object_id('TempDB..tt_temp16') IS NOT NULL THEN
                EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_temp16 ';
               END IF;
               DELETE FROM tt_temp16;
               UTILS.IDENTITY_RESET('tt_temp16');

               INSERT INTO tt_temp16 ( 
               	SELECT A.SourceAlt_Key ,
                       SourceName ,
                       ACBUSegmentCode ,
                       ACBUSegmentDescription ,
            ...
            ELSE
               ...
               BEGIN
                  IF utils.object_id('TempDB..tt_temp20') IS NOT NULL THEN
                   EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_temp20 ';
                  END IF;
                  DELETE FROM tt_temp20;
                  UTILS.IDENTITY_RESET('tt_temp20');

                  INSERT INTO tt_temp20 ( 
                  	SELECT A.SourceAlt_Key ,
                          SourceName ,
                          ACBUSegmentCode ,
                          ACBUSegmentDescription ,
