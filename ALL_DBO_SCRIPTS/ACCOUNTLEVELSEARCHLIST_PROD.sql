...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         IF tt_ACCOUNT_PREMOC_4  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_ACCOUNT_PREMOC_4;
         UTILS.IDENTITY_RESET('tt_ACCOUNT_PREMOC_4');

         INSERT INTO tt_ACCOUNT_PREMOC_4 ( 
         	SELECT * 
         	  FROM ( SELECT AccountEntityId ,
                 ...
                 X );
         ----POST 
         --Select 'tt_ACCOUNT_PREMOC_4',* from tt_ACCOUNT_PREMOC_4
         IF  --SQLDEV: NOT RECOGNIZED
         IF tt_ACCOUNT_POSTMOC_4  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_ACCOUNT_POSTMOC_4;
         UTILS.IDENTITY_RESET('tt_ACCOUNT_POSTMOC_4');

         INSERT INTO tt_ACCOUNT_POSTMOC_4 ( 
         	SELECT AccountEntityId ,
                 AccountID AccountID  ,
                 0 CustomerEntityID  ,
                 POS Balance  ,
         ...
         --and  ISNULL(ScreenFlag,'')=CASE WHEN @OperationFlag =2   THEN 'U' 
         --                              When @AuthorisationStatus  in('MP','1A') THEN 'U' END
         --Select 'tt_ACCOUNT_POSTMOC_4' ,* from tt_ACCOUNT_POSTMOC_4
         ...
         BEGIN
            OPEN  v_cursor FOR
               SELECT A.AccountID ,
                      ...
                      A.SourceSystem 
                 FROM tt_ACCOUNT_PREMOC_4 A
                        LEFT JOIN tt_ACCOUNT_POSTMOC_4 B   ON A.AccountID = b.AccountID
         ...
         IF utils.object_id('tempdb..tt_MOCAuthorisation_4') IS NOT NULL THEN

         BEGIN
            EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_MOCAuthorisation_4 ';

         END;
         END IF;
         DELETE FROM tt_MOCAuthorisation_4;
         UTILS.IDENTITY_RESET('tt_MOCAuthorisation_4');

         INSERT INTO tt_MOCAuthorisation_4 ( 
         	SELECT * ,
         ...
         --Select ' tt_MOCAuthorisation_4',* from  tt_MOCAuthorisation_4
         --where abc=1
         UPDATE tt_MOCAuthorisation_4 V
         ...
         ;
         MERGE INTO tt_MOCAuthorisation_4 Z
         ...
         FROM CustomerLevelMOC_Mod V
                ...
                JOIN tt_MOCAuthorisation_4 Z   ON X.CustomerACID = Z.AccountID 
