...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         BEGIN
            IF utils.object_id('TempDB..tt_temp_17') IS NOT NULL THEN
         ...
         ELSE
            ...
            BEGIN
               IF utils.object_id('TempDB..tt_temp_1716') IS NOT NULL THEN
                EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_temp16_10 ';
               END IF;
               DELETE FROM tt_temp16_10;
               UTILS.IDENTITY_RESET('tt_temp16_10');

               INSERT INTO tt_temp16_10 ( 
               	SELECT A.BankRPAlt_Key ,
                       A.BankCode ,
                       A.BankName ,
                       A.AuthorisationStatus ,
            ...
            ELSE
               ...
               BEGIN
                  IF utils.object_id('TempDB..tt_temp_1720') IS NOT NULL THEN
                   EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_temp20_10 ';
                  END IF;
                  DELETE FROM tt_temp20_10;
                  UTILS.IDENTITY_RESET('tt_temp20_10');

                  INSERT INTO tt_temp20_10 ( 
                  	SELECT A.BankRPAlt_Key ,
                          A.BankCode ,
                          A.BankName ,
                          A.AuthorisationStatus ,
