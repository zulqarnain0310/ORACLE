--------------------------------------------------------
--  DDL for Procedure ACCOUNTPREPOSDETAILS_SELECTLIST
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" 
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         IF tt_ACCOUNT_PREMOC_6  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_ACCOUNT_PREMOC_6;
         UTILS.IDENTITY_RESET('tt_ACCOUNT_PREMOC_6');

         INSERT INTO tt_ACCOUNT_PREMOC_6 ( 
         	SELECT * 
         ...
         IF  --SQLDEV: NOT RECOGNIZED
         IF tt_ACCOUNT_POSTMOC_6  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_ACCOUNT_POSTMOC_6;
         UTILS.IDENTITY_RESET('tt_ACCOUNT_POSTMOC_6');

         INSERT INTO tt_ACCOUNT_POSTMOC_6 ( 
         	SELECT AccountEntityId ,
                 AccountID AccountID  ,
                 POS Balance  ,
                 InterestReceivable ,
         ...
         OPEN  v_cursor FOR
            SELECT A.CustomerACID AccountID  ,
              ...
              FROM tt_ACCOUNT_PREMOC_6 A
                     LEFT JOIN tt_ACCOUNT_POSTMOC_6 B   ON A.AccountID = B.AccountID
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST" TO "ADF_CDR_RBL_STGDB";
