--------------------------------------------------------
--  DDL for Procedure ADHOCACCOUNTLEVELSEARCHLIST
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" 
...
BEGIN
   ...
   IF tt_CUSTOMERCAL_HIST_6  --SQLDEV: NOT RECOGNIZED
   ...
   BEGIN
      ...
      BEGIN
         ...
         BEGIN
            DELETE FROM tt_tmp21_3;
            UTILS.IDENTITY_RESET('tt_tmp21_3');

            INSERT INTO tt_tmp21_3 SELECT * 
         ...
         BEGIN
            ...
            BEGIN
               DELETE FROM tt_tmp22;
               UTILS.IDENTITY_RESET('tt_tmp22');

               INSERT INTO tt_tmp22 SELECT * 
                    FROM ( SELECT C.CustomerId CustomerId  ,
                                  C.UCIF_ID UCICID_Existing  ,
                                  C.AssetClassAlt_Key AssetClassAlt_Key_Existing  ,
                                  C.NPA_Date NPADate_Existing  ,
         ...
         BEGIN
            ...
            BEGIN
               ...
               BEGIN
                  ...
                  DELETE FROM tt_tmp_3;
                  UTILS.IDENTITY_RESET('tt_tmp_3');

                  INSERT INTO tt_tmp_3 SELECT * 
                       FROM ( SELECT C.CustomerId CustomerId  ,
                                     C.UCIF_ID UCICID_Existing  ,
                                     C.AssetClassAlt_Key AssetClassAlt_Key_Existing  ,
                                     C.NPA_Date NPADate_Existing  ,
               ...
               END;
               END IF;
               --Select 'tt_tmp_3',* from tt_tmp_3
               DELETE FROM tt_tmp1;
               UTILS.IDENTITY_RESET('tt_tmp1');

               INSERT INTO tt_tmp1 SELECT * 
               ...
               --Select 'tt_tmp_3',* from tt_tmp_3
               --Select 'tt_tmp_31',* from tt_tmp_31
               IF utils.object_id('TempDB..tt_tmp_3') IS NOT NULL THEN
                OPEN  v_cursor FOR
                  SELECT A.* ,
                         B.* 
                    FROM tt_tmp1 B
                           LEFT JOIN tt_tmp_3 A   ON A.UCICID_Existing = B.UCICID_Modified ;
                  DBMS_SQL.RETURN_RESULT(v_cursor);
               ELSE
                  OPEN  v_cursor FOR
                     SELECT A.* ,
                            B.* 
                       FROM tt_tmp1 B
                              LEFT JOIN tt_tmp_1 A   ON A.UCICID_Existing = B.UCICID_Modified ;
                     DBMS_SQL.RETURN_RESULT(v_cursor);
               END IF;
         ...
         BEGIN
            ...
            BEGIN
               ...
               BEGIN
                  ...
                  DELETE FROM tt_tmp2_8;
                  UTILS.IDENTITY_RESET('tt_tmp2_8');

                  INSERT INTO tt_tmp2_8 SELECT * 
               ...
               END IF;
               DELETE FROM tt_tmp3;
               UTILS.IDENTITY_RESET('tt_tmp3');

               INSERT INTO tt_tmp3 SELECT * 
               ...
               --Select 'tt_tmp_3_2',* from tt_tmp_3_2
               --Select 'tt_tmp_33',* from tt_tmp_33
               IF utils.object_id('TempDB..tt_tmp_32') IS NOT NULL THEN
               ...
               BEGIN
                  ...
                  OPEN  v_cursor FOR
                     SELECT C.* ,
                            D.* 
                       FROM tt_tmp3 D
                              LEFT JOIN tt_tmp2_8 C   ON C.UCICID_Existing = D.UCICID_Modified ;
                     DBMS_SQL.RETURN_RESULT(v_cursor);
               ...
               BEGIN
                  ...
                  OPEN  v_cursor FOR
                     SELECT C.* ,
                            D.* 
                       FROM tt_tmp3 D
                              LEFT JOIN tt_tmp_2 C   ON C.UCICID_Existing = D.UCICID_Modified ;
                     DBMS_SQL.RETURN_RESULT(v_cursor);
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOCACCOUNTLEVELSEARCHLIST" TO "ADF_CDR_RBL_STGDB";
