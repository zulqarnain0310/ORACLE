...
BEGIN
   ...
   /* CALCULATE MAX DPD */
   IF utils.object_id('TEMPDB..tt_TEMPTABLE_7') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TEMPTABLE_7 ';
   END IF;
   DELETE FROM tt_TEMPTABLE_7;
   UTILS.IDENTITY_RESET('tt_TEMPTABLE_7');

   INSERT INTO tt_TEMPTABLE_7 ( 
