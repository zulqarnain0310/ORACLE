...
BEGIN
   ...
   BEGIN
      ...
      -----==========================================
      IF ( utils.object_id('tempdb..tt_PostMOC') IS NOT NULL ) THEN
       EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_PostMOC ';
      END IF;
      DELETE FROM tt_PostMOC;
      UTILS.IDENTITY_RESET('tt_PostMOC');

      INSERT INTO tt_PostMOC ( 
      	SELECT CASE 
      ...
      --select * from #FID1
      IF ( utils.object_id('tempdb..tt_PreMOC') IS NOT NULL ) THEN
       EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_PreMOC ';
      END IF;
      DELETE FROM tt_PreMOC;
      UTILS.IDENTITY_RESET('tt_PreMOC');

      INSERT INTO tt_PreMOC ( 
      	SELECT CASE 
      ...
      --INNER JOIN PRO.ACCOUNTCAL  ACAL  ON CBD.CustomerID=ACAL.RefCustomerID
      --WHERE ACBD.CustomerACID=@AccountID
      --select * from tt_PostMOC
      --select * from tt_PreMOC
      OPEN  v_cursor FOR
         SELECT --RowID,
                Label DESCRIPTION  ,
                CASE 
                     WHEN tt_LABEL.RowID_ = 01 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PostMOC.BalanceOSPOS,30)
                     WHEN tt_LABEL.RowID_ = 02 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PostMOC.BalanceOSInttReceivable,30)
                     WHEN tt_LABEL.RowID_ = 03 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PostMOC.RestructureFlag,30)
                     WHEN tt_LABEL.RowID_ = 04 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PostMOC.RestructureDate,30)
                     WHEN tt_LABEL.RowID_ = 05 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PostMOC.FITLFlag,30)
                     WHEN tt_LABEL.RowID_ = 06 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PostMOC.DFVAmt,30)
                     WHEN tt_LABEL.RowID_ = 07 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PostMOC.RePossessionFlag,30)
                     WHEN tt_LABEL.RowID_ = 08 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PostMOC.RePossessionDate,30)
                     WHEN tt_LABEL.RowID_ = 09 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PostMOC.InherentWeaknessFlag,30)
                     WHEN tt_LABEL.RowID_ = 10 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PostMOC.InherentWeaknessDate,30)
                     WHEN tt_LABEL.RowID_ = 11 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PostMOC.SARFAESIFlag,30)
                     WHEN tt_LABEL.RowID_ = 12 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PostMOC.SARFAESIDate,30)
                     WHEN tt_LABEL.RowID_ = 13 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PostMOC.UnusualBounceFlag,30)
                     WHEN tt_LABEL.RowID_ = 14 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PostMOC.UnusualBounceDate,30)
                     WHEN tt_LABEL.RowID_ = 15 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PostMOC.UnclearedEffectFlag,30)
                     WHEN tt_LABEL.RowID_ = 16 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PostMOC.UnclearedEffectDate,30)
                     WHEN tt_LABEL.RowID_ = 17 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PostMOC.AdditionalProvisionCustomerLevel,30)
                     WHEN tt_LABEL.RowID_ = 18 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PostMOC.AdditionalProvisionAbsolute,30)
                     WHEN tt_LABEL.RowID_ = 19 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PostMOC.MOCReason,30)
                     WHEN tt_LABEL.RowID_ = 20 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PostMOC.FraudAccountFlag,30)
                     WHEN tt_LABEL.RowID_ = 21 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PostMOC.FraudDate,30)   END PostMocStatus  ,
                CASE 
                     WHEN tt_LABEL.RowID_ = 01 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PreMOC.BalanceOSPOS,30)
                     WHEN tt_LABEL.RowID_ = 02 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PreMOC.BalanceOSInttReceivable,30)
                     WHEN tt_LABEL.RowID_ = 03 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PreMOC.RestructureFlag,30)
                     WHEN tt_LABEL.RowID_ = 04 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PreMOC.RestructureDate,30)
                     WHEN tt_LABEL.RowID_ = 05 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PreMOC.FITLFlag,30)
                     WHEN tt_LABEL.RowID_ = 06 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PreMOC.DFVAmt,30)
                     WHEN tt_LABEL.RowID_ = 07 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PreMOC.RePossessionFlag,30)
                     WHEN tt_LABEL.RowID_ = 08 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PreMOC.RePossessionDate,30)
                     WHEN tt_LABEL.RowID_ = 09 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PreMOC.InherentWeaknessFlag,30)
                     WHEN tt_LABEL.RowID_ = 10 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PreMOC.InherentWeaknessDate,30)
                     WHEN tt_LABEL.RowID_ = 11 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PreMOC.SARFAESIFlag,30)
                     WHEN tt_LABEL.RowID_ = 12 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PreMOC.SARFAESIDate,30)
                     WHEN tt_LABEL.RowID_ = 13 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PreMOC.UnusualBounceFlag,30)
                     WHEN tt_LABEL.RowID_ = 14 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PreMOC.UnusualBounceDate,30)
                     WHEN tt_LABEL.RowID_ = 15 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PreMOC.UnclearedEffectFlag,30)
                     WHEN tt_LABEL.RowID_ = 16 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PreMOC.UnclearedEffectDate,30)
                     WHEN tt_LABEL.RowID_ = 17 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PreMOC.AdditionalProvisionCustomerLevel,30)
                     WHEN tt_LABEL.RowID_ = 18 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PreMOC.AdditionalProvisionAbsolute,30)
                     WHEN tt_LABEL.RowID_ = 19 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PreMOC.MOCReason,30)
                     WHEN tt_LABEL.RowID_ = 20 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PostMOC.FraudAccountFlag,30)
                     WHEN tt_LABEL.RowID_ = 21 THEN UTILS.CONVERT_TO_VARCHAR2(tt_PostMOC.FraudDate,30)   END PreMocStatus  
           FROM tt_LABEL CROSS
                  JOIN tt_PostMOC CROSS
                  JOIN tt_PreMOC  ;
