...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         BEGIN
            IF utils.object_id('TempDB..tt_temp_27') IS NOT NULL THEN
             EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_temp_27 ';
            END IF;
            DELETE FROM tt_temp_27;
            UTILS.IDENTITY_RESET('tt_temp_27');

            INSERT INTO tt_temp_27 ( 
         ...
         BEGIN
            IF utils.object_id('TempDB..tt_temp_2716') IS NOT NULL THEN
             EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_temp16_20 ';
            END IF;
            DELETE FROM tt_temp16_20;
            UTILS.IDENTITY_RESET('tt_temp16_20');

            INSERT INTO tt_temp16_20 ( 
            	SELECT A.CollateralChargeTypeAltKey ,
                    A.ChargeTypeID ,
                    A.ChargeType ,
                    A.CollChargeDescription ,
