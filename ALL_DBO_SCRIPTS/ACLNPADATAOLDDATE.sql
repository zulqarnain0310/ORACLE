...
BEGIN
   ...
   IF tt_DPD_4  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_DPD_4;
   UTILS.IDENTITY_RESET('tt_DPD_4');

   INSERT INTO tt_DPD_4 ( 
   	SELECT CustomerACID ,
           AccountEntityid ,
   ...
   EXECUTE IMMEDIATE ' ALTER TABLE tt_DPD_4 
   ...
   /* CALCULATE MAX DPD */
   IF utils.object_id('TEMPDB..tt_TEMPTABLE_5') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TEMPTABLE_5 ';
   END IF;
   DELETE FROM tt_TEMPTABLE_5;
   UTILS.IDENTITY_RESET('tt_TEMPTABLE_5');

   INSERT INTO tt_TEMPTABLE_5 ( 
   ...
   INSERT INTO ACL_NPA_DATA
     ( SELECT UTILS.CONVERT_TO_NVARCHAR2(SYSDATE,30,p_style=>105) Generation_Date  ,
       ...
       FROM PRO_RBL_MISDB_PROD.CustomerCal_Hist A
              ...
              LEFT JOIN tt_DPD_4 DPD   ON B.AccountEntityID = DPD.AccountEntityID
