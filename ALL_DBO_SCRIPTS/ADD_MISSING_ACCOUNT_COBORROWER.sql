...
BEGIN
   ...
   IF tt_leftaccounts ;  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_leftaccounts;
   UTILS.IDENTITY_RESET('tt_leftaccounts');

   INSERT INTO tt_leftaccounts WITH CTE_A AS ( SELECT A.UCIF_ID ,
                                                      A.CustomerAcID ,
                                                      RefCustomerID 
        FROM tt_AccountCal_7 A
