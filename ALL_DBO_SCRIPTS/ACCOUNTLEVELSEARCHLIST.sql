...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         IF tt_ACCOUNT_PREMOC  --SQLDEV: NOT RECOGNIZED
         DBMS_OUTPUT.PUT_LINE('AKSHAY2');
         DELETE FROM tt_ACCOUNT_PREMOC;
         UTILS.IDENTITY_RESET('tt_ACCOUNT_PREMOC');

         INSERT INTO tt_ACCOUNT_PREMOC ( 
         	SELECT * 
         ...
         ----POST 
         --Select 'tt_ACCOUNT_PREMOC',* from tt_ACCOUNT_PREMOC
         IF  --SQLDEV: NOT RECOGNIZED
         IF tt_ACCOUNT_POSTMOC  --SQLDEV: NOT RECOGNIZED
         ...
         IF utils.object_id('tempdb..tt_MOCAuthorisation') IS NOT NULL THEN

         BEGIN
            EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_MOCAuthorisation ';

         END;
         END IF;
         DELETE FROM tt_MOCAuthorisation;
         UTILS.IDENTITY_RESET('tt_MOCAuthorisation');

         INSERT INTO tt_MOCAuthorisation ( 
         	SELECT * ,
         ...
         --Select ' tt_MOCAuthorisation',* from  tt_MOCAuthorisation
         --where abc=1
         UPDATE tt_MOCAuthorisation V
         ...
         ;
         MERGE INTO tt_MOCAuthorisation Z
         ...
         FROM CustomerLevelMOC_Mod V
                ...
                JOIN tt_MOCAuthorisation Z   ON X.CustomerACID = Z.AccountID 
