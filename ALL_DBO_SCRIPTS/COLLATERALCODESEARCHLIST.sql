...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         BEGIN
            IF utils.object_id('TempDB..tt_temp_29') IS NOT NULL THEN
             EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_temp_29 ';
            END IF;
            DELETE FROM tt_temp_29;
            UTILS.IDENTITY_RESET('tt_temp_29');

            INSERT INTO tt_temp_29 ( 
         ...
         BEGIN
            IF utils.object_id('TempDB..tt_temp_2916') IS NOT NULL THEN
             EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_temp16_22 ';
            END IF;
            DELETE FROM tt_temp16_22;
            UTILS.IDENTITY_RESET('tt_temp16_22');

            INSERT INTO tt_temp16_22 ( 
            	SELECT A.CollateralCodeAltKey ,
                    A.CollateralCode ,
                    A.CollateralDescription ,
                    A.AuthorisationStatus ,
