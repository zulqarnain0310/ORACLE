...
BEGIN
   ...
   BEGIN
      DELETE FROM tt_INT1_4;
      UTILS.IDENTITY_RESET('tt_INT1_4');

      INSERT INTO tt_INT1_4 SELECT * 
   ...
   ELSE
      ...
      BEGIN
         ...
         DELETE FROM tt_INT_4;
         UTILS.IDENTITY_RESET('tt_INT_4');

         INSERT INTO tt_INT_4 SELECT * 
              FROM ( SELECT UniqueUploadID ,
                            UploadedBy ,
                            UTILS.CONVERT_TO_VARCHAR2(DateofUpload,10,p_style=>103) DateofUpload  ,
                            --,DateofUpload,
         ...
         OPEN  v_cursor FOR
           ...
           SELECT * INTO tt_INT_4 FROM(
            ...
            ORDER BY DateofUpload  DESC,CASE WHEN AuthorisationStatus='NP' THEN CAST(1 AS VARCHAR(50))
                                         ...
                                         FROM tt_INT_4 Where AuthorisationStatus Not In ('Authorized','Rejected')
