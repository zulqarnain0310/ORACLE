...
BEGIN
   ...
   IF tt_COBORROWER_4  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_COBORROWER_4;
   UTILS.IDENTITY_RESET('tt_COBORROWER_4');

   INSERT INTO tt_COBORROWER_4 ( 
   ...
   INSERT INTO ACL_Report_Automate
     ( SELECT UTILS.CONVERT_TO_NVARCHAR2(v_Date,30,p_style=>105) Report_date  ,
       ...
       FROM PRO_RBL_MISDB_PROD.CUSTOMERCAL A
              ...
              LEFT JOIN tt_COBORROWER_4 CB   ON B.AccountEntityID = CB.AccountEntityId
