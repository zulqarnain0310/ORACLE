...
BEGIN
   ...
   ----WHERE   EffectiveFromTimeKey <= @TimeKey-1 AND EffectiveToTimeKey >= @TimeKey-1
   DELETE FROM tt_CUSTOMERCAL_HIST_4;
   UTILS.IDENTITY_RESET('tt_CUSTOMERCAL_HIST_4');

   INSERT INTO tt_CUSTOMERCAL_HIST_4 ( 
   	SELECT CurntQtrRv ,
           CustomerEntityID 
   ...
   DELETE FROM tt_AccountCal_Hist_4;
   UTILS.IDENTITY_RESET('tt_AccountCal_Hist_4');

   INSERT INTO tt_AccountCal_Hist_4 ( 
   ...
   OPEN  v_cursor FOR
      SELECT UTILS.CONVERT_TO_NVARCHAR2(v_Date,30,p_style=>105) Report_date  ,
        ...
        FROM PRO_RBL_MISDB_PROD.CUSTOMERCAL A
               ...
               LEFT JOIN tt_CUSTOMERCAL_HIST_4 CH   ON a.CustomerEntityID = CH.CustomerEntityID
               LEFT JOIN tt_AccountCal_Hist_4 AH   ON b.AccountEntityID = ah.AccountEntityID
