...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         IF tt_CUST_PREMOC_3  --SQLDEV: NOT RECOGNIZED
         ...
         IF  --SQLDEV: NOT RECOGNIZED
         IF tt_CUST_POSTMOC_3  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_CUST_POSTMOC_3;
         UTILS.IDENTITY_RESET('tt_CUST_POSTMOC_3');
