...
BEGIN
   ...
   --select * from tt_ACCT_NPA_QTR_NO_REPORT
   IF tt_ACCT_NPA_QTR_NO_REPORT  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_ACCT_NPA_QTR_NO_REPORT;
   UTILS.IDENTITY_RESET('tt_ACCT_NPA_QTR_NO_REPORT');

   INSERT INTO tt_ACCT_NPA_QTR_NO_REPORT ( 
   ...
   IF  --SQLDEV: NOT RECOGNIZED
   IF tt_ACCT_NPA_QTR_NO_Account  --SQLDEV: NOT RECOGNIZED
   INSERT INTO tt_ACCT_NPA_QTR_NO_Account
     ( SELECT B.AccountEntityId ,
       ...
       FROM AcceleratedProvision A
              ...
              JOIN tt_ACCT_NPA_QTR_NO_REPORT D   ON D.AccountEntityID = b.AccountEntityId
       ...
       FROM BucketWiseAcceleratedProvision_TEST A
              JOIN tt_ACCT_NPA_QTR_NO_REPORT b   ON A.SegmentName = B.AcBuRevisedSegmentCode
