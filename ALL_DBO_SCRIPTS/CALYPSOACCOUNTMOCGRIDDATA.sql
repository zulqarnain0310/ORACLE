...
BEGIN
   ...
   BEGIN
      DELETE FROM tt_INT1_19;
      UTILS.IDENTITY_RESET('tt_INT1_19');

      INSERT INTO tt_INT1_19 SELECT * 
   ...
   ELSE
      ...
      BEGIN
         ...
         DELETE FROM tt_INT_19;
         UTILS.IDENTITY_RESET('tt_INT_19');

         INSERT INTO tt_INT_19 SELECT * 
              FROM ( SELECT UniqueUploadID ,
                            UploadedBy ,
                            UTILS.CONVERT_TO_VARCHAR2(DateofUpload,10,p_style=>103) DateofUpload  ,
                            --,DateofUpload,
