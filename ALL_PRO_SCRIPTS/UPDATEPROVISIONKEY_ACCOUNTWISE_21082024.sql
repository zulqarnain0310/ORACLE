--------------------------------------------------------
--  DDL for Procedure UPDATEPROVISIONKEY_ACCOUNTWISE_21082024
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" /*=========================================
...
BEGIN
   ...
   BEGIN
      DECLARE
         ...
         IF tt_PrvQtrProv_4  --SQLDEV: NOT RECOGNIZED
         v_PrvQtrTimeKey NUMBER(5,0) := ( SELECT LastQtrDateKey 
           FROM SYSDAYMATRIX 
          WHERE  TimeKey = v_TimeKey );
         -----------------------------------------END---------------------------------------------------------
         /* END OF RESTR */
         ----MANDEEP   FOR PRINCIPALOUTSTANDING <=100  BANKER(SITARAM SIR    Mail Date='21-07-2022' )------------------------------------------------------------------------						
         v_PROV NUMBER(10,0) := ( SELECT ProvisionAlt_Key 
           FROM DimProvision_Seg 
      ...
      BEGIN
         ...
         IF  --SQLDEV: NOT RECOGNIZED
         IF tt_AC_NPA_QTR_NO_13  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_AC_NPA_QTR_NO_13;
         UTILS.IDENTITY_RESET('tt_AC_NPA_QTR_NO_13');

         INSERT INTO tt_AC_NPA_QTR_NO_13 ( 
              ...
              --inner JOIN DimProduct	dp
               ...
               --	and dp.ProductAlt_Key=a.ProductAlt_Key
                ...
                AND seg.Segment = CASE 
                 ...
                 END
                JOIN tt_AC_NPA_QTR_NO_13 NP   ON NP.AccountEntityID = A.AccountEntityID
         ...
         FROM A ,tt_ACCOUNTCAL_56 A
                ...
                ----Added By Prashant---07062024--------
                AND ProvisionRule = 'K/W/E/U/D'
                AND A.AccountBlkCode2 IN ( 'K','W','E','U','D' )
         ...
         FROM A ,tt_ACCOUNTCAL_56 A
                ...
                AND NVL(A.AccountBlkCode2, ' ') NOT IN ( 'K','W','E','U','D' )
         ...
         ON ( A.ROWID = src.row_id )
         WHEN MATCHED THEN UPDATE SET A.ProvisionAlt_Key = src.ProvisionAlt_Key;
         DELETE FROM tt_PrvQtrProv_4;
         UTILS.IDENTITY_RESET('tt_PrvQtrProv_4');

         INSERT INTO tt_PrvQtrProv_4 ( 
         	SELECT AccountEntityID ,
                 a.ProvisionAlt_Key ,
                 b.ProvisionSecured 
         ...
         ELSE A.ProvisionAlt_Key
            END AS ProvisionAlt_Key
         FROM A ,tt_ACCOUNTCAL_56 A
                JOIN DimProvision_Seg B   ON B.EffectiveFromTimeKey <= v_TimeKey
                AND B.EffectiveToTimeKey >= v_TimeKey
                AND A.ProvisionAlt_Key = B.ProvisionAlt_Key
                JOIN tt_PrvQtrProv_4 C   ON A.AccountEntityID = C.AccountEntityID 
         ...
         FROM C ,AdvAcRestructureDetail A
                JOIN DimParameter D   ON D.EffectiveFromTimeKey <= v_TIMEKEY
                AND D.EffectiveToTimeKey >= v_TIMEKEY
                AND D.ParameterAlt_Key = A.RestructureFacilityTypeAlt_Key
                AND D.DimParameterName = 'RestructureFacility'
                AND D.ParameterShortNameEnum = 'FITL'
                JOIN tt_ACCOUNTCAL_56 C   ON C.AccountEntityID = A.AccountEntityId 
...
/
  ...
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_21082024" TO "ADF_CDR_RBL_STGDB";
