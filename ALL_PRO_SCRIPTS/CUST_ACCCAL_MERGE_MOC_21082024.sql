--------------------------------------------------------
--  DDL for Procedure CUST_ACCCAL_MERGE_MOC_21082024
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" /*==============================          
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         IF tt_AdvAcCal_3  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_AdvAcCal_3;
         UTILS.IDENTITY_RESET('tt_AdvAcCal_3');

         INSERT INTO tt_AdvAcCal_3 ( 
         	SELECT O.* 
         ...
         FROM O ,CurDat_RBL_MISDB_PROD.ADVACCAL O
                JOIN tt_AdvAcCal_3 B   ON O.EffectiveFromTimeKey <= v_TimeKey
                AND O.EffectiveToTimeKey >= v_TimeKey
         ...
         IF tt_AdvCustCal_3  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_AdvCustCal_3;
         UTILS.IDENTITY_RESET('tt_AdvCustCal_3');

         INSERT INTO tt_AdvCustCal_3 ( 
         	SELECT O.* 
         ...
         FROM O ,CurDat_RBL_MISDB_PROD.ADVCUSTCAL O
                JOIN tt_AdvCustCal_3 B   ON O.EffectiveFromTimeKey <= v_TimeKey
                AND O.EffectiveToTimeKey >= v_TimeKey
                AND O.EffectiveFromTimeKey < v_TimeKey
...
/
  ...
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_21082024" TO "ADF_CDR_RBL_STGDB";
