--------------------------------------------------------
--  DDL for Procedure DERIVATIVEDATAPROCESSING_15032023
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" 
----/*=========================================
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         IF utils.object_id('TEMPDB..tt_TEMPMINASSETCLASS_4') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TEMPMINASSETCLASS_4 ';
         END IF;
         DELETE FROM tt_TEMPMINASSETCLASS_4;
         UTILS.IDENTITY_RESET('tt_TEMPMINASSETCLASS_4');

         INSERT INTO tt_TEMPMINASSETCLASS_4 ( 
         	SELECT UCIC_ID ,
         ...
         FROM B ,tt_TEMPMINASSETCLASS_4 A
         ...
         IF utils.object_id('TEMPDB..tt_TEMPTABLE_48') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TEMPTABLE_48 ';
         END IF;
         DELETE FROM tt_TEMPTABLE_48;
         UTILS.IDENTITY_RESET('tt_TEMPTABLE_48');

         INSERT INTO tt_TEMPTABLE_48 ( 
         	SELECT A.UCIC_ID ,
                 TOTALCOUNT 
         	  FROM ( SELECT A.UCIC_ID ,
                          COUNT(1)  TOTALCOUNT  
                   FROM CurDat_RBL_MISDB_PROD.DerivativeDetail A
                    WHERE  A.EffectiveFromTimeKey <= v_timekey
                             AND A.EffectiveToTimeKey >= v_timekey
                     GROUP BY A.UCIC_ID ) A
                   JOIN ( SELECT B.UCIC_ID ,
                          ...
                          FROM CurDat_RBL_MISDB_PROD.DerivativeDetail B
                           WHERE  ( NVL(B.DPD, 0) <= 0 )
                                    ...
                                    AND B.EffectiveToTimeKey >= v_TimeKey
                            GROUP BY B.UCIC_ID ) B   ON A.UCIC_ID = B.UCIC_ID
                   AND A.TOTALCOUNT = B.TOTALDPD_MAXCOUNT );
         ----  /*------ UPGRADING CUSTOMER-----------*/
         MERGE INTO A 
         USING (SELECT A.ROWID row_id, 'U'
         FROM A ,CurDat_RBL_MISDB_PROD.DerivativeDetail A
                JOIN tt_TEMPTABLE_48 B   ON A.UCIC_ID = B.UCIC_ID 
          WHERE A.EffectiveFromTimeKey <= v_timekey
           AND A.EffectiveToTimeKey >= v_timekey) src
         ON ( A.ROWID = src.row_id )
...
/
  ...
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_15032023" TO "ADF_CDR_RBL_STGDB";
