--------------------------------------------------------
--  DDL for Procedure FINAL_ASSETCLASS_NPADATE_04122023
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" /*=========================================
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         MERGE INTO B 
         USING (SELECT B.ROWID row_id, A.FinalAssetClass_AltKey, A.FinalNpaDt, CONCAT(B.DegradeReason, ' NPA DUE TO COBORROWER LINKAGE 1st level ', A.CustomerID) AS pos_4
         FROM B ,PRO_RBL_MISDB_PROD.CoBorrowerCal A
                JOIN PRO_RBL_MISDB_PROD.CoBorrowerCal B   ON B.MainCustID = A.CustomerID
                AND A.CustomerType = 'Co-borrower'
         ...
         MERGE INTO B 
         USING (SELECT B.ROWID row_id, A.FinalAssetClass_AltKey, A.FinalNpaDt, CONCAT(B.DegradeReason, ' NPA DUE TO COBORROWER LINKAGE 2nd level ', A.CustomerID) AS pos_4
         FROM B ,PRO_RBL_MISDB_PROD.CoBorrowerCal A
                JOIN PRO_RBL_MISDB_PROD.CoBorrowerCal B   ON B.MainCustID = A.CustomerID
                AND A.CustomerType = 'Co-borrower'
                AND A.FinalAssetClass_AltKey > 1
         ...
         WHEN MATCHED THEN UPDATE SET B.FinalAssetClass_AltKey = src.FinalAssetClass_AltKey,
                                      ...
                                      B.DegradeReason = pos_4;
         MERGE INTO B 
         USING (SELECT B.ROWID row_id, A.FinalAssetClass_AltKey, A.FinalNpaDt, CONCAT(B.DegradeReason, ' NPA DUE TO COBORROWER LINKAGE 3rd level ', A.CustomerID) AS pos_4
         FROM B ,PRO_RBL_MISDB_PROD.CoBorrowerCal A
                JOIN PRO_RBL_MISDB_PROD.CoBorrowerCal B   ON B.MainCustID = A.CustomerID
                AND A.CustomerType = 'Co-borrower'
                AND A.FinalAssetClass_AltKey > 1
         ...
         WHEN MATCHED THEN UPDATE SET B.FinalAssetClass_AltKey = src.FinalAssetClass_AltKey,
                                      ...
                                      B.DegradeReason = pos_4;
         MERGE INTO B 
         USING (SELECT B.ROWID row_id, A.FinalAssetClass_AltKey, A.FinalNpaDt, CONCAT(B.DegradeReason, ' NPA DUE TO COBORROWER LINKAGE 4th level ', A.CustomerID) AS pos_4
         FROM B ,PRO_RBL_MISDB_PROD.CoBorrowerCal A
                JOIN PRO_RBL_MISDB_PROD.CoBorrowerCal B   ON B.MainCustID = A.CustomerID
                AND A.CustomerType = 'Co-borrower'
                AND A.FinalAssetClass_AltKey > 1
         ...
         WHEN MATCHED THEN UPDATE SET B.FinalAssetClass_AltKey = src.FinalAssetClass_AltKey,
                                      ...
                                      B.DegradeReason = pos_4;
         MERGE INTO B 
         USING (SELECT B.ROWID row_id, A.FinalAssetClass_AltKey, A.FinalNpaDt, CONCAT(B.DegradeReason, ' NPA DUE TO COBORROWER LINKAGE 5th level ', A.CustomerID) AS pos_4
         FROM B ,PRO_RBL_MISDB_PROD.CoBorrowerCal A
                JOIN PRO_RBL_MISDB_PROD.CoBorrowerCal B   ON B.MainCustID = A.CustomerID
                AND A.CustomerType = 'Co-borrower'
                AND A.FinalAssetClass_AltKey > 1
         ...
         WHEN MATCHED THEN UPDATE SET B.FinalAssetClass_AltKey = src.FinalAssetClass_AltKey,
                                      ...
                                      B.DegradeReason = pos_4;
         MERGE INTO B 
         USING (SELECT B.ROWID row_id, A.FinalAssetClass_AltKey, A.FinalNpaDt, CONCAT(B.DegradeReason, ' NPA DUE TO COBORROWER LINKAGE 6th level ', A.CustomerID) AS pos_4
         FROM B ,PRO_RBL_MISDB_PROD.CoBorrowerCal A
                JOIN PRO_RBL_MISDB_PROD.CoBorrowerCal B   ON B.MainCustID = A.CustomerID
                AND A.CustomerType = 'Co-borrower'
                AND A.FinalAssetClass_AltKey > 1
         ...
         IF tt_MAXUCIC  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_MAXUCIC;
         UTILS.IDENTITY_RESET('tt_MAXUCIC');

         INSERT INTO tt_MAXUCIC ( 
         	SELECT UCIC ,
         	 ...
         	 WHERE  FinalAssetClass_AltKey > 1
         	  GROUP BY UCIC );
         MERGE INTO A 
         USING (SELECT A.ROWID row_id, B.FinalAssetClass_AltKey
         FROM A ,PRO_RBL_MISDB_PROD.CUSTOMERCAL A
                JOIN tt_MAXUCIC B   ON A.UCIF_ID = B.UCIC 
          WHERE A.SysAssetClassAlt_Key = 1
           AND A.Asset_Norm NOT IN ( 'AlWYS_NPA','AlWYS_STD' )

           AND B.FinalAssetClass_AltKey > 1) src
         ON ( A.ROWID = src.row_id )
         WHEN MATCHED THEN UPDATE SET A.SysAssetClassAlt_Key = src.FinalAssetClass_AltKey;
         ------------------------------END of COborrower Degrade work --------------------------------------------------------------
         /*------------------------------UPDATE UNIFORM ASSET CLASSIFICATION--------------------------------*/
         --IF OBJECT_ID('TEMPDB..tt_TEMPTABLE_UCFIC1_5') IS NOT NULL
         --   DROP TABLE tt_TEMPTABLE_UCFIC1_5
         ...
         -- INTO tt_TEMPTABLE_UCFIC1_5 FROM PRO.CUSTOMERCAL A
         ...
         IF utils.object_id('TEMPDB..tt_CTE_PERC_4') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_CTE_PERC_4 ';
         END IF;
         DELETE FROM tt_CTE_PERC_4;
         UTILS.IDENTITY_RESET('tt_CTE_PERC_4');

         INSERT INTO tt_CTE_PERC_4 ( 
         	SELECT * 
         	  FROM (  /* ADVANCE DATA */
                   SELECT UCIF_ID ,
         ...
         IF utils.object_id('TEMPDB..tt_TEMPTABLE_UCFIC1_5') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TEMPTABLE_UCFIC1_5 ';
         END IF;
         DELETE FROM tt_TEMPTABLE_UCFIC1_5;
         UTILS.IDENTITY_RESET('tt_TEMPTABLE_UCFIC1_5');

         INSERT INTO tt_TEMPTABLE_UCFIC1_5 ( 
         	SELECT UCIF_ID ,
         ...
         FROM A ,tt_TEMPTABLE_UCFIC1_5 A
                JOIN tt_CTE_PERC_4 B   ON A.UCIF_ID = B.UCIF_ID
         ...
         IF tt_CTE_PERC_4  --SQLDEV: NOT RECOGNIZED
         MERGE INTO A 
         ...
         ELSE A.DegReason
            END AS pos_4
         FROM A ,PRO_RBL_MISDB_PROD.CUSTOMERCAL A
                JOIN tt_TEMPTABLE_UCFIC1_5 B   ON A.UCIF_ID = B.UCIF_ID ) src
         ON ( A.ROWID = src.row_id )
         ...
         FROM A ,InvestmentFinancialDetail A
                ...
                AND C.EffectiveFromTimeKey <= v_TIMEKEY
                AND C.EffectiveToTimeKey >= v_TIMEKEY
                JOIN tt_TEMPTABLE_UCFIC1_5 D   ON D.UCIF_ID = C.UcifId ) src
         ON ( A.ROWID = src.row_id )
         ...
         FROM A ,CurDat_RBL_MISDB_PROD.DerivativeDetail A
                JOIN tt_TEMPTABLE_UCFIC1_5 B   ON A.UCIC_ID = B.UCIF_ID
                AND A.EffectiveFromTimeKey <= v_TIMEKEY
         ...
         IF tt_TEMPTABLE_UCFIC1_5  --SQLDEV: NOT RECOGNIZED
         ...
         IF tt_CTE_AA_2  --SQLDEV: NOT RECOGNIZED
         tt_CTE_AA_2 TABLE IF  --SQLDEV: NOT RECOGNIZED
         IF tt_CTE_BB_2  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_CTE_AA_2;
         UTILS.IDENTITY_RESET('tt_CTE_AA_2');

         INSERT INTO tt_CTE_AA_2 ( 
         	SELECT UcifEntityID 
         ...
         DELETE FROM tt_CTE_BB_2;
         UTILS.IDENTITY_RESET('tt_CTE_BB_2');

         INSERT INTO tt_CTE_BB_2 ( 
         ...
         FROM B ,PRO_RBL_MISDB_PROD.ACCOUNTCAL A
                JOIN tt_CTE_BB_2 AA   ON A.UcifEntityID = A.UcifEntityID
         ...
         ----FROM PRO.CustomerCal A INNER JOIN tt_TEMPTABLE_UCFIC1_5 B ON A.UCIF_ID=B.UCIF_ID
         ...
         IF utils.object_id('TEMPDB..tt_Data_5') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Data_5 ';
         END IF;
         DELETE FROM tt_Data_5;
         UTILS.IDENTITY_RESET('tt_Data_5');

         INSERT INTO tt_Data_5 ( 
         	SELECT DISTINCT DegReason ,
                          UcifEntityID 
         	  FROM PRO_RBL_MISDB_PROD.ACCOUNTCAL 
         	 WHERE  DegReason IS NOT NULL
                    AND FLGDEG = 'Y' );
         IF utils.object_id('TEMPDB..tt_NPADegReason_5') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_NPADegReason_5 ';
         END IF;
         DELETE FROM tt_NPADegReason_5;
         UTILS.IDENTITY_RESET('tt_NPADegReason_5');

         INSERT INTO tt_NPADegReason_5 ( 
         	SELECT UcifEntityID ,
         ...
         --DROP TABLE #DD
         --Select SourceSystemCustomerID ,DegReason ,ROW_NUMBER()OVER(PARTITION by SourceSystemCustomerID order by SourceSystemCustomerID) AS RN  INTO #DD  FROM tt_Data_5
         --IF object_id('TEMPDB..tt_NPADegReason_5') is NOT NULL
         --DROP TABLE tt_NPADegReason_5
         --SELECT SourceSystemCustomerID ,DegReason INTO tt_NPADegReason_5 FROM
         --(
         ...
         USING (SELECT A.ROWID row_id, B.DegReason
         FROM A ,PRO_RBL_MISDB_PROD.CUSTOMERCAL A
                JOIN tt_NPADegReason_5 B   ON A.UcifEntityID = B.UcifEntityID
                AND A.FlgDeg = 'Y' ) src
         ON ( A.ROWID = src.row_id )
...
/
  ...
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_04122023" TO "ADF_CDR_RBL_STGDB";
