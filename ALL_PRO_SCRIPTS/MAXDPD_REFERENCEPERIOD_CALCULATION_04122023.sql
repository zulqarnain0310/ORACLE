--------------------------------------------------------
--  DDL for Procedure MAXDPD_REFERENCEPERIOD_CALCULATION_04122023
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" /*=========================================================
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         IF utils.object_id('TEMPDB..tt_TEMPTABLE_78') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TEMPTABLE_78 ';
         END IF;
         DELETE FROM tt_TEMPTABLE_78;
         UTILS.IDENTITY_RESET('tt_TEMPTABLE_78');

         INSERT INTO tt_TEMPTABLE_78 ( 
         ...
         FROM A ,PRO_RBL_MISDB_PROD.ACCOUNTCAL a
              --INNER JOIN PRO.CUSTOMERCAL C ON C.RefCustomerID=a.RefCustomerID
                ...
                JOIN PRO_RBL_MISDB_PROD.CUSTOMERCAL C   ON C.SourceSystemCustomerID = a.SourceSystemCustomerID 
         ...
         /*-------Update REFPeriodMax---------------------------*/
         IF utils.object_id('TEMPDB..tt_TEMPTABLE_782') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TEMPTABLE2_3 ';
         END IF;
         DELETE FROM tt_TEMPTABLE2_3;
         UTILS.IDENTITY_RESET('tt_TEMPTABLE2_3');

         INSERT INTO tt_TEMPTABLE2_3 ( 
         	SELECT A.CustomerAcID ,
                 CASE 
                      WHEN ( NVL(A.DPD_IntService, 0) >= NVL(A.DPD_NoCredit, 0)
                        AND NVL(A.DPD_IntService, 0) >= NVL(A.DPD_Overdrawn, 0)
         	  ...
         	  FROM tt_TEMPTABLE_78 A
                 ...
                 --INNER JOIN PRO.CUSTOMERCAL C ON C.RefCustomerID=B.RefCustomerID
                   ...
                   JOIN PRO_RBL_MISDB_PROD.CUSTOMERCAL C   ON C.SourceSystemCustomerID = B.SourceSystemCustomerID
         	 WHERE  ( NVL(C.FlgProcessing, 'N') = 'N' ) );
         /*------- INTIAL REFPERIODMAX 0 FOR RE-PROCESSING----- */
         MERGE INTO B 
         USING (SELECT B.ROWID row_id, 0
         FROM B ,tt_TEMPTABLE2_3 A
                JOIN PRO_RBL_MISDB_PROD.ACCOUNTCAL B   ON A.CustomerAcID = B.CustomerAcID
              --INNER JOIN PRO.CUSTOMERCAL C ON C.RefCustomerID=B.RefCustomerID
...
/
  ...
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_04122023" TO "ADF_CDR_RBL_STGDB";
