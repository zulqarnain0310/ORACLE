--------------------------------------------------------
--  DDL for Procedure NPA_EROSION_AGING_12122023
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "MAIN_PRO"."NPA_EROSION_AGING_12122023" /*=========================================
...
BEGIN
   ...
   BEGIN
      DECLARE
         ...
         INNER JOIN tt_CTE_CustomerWiseBalance_8 C ON C.RefCustomerID=B.RefCustomerID
      ...
      BEGIN
         IF utils.object_id('TEMPDB..tt_CTE_CustomerWiseBalance_8') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_CTE_CustomerWiseBalance_8 ';
         END IF;
         DELETE FROM tt_CTE_CustomerWiseBalance_8;
         UTILS.IDENTITY_RESET('tt_CTE_CustomerWiseBalance_8');

         INSERT INTO tt_CTE_CustomerWiseBalance_8 ( 
         ...
         FROM B ,PRO_RBL_MISDB_PROD.ACCOUNTCAL A
                JOIN PRO_RBL_MISDB_PROD.CUSTOMERCAL B   ON A.RefCustomerID = B.RefCustomerID
                JOIN tt_CTE_CustomerWiseBalance_8 C   ON C.RefCustomerID = B.RefCustomerID
...
/
  ...
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_12122023" TO "ADF_CDR_RBL_STGDB";
