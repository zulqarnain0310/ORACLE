...
AS
   ...
   IF tt_AdvAcRestructureDetail_4  --SQLDEV: NOT RECOGNIZED
...
BEGIN
   ...
   DELETE FROM tt_AdvAcRestructureDetail_4;
   UTILS.IDENTITY_RESET('tt_AdvAcRestructureDetail_4');

   INSERT INTO tt_AdvAcRestructureDetail_4 ( 
   	SELECT * ,
           ' ' IsChanged  
   ...
   FROM A ,tt_AdvAcRestructureDetail_4 A
   ...
   FROM O ,CurDat_RBL_MISDB_PROD.AdvAcRestructureDetail O
          JOIN tt_AdvAcRestructureDetail_4 T   ON O.AccountEntityID = T.AccountEntityID
   ...
   FROM A ,CurDat_RBL_MISDB_PROD.AdvAcRestructureDetail A
          JOIN tt_AdvAcRestructureDetail_4 B   ON A.AccountEntityId = B.AccountEntityId
   ...
   INSERT INTO CurDat_RBL_MISDB_PROD.AdvAcRestructureDetail
     ...
     ( SELECT AccountEntityId ,
              ...
              InvestmentGrade ,
              POS_10PerPaidDate 
       FROM tt_AdvAcRestructureDetail_4 T
