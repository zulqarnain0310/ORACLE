--------------------------------------------------------
--  DDL for Procedure MARKING_NPA_REASON_NPAACCOUNT_12122023
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" /*=========================================
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         ON ( B.ROWID = src.row_id )
         WHEN MATCHED THEN UPDATE SET NPA_Reason = src.NPA_Reason;
         IF utils.object_id('TEMPDB..tt_TEMPTABLE_PERCOLATION_5') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TEMPTABLE_PERCOLATION_5 ';
         END IF;
         DELETE FROM tt_TEMPTABLE_PERCOLATION_5;
         UTILS.IDENTITY_RESET('tt_TEMPTABLE_PERCOLATION_5');

         INSERT INTO tt_TEMPTABLE_PERCOLATION_5 SELECT A.RefCustomerID RefCustomerID  ,
         ...
         FROM A ,PRO_RBL_MISDB_PROD.ACCOUNTCAL A
                JOIN tt_TEMPTABLE_PERCOLATION_5 B   ON A.RefCustomerID = B.REFCUSTOMERID 
          WHERE A.FinalAssetClassAlt_Key > 1
           AND A.NPA_Reason IS NULL
           AND ( A.FlgDeg = 'N' )) src
         ON ( A.ROWID = src.row_id )
         WHEN MATCHED THEN UPDATE SET B.NPA_Reason = src.NPA_Reason;
         IF utils.object_id('TEMPDB..tt_TEMPTABLE_PERCOLATION_5FreshSlipage') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TEMPTABLE_PERCOLATIONFre_5 ';
         END IF;
         DELETE FROM tt_TEMPTABLE_PERCOLATIONFre_5;
         UTILS.IDENTITY_RESET('tt_TEMPTABLE_PERCOLATIONFre_5');

         INSERT INTO tt_TEMPTABLE_PERCOLATIONFre_5 SELECT A.RefCustomerID RefCustomerID  ,
                                                          A.CustomerAcID CustomerAcID  ,
                                                          A.NPA_Reason 
              FROM PRO_RBL_MISDB_PROD.ACCOUNTCAL A
                     JOIN PRO_RBL_MISDB_PROD.CUSTOMERCAL B   ON A.RefCustomerID = B.RefCustomerID
         ...
         USING (SELECT A.ROWID row_id, 'Link By AccountId' || ' ' || B.CustomerAcID AS NPA_Reason
         FROM A ,PRO_RBL_MISDB_PROD.ACCOUNTCAL A
                JOIN tt_TEMPTABLE_PERCOLATIONFre_5 B   ON A.RefCustomerID = B.REFCUSTOMERID
         ...
         IF utils.object_id('TEMPDB..tt_TEMPTABLE_PERCOLATION_5WRITEOFF') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TEMPTABLE_PERCOLATIONWRI_5 ';
         END IF;
         DELETE FROM tt_TEMPTABLE_PERCOLATIONWRI_5;
         UTILS.IDENTITY_RESET('tt_TEMPTABLE_PERCOLATIONWRI_5');

         INSERT INTO tt_TEMPTABLE_PERCOLATIONWRI_5 SELECT A.RefCustomerID RefCustomerID  ,
                                                          A.CustomerAcID CustomerAcID  ,
                                                          A.NPA_Reason 
              FROM PRO_RBL_MISDB_PROD.ACCOUNTCAL A
                     JOIN PRO_RBL_MISDB_PROD.CUSTOMERCAL B   ON A.RefCustomerID = B.RefCustomerID
         ...
         FROM A ,PRO_RBL_MISDB_PROD.ACCOUNTCAL A
                JOIN tt_TEMPTABLE_PERCOLATIONWRI_5 B   ON A.RefCustomerID = B.REFCUSTOMERID 
          WHERE A.FinalAssetClassAlt_Key > 1
           AND A.NPA_Reason <> 'ALWYS_NPA Due To Writeoff Amount'
           AND ( A.FlgDeg = 'N' )) src
         ON ( A.ROWID = src.row_id )
...
/
  ...
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_NPA_REASON_NPAACCOUNT_12122023" TO "ADF_CDR_RBL_STGDB";
