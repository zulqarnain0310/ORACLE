...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         IF tt_AdvAcCal  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_AdvAcCal;
         UTILS.IDENTITY_RESET('tt_AdvAcCal');

         INSERT INTO tt_AdvAcCal ( 
         	SELECT O.* 
         ...
         FROM O ,CurDat_RBL_MISDB_PROD.ADVACCAL O
                JOIN tt_AdvAcCal B   ON O.EffectiveFromTimeKey <= v_TimeKey
                AND O.EffectiveToTimeKey >= v_TimeKey
         ...
         IF tt_AdvCustCal  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_AdvCustCal;
         UTILS.IDENTITY_RESET('tt_AdvCustCal');

         INSERT INTO tt_AdvCustCal ( 
         	SELECT O.* 
         ...
         FROM O ,CurDat_RBL_MISDB_PROD.ADVCUSTCAL O
                JOIN tt_AdvCustCal B   ON O.EffectiveFromTimeKey <= v_TimeKey
                AND O.EffectiveToTimeKey >= v_TimeKey
                AND O.EffectiveFromTimeKey < v_TimeKey
