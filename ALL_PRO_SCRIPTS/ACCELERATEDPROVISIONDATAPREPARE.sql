...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         IF tt_AC_NPA_QTR_NO_2  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_AC_NPA_QTR_NO_2;
         UTILS.IDENTITY_RESET('tt_AC_NPA_QTR_NO_2');

         INSERT INTO tt_AC_NPA_QTR_NO_2 ( 
         ...
         --select * from tt_AC_NPA_QTR_NO_2            
         ...
         INSERT INTO PRO_RBL_MISDB_PROD.AcceleratedProvCalc
           ( SELECT A.DateApproved ,
             ...
             FROM AcceleratedProvision A
                    ...
                    JOIN tt_AC_NPA_QTR_NO_2 D   ON D.AccountEntityID = b.AccountEntityId
             ...
             -- INNER JOIN tt_AC_NPA_QTR_NO_2 B            
             ...
             FROM BucketWiseAcceleratedProvision A
                    JOIN tt_AC_NPA_QTR_NO_2 b   ON A.SegmentName = B.AcBuRevisedSegmentCode
