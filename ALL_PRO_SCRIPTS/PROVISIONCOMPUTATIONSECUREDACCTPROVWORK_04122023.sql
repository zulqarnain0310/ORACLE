--------------------------------------------------------
--  DDL for Procedure PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" /*=====================================
...
BEGIN
   ...
   /* DPS BASE PROVISION */
   IF tt_AcctProvWork_2  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_AcctProvWork_2;
   UTILS.IDENTITY_RESET('tt_AcctProvWork_2');

   INSERT INTO tt_AcctProvWork_2 ( 
   ...
   /* UPDATE tt_AcctProvWork_2 MAX ON CUSTOMER LEVEL  01-06-2021 */
   MERGE INTO A 
   USING (SELECT A.ROWID row_id, B.LastCrDt
   FROM A ,tt_AcctProvWork_2 A
          JOIN ( SELECT tt_AcctProvWork_2.CustomerEntityID ,
                        MAX(tt_AcctProvWork_2.LastCrDt)  LastCrDt  
                 FROM tt_AcctProvWork_2 
                   GROUP BY tt_AcctProvWork_2.CustomerEntityID ) B   ON A.CustomerEntityID = B.CustomerEntityID ) src
   ...
   FROM A ,tt_AcctProvWork_2 a ) src
   ON ( A.ROWID = src.row_id )
   WHEN MATCHED THEN UPDATE SET A.HighestOverdueProv = src.HighestOverdueProv;
   --select * FROM tt_AcctProvWork_2 where AccountEntityID=2 
   ...
   FROM A ,PRO_RBL_MISDB_PROD.ACCOUNTCAL A
          JOIN tt_AcctProvWork_2 B   ON A.AccountEntityID = B.AccountEntityID 
   ...
   FROM A ,tt_AcctProvWork_2 A
          JOIN ( SELECT tt_AcctProvWork_2.UcifEntityID ,
                        MAX(tt_AcctProvWork_2.FinalProv)  FinalProv  
                 FROM tt_AcctProvWork_2 
                   GROUP BY tt_AcctProvWork_2.UcifEntityID ) B   ON A.UcifEntityID = B.UcifEntityID ) src
   ON ( A.ROWID = src.row_id )
   ...
   USING (SELECT A.ROWID row_id, B.FinalProv
   FROM A ,tt_AcctProvWork_2 A
          JOIN ( SELECT tt_AcctProvWork_2.PANNO ,
                        MAX(tt_AcctProvWork_2.FinalProv)  FinalProv  
                 FROM tt_AcctProvWork_2 
                  WHERE  tt_AcctProvWork_2.PANNO IS NOT NULL
                   GROUP BY tt_AcctProvWork_2.PANNO ) B   ON A.PANNO = B.PANNO ) src
   ON ( A.ROWID = src.row_id )
   WHEN MATCHED THEN UPDATE SET A.FinalProv = src.FinalProv;
...
/
  ...
  GRANT EXECUTE ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."PROVISIONCOMPUTATIONSECUREDACCTPROVWORK_04122023" TO "ADF_CDR_RBL_STGDB";
