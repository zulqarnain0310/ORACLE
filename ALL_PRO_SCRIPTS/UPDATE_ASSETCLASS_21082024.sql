--------------------------------------------------------
--  DDL for Procedure UPDATE_ASSETCLASS_21082024
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" /*=========================================
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         IF utils.object_id('TEMPDB..tt_CTE_CustomerWiseBalance_15') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_CTE_CustomerWiseBalance_15 ';
         END IF;
         DELETE FROM tt_CTE_CustomerWiseBalance_15;
         UTILS.IDENTITY_RESET('tt_CTE_CustomerWiseBalance_15');

         INSERT INTO tt_CTE_CustomerWiseBalance_15 ( 
         	SELECT A.refcustomerid ,
                 SUM(NVL(A.BALANCE, 0))  Balance  
         	  FROM tt_ACCOUNTCAL_58 A
                   JOIN tt_CUSTOMERCAL_57 B   ON A.refcustomerid = B.refcustomerid
         	 WHERE  NVL(B.FlgProcessing, 'N') = 'N'
         	  GROUP BY A.refcustomerid );
         EXECUTE IMMEDIATE ' CREATE INDEX I1
            ON tt_CTE_CustomerWiseBalance_15 ( refcustomerid)';
         /*-----INTIAL LEVEL SysAssetClassAlt_Key DbtDt,C DegDate----------- */
         MERGE INTO B 
         USING (SELECT B.ROWID row_id, NULL, NULL, NULL
         FROM B ,tt_CTE_CustomerWiseBalance_15 a
                JOIN tt_CUSTOMERCAL_57 B   ON A.REFCUSTOMERID = B.REFCUSTOMERID 
...
/
  ...
  GRANT EXECUTE ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATE_ASSETCLASS_21082024" TO "ADF_CDR_RBL_STGDB";
