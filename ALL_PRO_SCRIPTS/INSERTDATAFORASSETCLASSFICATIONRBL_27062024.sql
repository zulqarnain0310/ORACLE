--------------------------------------------------------
--  DDL for Procedure INSERTDATAFORASSETCLASSFICATIONRBL_27062024
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" /*=========================================  
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         IF tt_ACCOUNTCAL_33  --SQLDEV: NOT RECOGNIZED
         tt_ACCOUNTCAL_33 TABLE IF  --SQLDEV: NOT RECOGNIZED
         IF tt_CUSTOMERCAL_30  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_ACCOUNTCAL_33;
         UTILS.IDENTITY_RESET('tt_ACCOUNTCAL_33');

         INSERT INTO tt_ACCOUNTCAL_33 ( 
         	SELECT * 
         	  FROM PRO_RBL_MISDB_PROD.ACCOUNTCAL 
         	 WHERE  1 = 2 );
         DELETE FROM tt_CUSTOMERCAL_30;
         UTILS.IDENTITY_RESET('tt_CUSTOMERCAL_30');

         INSERT INTO tt_CUSTOMERCAL_30 ( 
         	SELECT * 
         ...
         UPDATE PRO_RBL_MISDB_PROD.AclRunningProcessStatus
            SET COMPLETED = 'N',
                ...
                ERRORDATE = NULL;
         --ALTER INDEX INDEX_CUSTOMERENTITYID ON tt_CUSTOMERCAL_30 DISABLE  
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor
           ...
           ( SELECT USER ,
                    ...
                    v_SetID 
               FROM DUAL  );
         /*--------------INSERT DATA FOR tt_CUSTOMERCAL_30 CAL TABLE--------------------------*/
         INSERT INTO tt_CUSTOMERCAL_30
         ...
         INSERT INTO tt_ACCOUNTCAL_33
           ...
           ( SELECT ACCOUNTENTITYID ACCOUNTENTITYID  ,
             ...
             FROM RBL_MISDB_PROD.AdvAcBasicDetail ABD
                    JOIN tt_CUSTOMERCAL_30 CBD   ON abd.CUSTOMERENTITYID = CBD.CUSTOMERENTITYID
         ...
         --select count(1)  
          ...
          WHERE ROWID IN 
         ( SELECT A.ROWID
           FROM tt_CUSTOMERCAL_30 A
                  LEFT JOIN tt_ACCOUNTCAL_33 B   ON A.CustomerEntityID = B.CustomerEntityID,
                A
                --select count(1)  

          WHERE  B.CustomerEntityID IS NULL );
         /* */
         --alter index all on tt_CUSTOMERCAL_30  rebuild  
         --alter index all on tt_ACCOUNTCAL_33   rebuild    
         /* update ucifentityid from  customerentityid in case of ucifeentity is not  present */
         ----update tt_ACCOUNTCAL_33 set UcifEntityID=CustomerEntityID  where isnull(ucifentityid,0)=0  
         ----update tt_CUSTOMERCAL_30 set UcifEntityID=CustomerEntityID where isnull(ucifentityid,0)=0  
         ----update tt_ACCOUNTCAL_33 set UCIF_ID=RefCustomerID  where UCIF_ID IS NULL  
         ----update tt_CUSTOMERCAL_30 set UCIF_ID=RefCustomerID where UCIF_ID IS NULL  
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor
            SET ENDTIME = SYSDATE,
                MODE_ = 'COMPLETE'
          WHERE  IdentityKey = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR') /*END:SQLDEV*/ 
         ...
         UPDATE tt_CUSTOMERCAL_30 SET  PANNO=NULL WHERE PANNO='FORMO6161O'  
         UPDATE tt_CUSTOMERCAL_30 SET  PANNO=NULL WHERE PANNO='FORPM6060F'  
         UPDATE tt_CUSTOMERCAL_30 SET  PANNO=NULL WHERE PANNO='FORPM6060P'  
         UPDATE tt_CUSTOMERCAL_30 SET  PANNO=NULL WHERE PANNO='FORMF6060F'  
         UPDATE tt_CUSTOMERCAL_30 SET  PANNO=NULL WHERE PANNO='AAAAA1111A'  
         */
         UPDATE tt_CUSTOMERCAL_30
            SET PANNO = NULL
         ...
         /*  COMMENTED BY MANDEEP  11-09-2023  QUERY OPTIMIZATION
         UPDATE tt_CUSTOMERCAL_30 SET AADHARCARDNO=NULL  WHERE AADHARCARDNO='000000000000'  
         UPDATE tt_CUSTOMERCAL_30 SET AADHARCARDNO=NULL  WHERE AADHARCARDNO='111111111111'  
         UPDATE tt_CUSTOMERCAL_30 SET AADHARCARDNO=NULL  WHERE AADHARCARDNO='222222222222'  
         UPDATE tt_CUSTOMERCAL_30 SET AADHARCARDNO=NULL  WHERE AADHARCARDNO='333333333333'  
         UPDATE tt_CUSTOMERCAL_30 SET AADHARCARDNO=NULL  WHERE AADHARCARDNO='444444444444'  
         UPDATE tt_CUSTOMERCAL_30 SET AADHARCARDNO=NULL  WHERE AADHARCARDNO='555555555555'  
         UPDATE tt_CUSTOMERCAL_30 SET AADHARCARDNO=NULL  WHERE AADHARCARDNO='666666666666'  
         UPDATE tt_CUSTOMERCAL_30 SET AADHARCARDNO=NULL  WHERE AADHARCARDNO='777777777777'  
         UPDATE tt_CUSTOMERCAL_30 SET AADHARCARDNO=NULL  WHERE AADHARCARDNO='888888888888'  
         UPDATE tt_CUSTOMERCAL_30 SET AADHARCARDNO=NULL  WHERE AADHARCARDNO='999999999999'  
         */
         UPDATE tt_CUSTOMERCAL_30
         ...
         ----------UPDATE  tt_ACCOUNTCAL_33  
         ----------SET tt_ACCOUNTCAL_33.BankAssetClass =C.AssetClassAlt_Key  
         ----------   FROM tt_ACCOUNTCAL_33 A  
         ...
         --update a  
         --        set  FacilityType='CC'  
         --from tt_ACCOUNTCAL_33 a WHERE FacilityType='CCOD'  
         ------  
         --UPDATE A SET A.OVERDUESINCEDT=DATEADD(DAY,-b.CD,@PROCESSINGDATE)  
         --FROM tt_ACCOUNTCAL_33 A INNER  JOIN RBL_STGDB.DBO.ACCOUNT_ALL_SOURCE_SYSTEM b on a.customeracid=b.CustomerAcID  
         ...
         --FROM tt_ACCOUNTCAL_33 A INNER  JOIN DBO.AdvFacCreditCardDetail B ON A.AccountEntityID=B.AccountEntityID  
         ...
         ----FROM tt_CUSTOMERCAL_30 A INNER JOIN #TEMPTABLE_VISIONPLUS_ASSETCLASS B  
         ...
         BEGIN
            IF utils.object_id('TEMPDB..tt_TEMPTABLEPANCARD_25') IS NOT NULL THEN
             EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TEMPTABLEPANCARD_25 ';
            END IF;
            DELETE FROM tt_TEMPTABLEPANCARD_25;
            UTILS.IDENTITY_RESET('tt_TEMPTABLEPANCARD_25');

            INSERT INTO tt_TEMPTABLEPANCARD_25 ( 
            	SELECT PANNO ,
            ...
            EXECUTE IMMEDIATE ' ALTER TABLE tt_TEMPTABLEPANCARD_25 
               ADD ( SOURCEDBNAME VARCHAR2(20)  ) ';
            MERGE INTO A 
            USING (SELECT A.ROWID row_id, C.SOURCEDBNAME
            FROM A ,tt_TEMPTABLEPANCARD_25 A
                   JOIN tt_CUSTOMERCAL_30 B   ON A.PANNO = B.PANNO
            ...
            USING (SELECT A.ROWID row_id, B.SYSASSETCLASSALT_KEY, B.SYSNPA_DT
            FROM A ,tt_CUSTOMERCAL_30 A
                   JOIN tt_TEMPTABLEPANCARD_25 B   ON A.PANNO = B.PANNO ) src
            ON ( A.ROWID = src.row_id )
            WHEN MATCHED THEN UPDATE SET A.SYSASSETCLASSALT_KEY = src.SYSASSETCLASSALT_KEY,
                                         A.SYSNPA_DT = src.SYSNPA_DT;
            MERGE INTO A 
            ...
            FROM A ,tt_CUSTOMERCAL_30 A
                   JOIN tt_TEMPTABLEPANCARD_25 B   ON A.PANNO = B.PANNO 
         ...
         BEGIN
            IF utils.object_id('TEMPDB..tt_TEMPTABLE_ADHARCARD_25') IS NOT NULL THEN
             EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TEMPTABLE_ADHARCARD_25 ';
            END IF;
            DELETE FROM tt_TEMPTABLE_ADHARCARD_25;
            UTILS.IDENTITY_RESET('tt_TEMPTABLE_ADHARCARD_25');

            INSERT INTO tt_TEMPTABLE_ADHARCARD_25 ( 
            	SELECT AADHARCARDNO ,
                    MAX(NVL(SYSASSETCLASSALT_KEY, 1))  SYSASSETCLASSALT_KEY  ,
                    MIN(SYSNPA_DT)  SYSNPA_DT  ,
                    B.SOURCEDBNAME 
            ...
            USING (SELECT A.ROWID row_id, B.SYSASSETCLASSALT_KEY, B.SYSNPA_DT
            FROM A ,tt_CUSTOMERCAL_30 A
                   JOIN tt_TEMPTABLE_ADHARCARD_25 B   ON A.AADHARCARDNO = B.AADHARCARDNO ) src
            ON ( A.ROWID = src.row_id )
            WHEN MATCHED THEN UPDATE SET A.SYSASSETCLASSALT_KEY = src.SYSASSETCLASSALT_KEY,
                                         A.SYSNPA_DT = src.SYSNPA_DT;
            MERGE INTO A 
            ...
            FROM A ,tt_CUSTOMERCAL_30 A
                   JOIN tt_TEMPTABLE_ADHARCARD_25 B   ON A.AADHARCARDNO = B.AADHARCARDNO 
             WHERE A.SRCASSETCLASSALT_KEY = 1
              AND A.SYSASSETCLASSALT_KEY > 1
              AND A.DEGREASON IS NULL) src
            ON ( A.ROWID = src.row_id )
         ...
         ------FROM tt_ACCOUNTCAL_33 A LEFT  OUTER JOIN   tt_CUSTOMERCAL_30  B   
         ...
         FROM A ,tt_ACCOUNTCAL_33 A
                JOIN tt_CUSTOMERCAL_30 B   ON A.CustomerEntityID = B.CustomerEntityID
                AND ( B.EFFECTIVEFROMTIMEKEY <= v_TIMEKEY
                AND B.EFFECTIVETOTIMEKEY >= v_TIMEKEY ) ) src
         ON ( A.ROWID = src.row_id )
         ...
         USING (SELECT A.ROWID row_id, NVL(B.SysAssetClassAlt_Key, 1) AS FinalAssetClassAlt_Key
         FROM A ,tt_ACCOUNTCAL_33 A
                JOIN tt_CUSTOMERCAL_30 B   ON A.UcifEntityID = B.UcifEntityID
                AND ( B.EFFECTIVEFROMTIMEKEY <= v_TIMEKEY
                AND B.EFFECTIVETOTIMEKEY >= v_TIMEKEY ) ) src
         ON ( A.ROWID = src.row_id )
         WHEN MATCHED THEN UPDATE SET A.FinalAssetClassAlt_Key = src.FinalAssetClassAlt_Key;
         ...
         BEGIN
            ...
            FROM C ,tt_CUSTOMERCAL_30 A
                   JOIN tt_TEMPTABLEPANCARD_25 B   ON A.PANNO = B.PANNO
                   JOIN tt_ACCOUNTCAL_33 C   ON C.UcifEntityID = A.UcifEntityID ) src
         ...
         ------FROM tt_ACCOUNTCAL_33  A INNER  JOIN tt_CUSTOMERCAL_30 B ON A.CUSTOMERENTITYID=B.CUSTOMERENTITYID  
         ------WHERE A.INITIALASSETCLASSALT_KEY<>1  
         ...
         /*  
           ...
           BEGIN  
            UPDATE A SET  A.InitialNpaDt=isnull(C.NPADt,null)  
                 FROM tt_ACCOUNTCAL_33 A  LEFT hash JOIN dbo.AdvCustNPAdetail C  
           ...
           BEGIN  
            UPDATE A SET  A.InitialNpaDt=isnull(C.FinalNpaDt,null)  
                 FROM tt_ACCOUNTCAL_33 A  LEFT hash JOIN PRO.ACCOUNTCAL_Hist C  
         ...
         */
         ...
         FROM A ,tt_ACCOUNTCAL_33 A
                JOIN tt_CUSTOMERCAL_30 B   ON A.CUSTOMERENTITYID = B.CUSTOMERENTITYID ) src
         ON ( A.ROWID = src.row_id )
         ...
         USING (SELECT A.ROWID row_id, B.SysNPA_Dt
         FROM A ,tt_ACCOUNTCAL_33 A
                JOIN tt_CUSTOMERCAL_30 B   ON A.UcifEntityID = B.UcifEntityID ) src
         ON ( A.ROWID = src.row_id )
         WHEN MATCHED THEN UPDATE SET A.FinalNpaDt = src.SysNPA_Dt;
         --WHERE A.INITIALASSETCLASSALT_KEY<>1  
         IF v_PANCARDFLAG = 'Y' THEN
         ...
         /*  
         UPDATE tt_ACCOUNTCAL_33 SET ASSET_NORM='ALWYS_NPA'  
         ...
         */
         ...
         /*  
         --UPDATE tt_ACCOUNTCAL_33 SET INITIALASSETCLASSALT_KEY=1,INITIALNPADT=NULL,FINALNPADT=NULL,FINALASSETCLASSALT_KEY=1,PrvAssetClassAlt_Key=1  
         ...
         */
         ...
         FROM A ,tt_CUSTOMERCAL_30 A
                JOIN tt_ACCOUNTCAL_33 AC   ON AC.CustomerEntityID = A.CustomerEntityID 
          WHERE AccountBlkCode2 IN ( 'K','E','W' )
         ...
         WHEN MATCHED THEN UPDATE SET Asset_Norm = 'ALWYS_NPA',
                                      DegReason = pos_3;
         -------------------------------Added By Prashant-----06072024-----------------------------------
         MERGE INTO ACL 
         USING (SELECT ACL.ROWID row_id, 'ALWYS_NPA', 2, v_ProcessingDate, 'NPA DUE TO CREDIT CARD WRITE-OFF – D BLOCK' AS pos_5, 'NPA DUE TO CREDIT CARD WRITE-OFF – D BLOCK' AS pos_6
         FROM ACL ,tt_ACCOUNTCAL_33 ACL 
          WHERE AccountBlkCode2 IN ( 'D' )
         ...
         WHEN MATCHED THEN UPDATE SET Asset_Norm = 'ALWYS_NPA',
                                      ...
                                      DegReason = pos_6;
         MERGE INTO ACL 
         USING (SELECT ACL.ROWID row_id, 'ALWYS_NPA', 'NPA DUE TO CREDIT CARD WRITE-OFF – D BLOCK' AS pos_3
         FROM ACL ,tt_ACCOUNTCAL_33 ACL 
          WHERE AccountBlkCode2 IN ( 'D' )
         ...
         /* CUSTOMER WRITEOFF UPDATE */
         MERGE INTO A 
         USING (SELECT A.ROWID row_id, 'ALWYS_NPA', 'NPA DUE TO CREDIT CARD WRITE-OFF – D BLOCK' AS pos_3, 2, v_ProcessingDate
         FROM A ,tt_CUSTOMERCAL_30 A
                JOIN tt_ACCOUNTCAL_33 AC   ON AC.CustomerEntityID = A.CustomerEntityID 
          WHERE AccountBlkCode2 IN ( 'D' )
         ...
         WHEN MATCHED THEN UPDATE SET Asset_Norm = 'ALWYS_NPA',
                                      ...
                                      A.SysNPA_Dt = v_ProcessingDate;
         MERGE INTO A 
         USING (SELECT A.ROWID row_id, 'ALWYS_NPA', 'NPA DUE TO CREDIT CARD WRITE-OFF – D BLOCK' AS pos_3
         FROM A ,tt_CUSTOMERCAL_30 A
                JOIN tt_ACCOUNTCAL_33 AC   ON AC.CustomerEntityID = A.CustomerEntityID 
          WHERE AccountBlkCode2 IN ( 'D' )
         ...
         ELSE SysNPA_Dt
            END AS pos_4
         FROM A ,tt_CUSTOMERCAL_30 A
                JOIN tt_ACCOUNTCAL_33 ACL   ON A.CustomerEntityID = ACL.CustomerEntityID
                JOIN ExceptionFinalStatusType C   ON ACL.CustomerAcID = C.ACID
                AND NVL(c.SourceAlt_Key, 0) <> 7
                AND C.EFFECTIVEFROMTIMEKEY <= v_TIMEKEY
                AND C.EffectiveToTimeKey >= v_TIMEKEY 
         ...
         --	)
         IF  --SQLDEV: NOT RECOGNIZED
         IF tt_excepdata_11  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_excepdata_11;
         UTILS.IDENTITY_RESET('tt_excepdata_11');

         INSERT INTO tt_excepdata_11 ( 
         	SELECT acid ,
         	 ...
         	 WHERE  StatusType IN ( 'TWO','WO','Charge Off','Settlement' )
         	  ...
         	  GROUP BY ACID );
         IF  --SQLDEV: NOT RECOGNIZED
         IF tt_EXPACID_11  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_EXPACID_11;
         UTILS.IDENTITY_RESET('tt_EXPACID_11');

         INSERT INTO tt_EXPACID_11 ( 
         	SELECT a.acid ,
                 StatusType ,
                 UTILS.CONVERT_TO_NUMBER(0,19,0) CUSTOMERENTITYID  ,
                 UTILS.CONVERT_TO_NUMBER(0,19,0) UCIFENTITYID  
         	  FROM ExceptionFinalStatusType a
                   JOIN tt_excepdata_11 b   ON a.acid = b.acid
         ...
         IF  --SQLDEV: NOT RECOGNIZED
         IF tt_ADVACID_11  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_ADVACID_11;
         UTILS.IDENTITY_RESET('tt_ADVACID_11');

         INSERT INTO tt_ADVACID_11 ( 
         	SELECT AccountEntityId ,
                 MAX(EffectiveFromTimeKey)  EffectiveFromTimeKey  
         	  FROM AdvAcBasicDetail A
                   JOIN tt_EXPACID_11 B   ON A.CustomerACID = B.ACID
         	  GROUP BY AccountEntityId );
         IF  --SQLDEV: NOT RECOGNIZED
         IF tt_EXPCUST_11  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_EXPCUST_11;
         UTILS.IDENTITY_RESET('tt_EXPCUST_11');

         INSERT INTO tt_EXPCUST_11 ( 
         	SELECT CustomerEntityId ,
                 CustomerACID 
         	  FROM AdvAcBasicDetail A
                   JOIN tt_ADVACID_11 B   ON A.AccountEntityId = B.AccountEntityId
                   AND a.EffectiveFromTimeKey = B.EffectiveFromTimeKey );
         IF  --SQLDEV: NOT RECOGNIZED
         IF tt_EXPCUST_11ID  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_EXPCUSTID_11;
         UTILS.IDENTITY_RESET('tt_EXPCUSTID_11');

         INSERT INTO tt_EXPCUSTID_11 ( 
         	SELECT A.CustomerEntityId ,
                 MAX(EffectiveFromTimeKey)  EffectiveFromTimeKey  
         	  FROM CustomerBasicDetail A
                   JOIN tt_EXPCUST_11 B   ON A.CustomerEntityId = B.CustomerEntityId
         	  GROUP BY A.CustomerEntityId );
         IF  --SQLDEV: NOT RECOGNIZED
         IF tt_EXPUCIC_11  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_EXPUCIC_11;
         UTILS.IDENTITY_RESET('tt_EXPUCIC_11');

         INSERT INTO tt_EXPUCIC_11 ( 
         	SELECT A.CustomerEntityId ,
                 UcifEntityID 
         	  FROM CustomerBasicDetail A
                   JOIN tt_EXPCUSTID_11 B   ON A.CustomerEntityId = B.CustomerEntityId
                   AND a.EffectiveFromTimeKey = B.EffectiveFromTimeKey );
         ---------------
         MERGE INTO A 
         USING (SELECT A.ROWID row_id, B.CustomerEntityId
         FROM A ,tt_EXPACID_11 A
                JOIN tt_EXPCUST_11 B   ON A.ACID = B.CustomerACID ) src
         ON ( A.ROWID = src.row_id )
         ...
         FROM A ,tt_EXPACID_11 A
                JOIN tt_EXPUCIC_11 B   ON A.CUSTOMERENTITYID = B.CUSTOMERENTITYID ) src
         ON ( A.ROWID = src.row_id )
         WHEN MATCHED THEN UPDATE SET A.UCIFENTITYID = src.UCIFENTITYID;
         DELETE tt_EXPACID_11

          WHERE  UCIFENTITYID = 0;
         IF  --SQLDEV: NOT RECOGNIZED
         --select a.UCIFENTITYID, STRING_AGG(ACID,'|') AS ACID into tt_LINKACEXP_11
         IF tt_LINKACEXP_11  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_LINKACEXP_11;
         UTILS.IDENTITY_RESET('tt_LINKACEXP_11');

         INSERT INTO tt_LINKACEXP_11 ( 
         	SELECT a.UCIFENTITYID ,
                 STRING_AGG(ACID, '-') ACID --Added by Prashant--02052024-------

         	  FROM tt_EXPACID_11 a
                   LEFT JOIN tt_ACCOUNTCAL_33 b   ON a.acid = b.CustomerAcID
         ...
         FROM ACL ,tt_ACCOUNTCAL_33 ACL
                JOIN tt_EXPACID_11 A   ON ACL.UcifEntityID = A.UcifEntityID
                JOIN tt_LINKACEXP_11 b   ON a.UCIFENTITYID = acl.UcifEntityID 
         ...
         FROM ACL ,tt_ACCOUNTCAL_33 ACL
                JOIN tt_EXPACID_11 A   ON ACL.UcifEntityID = A.UcifEntityID
                JOIN tt_LINKACEXP_11 b   ON a.UCIFENTITYID = B.UcifEntityID 
         ...
         MERGE INTO ACL 
         USING (SELECT ACL.ROWID row_id, 'ALWYS_NPA'
         FROM ACL ,tt_CUSTOMERCAL_30 ACL
                JOIN tt_EXPACID_11 A   ON ACL.UcifEntityID = A.UcifEntityID 
          WHERE A.StatusType = 'Settlement'
           AND SysAssetClassAlt_Key > 1) src
         ON ( ACL.ROWID = src.row_id )
         ...
         ON ( ACL.ROWID = src.row_id )
         WHEN MATCHED THEN UPDATE SET ACL.Asset_Norm = 'ALWYS_NPA';
         ---------ADDED BY PRASHANT---03062024---------
         --UPDATE  ACL set  
         --  Asset_Norm='ALWYS_NPA'  
         --FROM tt_CUSTOMERCAL_30 ACL  
         -- INNER JOIN tt_EXPACID_11 A  
         -- on ACL.UcifEntityID=A.UcifEntityID
         -- WHERE A.StatusType in('CHARGE OFF') AND SysAssetClassAlt_Key>1 
         MERGE INTO A 
         USING (SELECT A.ROWID row_id, 'ALWYS_NPA'
         FROM A ,tt_CUSTOMERCAL_30 A
                JOIN tt_ACCOUNTCAL_33 ACL   ON A.CustomerEntityID = ACL.CustomerEntityID
          ...
          WHERE c.StatusType = 'Charge Off'
           AND SysAssetClassAlt_Key > 1
           AND NVL(acl.Balance, 0) > 0) src
         ON ( A.ROWID = src.row_id )
         WHEN MATCHED THEN UPDATE SET ACL.Asset_Norm = 'ALWYS_NPA';
         IF  --SQLDEV: NOT RECOGNIZED
         IF tt_ChargeOff_AccountStatus_4  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_ChargeOff_AccountStatus_4;
         UTILS.IDENTITY_RESET('tt_ChargeOff_AccountStatus_4');

         INSERT INTO tt_ChargeOff_AccountStatus_4 ( 
         	SELECT * 
         	  FROM tt_ACCOUNTCAL_33 
         	 WHERE  AccountStatus = 'Z' );
         MERGE INTO a 
         USING (SELECT a.ROWID row_id, a.FinalAssetClassAlt_Key
         FROM a ,tt_ACCOUNTCAL_33 a
                JOIN tt_ChargeOff_AccountStatus_4 b   ON a.AccountEntityID = b.AccountEntityID ) src
         ON ( a.ROWID = src.row_id )
         ...
         --IF OBJECT_ID('TEMPDB..tt_PRVQTRRV_25') IS NOT NULL  
         --DROP TABLE tt_PRVQTRRV_25  
         ...
         --FROM tt_CUSTOMERCAL_30 A INNER  JOIN tt_PRVQTRRV_25 B  
         ...
         IF utils.object_id('TEMPDB..tt_PRVQTRRV_25') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_PRVQTRRV_25 ';
         END IF;
         DELETE FROM tt_PRVQTRRV_25;
         UTILS.IDENTITY_RESET('tt_PRVQTRRV_25');

         INSERT INTO tt_PRVQTRRV_25 ( 
         	SELECT A.CustomerEntityId ,
         ...
         FROM A ,tt_CUSTOMERCAL_30 A
                JOIN tt_PRVQTRRV_25 B   ON A.CUSTOMERENTITYID = B.CUSTOMERENTITYID ) src
         ON ( A.ROWID = src.row_id )
         ...
         --UPDATE A SET A.PRVQTRRV= ISNULL(B.Total_PriSec,0)+ISNULL(B.Total_CollSec,0)  FROM tt_CUSTOMERCAL_30 A INNER  JOIN tt_PRVQTRRV_25 B                  
         --ON A.CUSTOMERENTITYID=B.CUSTOMERENTITYID                  
         */
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor
            SET ENDTIME = SYSDATE,
         ...
         IF utils.object_id('TEMPDB..tt_CurntQtrRv_25') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_CurntQtrRv_25 ';
         END IF;
         DELETE FROM tt_CurntQtrRv_25;
         UTILS.IDENTITY_RESET('tt_CurntQtrRv_25');

         INSERT INTO tt_CurntQtrRv_25 ( 
         	SELECT CustomerEntityId ,
         ...
         FROM A ,tt_CUSTOMERCAL_30 A
                JOIN tt_CurntQtrRv_25 B   ON A.CUSTOMERENTITYID = B.CUSTOMERENTITYID 
          WHERE A.SourceAlt_Key <> 1) src
         ON ( A.ROWID = src.row_id )
         WHEN MATCHED THEN UPDATE SET A.CurntQtrRv = CurrentValue;
         ------- ----Added By Mandeep (Security Perfection)
         DELETE FROM tt_CurntQtrRv_Finacle_19;
         UTILS.IDENTITY_RESET('tt_CurntQtrRv_Finacle_19');

         INSERT INTO tt_CurntQtrRv_Finacle_19 ( 
         	SELECT CustomerEntityId ,
                 SUM(b.CurrentValue)  CurrentValue  
         	  FROM AdvSecurityDetail A
                   JOIN AdvSecurityValueDetail B   ON A.SecurityEntityID = B.SecurityEntityID
         ...
         FROM A ,tt_CUSTOMERCAL_30 A
                JOIN tt_CurntQtrRv_Finacle_19 B   ON A.CUSTOMERENTITYID = B.CUSTOMERENTITYID 
          WHERE A.SourceAlt_Key = 1) src
         ON ( A.ROWID = src.row_id )
         WHEN MATCHED THEN UPDATE SET A.CurntQtrRv = src.CurrentValue;
         /*                  
         --IF OBJECT_ID('TEMPDB..tt_CurntQtrRv_25') IS NOT NULL                  
         --DROP TABLE tt_CurntQtrRv_25                  

         --SELECT *                    
         --INTO tt_CurntQtrRv_25                   
         --FROM dbo.AdvCustSecurityFun(@TIMEKEY)                  

         ------UPDATE A SET A.CurntQtrRv= ISNULL(B.Total_PriSec,0)+ISNULL(B.Total_CollSec,0)                   
         ------FROM tt_CUSTOMERCAL_30 A INNER  JOIN tt_CurntQtrRv_25 B                  
         ------ON A.CUSTOMERENTITYID=B.CUSTOMERENTITYID                  
         */
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor
            SET ENDTIME = SYSDATE,
         ...
         ----UPDATE A SET A.SecurityValue= ISNULL(B.Total_PriSec,0)+ISNULL(B.Total_CollSec,0)  FROM tt_ACCOUNTCAL_33 A INNER  JOIN #TEMPSECURITY B                  
         ----ON A.AccountEntityID=B.AccountEntityID                  
         ...
         ----UPDATE A SET A.CURNTQTRRV=ISNULL(A.CURNTQTRRV,0) FROM tt_CUSTOMERCAL_30 A  INNER JOIN                   
         ----(                  
         ----SELECT A.CUSTOMERENTITYID,SUM(ISNULL(A.SecurityValue,0)) as CURNTQTRRV FROM tt_ACCOUNTCAL_33 A                   
         ----INNER JOIN tt_CUSTOMERCAL_30 B ON A.CUSTOMERENTITYID=B.CUSTOMERENTITYID                  
         ...
         ------FROM tt_ACCOUNTCAL_33 A INNER  JOIN dbo.AdvAcBasicDetail B ON A.AccountEntityID=B.AccountEntityID                  
         ------WHERE  (B.EffectiveFromTimeKey<=@TIMEKEY and B.EffectiveToTimeKey>=@TIMEKEY)               
         ------AND B.FlgSecured='S'                  
         ------AND A.FlgSecured='U'                  

         --UPDATE B SET SecApp='S'                  
         --FROM  tt_ACCOUNTCAL_33 B                  
         ...
         */
         ...
         FROM B ,tt_ACCOUNTCAL_33 B
                JOIN tt_CUSTOMERCAL_30 a   ON A.CustomerEntityID = B.CustomerEntityID 
         ...
         ;
         IF utils.object_id('TEMPDB..tt_BILL_OVERDUE_25') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_BILL_OVERDUE_25 ';
         END IF;
         DELETE FROM tt_BILL_OVERDUE_25;
         UTILS.IDENTITY_RESET('tt_BILL_OVERDUE_25');

         INSERT INTO tt_BILL_OVERDUE_25 ( 
         	SELECT AccountEntityID ,
                 BILLENTITYID ,
                 BALANCE ,
                 CASE 
         	 ...
         	 WHERE  EFFECTIVEFROMTIMEKEY <= v_TIMEKEY
                  ...
                  v_PROCESSINGDATE );
         IF utils.object_id('TEMPDB..tt_BILL_OVERDUE_25_FINAL') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_BILL_OVERDUE_FINAL_23 ';
         END IF;
         DELETE FROM tt_BILL_OVERDUE_FINAL_23;
         UTILS.IDENTITY_RESET('tt_BILL_OVERDUE_FINAL_23');

         INSERT INTO tt_BILL_OVERDUE_FINAL_23 ( 
         	SELECT AccountEntityId ,
                 SUM(BALANCE)  BILOVERDUE  ,
                 MIN(BILLDUEDT)  BILLOVERDUEDT  
         	  FROM tt_BILL_OVERDUE_25 
         	  GROUP BY AccountEntityId );
         MERGE INTO tt_ACCOUNTCAL_33 A
         USING (SELECT A.ROWID row_id, B.BILLOVERDUEDT, B.BILOVERDUE
         FROM tt_ACCOUNTCAL_33 A
                JOIN tt_BILL_OVERDUE_FINAL_23 B   ON A.AccountEntityID = B.AccountEntityId ) src
         ON ( A.ROWID = src.row_id )
         WHEN MATCHED THEN UPDATE SET OVERDUESINCEDT = src.BILLOVERDUEDT,
                                      OverdueAmt = src.BILOVERDUE;
         --=====SCF SOURCE SYSTEM CHANGES==================================================================================================
         IF utils.object_id('TEMPDB..tt_BILL_OVERDUE_25_SCF') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_BILL_OVERDUE_SCF_22 ';
         END IF;
         DELETE FROM tt_BILL_OVERDUE_SCF_22;
         UTILS.IDENTITY_RESET('tt_BILL_OVERDUE_SCF_22');

         INSERT INTO tt_BILL_OVERDUE_SCF_22 ( 
         	SELECT AccountEntityID ,
         	 ...
         	 WHERE  EFFECTIVEFROMTIMEKEY <= v_TIMEKEY
         	  ...
         	  GROUP BY AccountEntityId );
         IF utils.object_id('TEMPDB..tt_BILL_OVERDUE_25_SCF_FINAL') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_BILL_OVERDUE_SCF_FINAL_22 ';
         END IF;
         DELETE FROM tt_BILL_OVERDUE_SCF_FINAL_22;
         UTILS.IDENTITY_RESET('tt_BILL_OVERDUE_SCF_FINAL_22');

         INSERT INTO tt_BILL_OVERDUE_SCF_FINAL_22 ( 
         	SELECT AccountEntityId ,
                 Balance ,
                 overdueinterest ,
         ...
         FROM tt_ACCOUNTCAL_33 A
                JOIN tt_BILL_OVERDUE_SCF_FINAL_22 B   ON A.AccountEntityID = B.AccountEntityId ) src
         ON ( A.ROWID = src.row_id )
         WHEN MATCHED THEN UPDATE SET PrincOverdueSinceDt = src.BillDueDt,
                                      ...
                                      PrincOverdue = pos_6,
                                      IntOverdue = pos_7;
         IF utils.object_id('TEMPDB..tt_BILL_Min_ReviewDt_22') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_BILL_Min_ReviewDt_22 ';
         END IF;
         DELETE FROM tt_BILL_Min_ReviewDt_22;
         UTILS.IDENTITY_RESET('tt_BILL_Min_ReviewDt_22');

         INSERT INTO tt_BILL_Min_ReviewDt_22 ( 
         	SELECT AccountEntityId ,
         ...
         FROM A ,tt_ACCOUNTCAL_33 A
                JOIN tt_BILL_Min_ReviewDt_22 B   ON A.AccountEntityID = B.AccountEntityId ) src
         ON ( A.ROWID = src.row_id )
         WHEN MATCHED THEN UPDATE SET A.ReviewDueDt = ReviewDuedate;
         --=====================================================SCF BILL END===========================================================================
         --IF OBJECT_ID('TEMPDB..tt_BILL_OVERDUE_25_FINAL') IS NOT NULL  
         --    DROP TABLE tt_BILL_OVERDUE_25_FINAL  
         --SELECT AccountEntityId,SUM(BALANCE) BILOVERDUE,MIN(BILLDUEDT) BILLOVERDUEDT  
         -- INTO tt_BILL_OVERDUE_25_FINAL  
         --FROM tt_BILL_OVERDUE_25 GROUP BY AccountEntityId  
         --UPDATE tt_ACCOUNTCAL_33 SET OVERDUESINCEDT=B.BILLOVERDUEDT ,OverdueAmt  =B.BILOVERDUE  
         --FROM  tt_ACCOUNTCAL_33 A   
         --INNER JOIN tt_BILL_OVERDUE_25_FINAL B  
         -- ON A.AccountEntityID =B.AccountEntityId  
         ...
         IF utils.object_id('TEMPDB..tt_PC_OVERDUE_25') IS NOT NULL THEN
          --update a  
         ...
         /* START OF PUI WORK*/
         EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_PC_OVERDUE_25 ';
         END IF;
         DELETE FROM tt_PC_OVERDUE_25;
         UTILS.IDENTITY_RESET('tt_PC_OVERDUE_25');

         INSERT INTO tt_PC_OVERDUE_25 ( 
         	SELECT AccountEntityID ,
                 PCRefNo ,
                 BALANCE ,
                 CASE 
         	 ...
         	 WHERE  EFFECTIVEFROMTIMEKEY <= v_TIMEKEY
                  ...
                  ----- )<=@PROCESSINGDATE  --  as discussed with Triloki Sir for SMA KIssue - Consider 1 dpd on due date  
                  v_PROCESSINGDATE );
         IF utils.object_id('TEMPDB..tt_PC_OVERDUE_25_FINAL') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_PC_OVERDUE_FINAL_25 ';
         END IF;
         DELETE FROM tt_PC_OVERDUE_FINAL_25;
         UTILS.IDENTITY_RESET('tt_PC_OVERDUE_FINAL_25');

         INSERT INTO tt_PC_OVERDUE_FINAL_25 ( 
         	SELECT AccountEntityId ,
                 SUM(BALANCE)  PCOVERDUE  ,
                 MIN(PCOVERDUEDUEDT)  PCOVERDUEDUEDT  
         	  FROM tt_PC_OVERDUE_25 
         	  GROUP BY AccountEntityId );
         MERGE INTO tt_ACCOUNTCAL_33 A
         USING (SELECT A.ROWID row_id, B.PCOVERDUEDUEDT, B.PCOVERDUE
         FROM tt_ACCOUNTCAL_33 A
                JOIN tt_PC_OVERDUE_FINAL_25 B   ON A.AccountEntityID = B.AccountEntityId ) src
         ON ( A.ROWID = src.row_id )
         ...
         FROM A ,tt_ACCOUNTCAL_33 A
                JOIN ( SELECT A.ACCOUNTENTITYID ,
                       ...
                       FROM RBL_MISDB_PROD.AdvFacBillDetail A
                              JOIN tt_ACCOUNTCAL_33 B   ON A.ACCOUNTENTITYID = B.ACCOUNTENTITYID
                        WHERE  ( A.EFFECTIVEFROMTIMEKEY <= v_TIMEKEY
                                 AND A.EFFECTIVETOTIMEKEY >= v_TIMEKEY )
         ...
         ------------END  
         -----------------------------------------------------------------------------------------------------------------  
         --DROP TABLE IF EXISTS tt_CCOD_90DAYS_INTT_CR_AMT_22  
         --SELECT A.CustomerAcID,  
         ...
         -- INTO tt_CCOD_90DAYS_INTT_CR_AMT_22  
         ...
         IF  --SQLDEV: NOT RECOGNIZED
         IF tt_CCOD_90DAYS_INTT_CR_AMT_22  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_CCOD_90DAYS_INTT_CR_AMT_22;
         UTILS.IDENTITY_RESET('tt_CCOD_90DAYS_INTT_CR_AMT_22');

         INSERT INTO tt_CCOD_90DAYS_INTT_CR_AMT_22 ( 
         	SELECT A.CustomerAcID ,
                 SUM(CASE 
         ...
         FROM A ,tt_ACCOUNTCAL_33 a
                LEFT JOIN tt_CCOD_90DAYS_INTT_CR_AMT_22 b   ON A.CustomerAcID = b.CustomerAcID ) src
         ON ( A.ROWID = src.row_id )
         ...
         /*------------------UPDATE INTSERVICESDT IN tt_ACCOUNTCAL_33------------------*/
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor
           ( USERID, DESCRIPTION, MODE_, STARTTIME, ENDTIME, TIMEKEY, SETID )
           ( SELECT USER ,
                    'UPDATE INTNOTSERVICEDDT IN tt_ACCOUNTCAL_33' ,
                    'RUNNING' ,
                    SYSDATE ,
                    NULL ,
                    v_TIMEKEY ,
         ...
         --FROM tt_ACCOUNTCAL_33 A  INNER JOIN DimProduct C   
         ...
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor
          ...
          WHERE  IDENTITYKEY = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR') /*END:SQLDEV*/ 
                                   FROM DUAL  )
           AND TIMEKEY = v_TIMEKEY
           AND DESCRIPTION = 'UPDATE INTNOTSERVICEDDT IN tt_ACCOUNTCAL_33';
         ...
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor
           ...
           ( SELECT USER ,
                    ...
                    v_SetID 
               FROM DUAL  );
         IF utils.object_id('Tempdb..tt_Stock_25') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Stock_25 ';
         END IF;
         DELETE FROM tt_Stock_25;
         UTILS.IDENTITY_RESET('tt_Stock_25');

         INSERT INTO tt_Stock_25 ( 
         	SELECT AccountEntityId ,
         	  ...
         	  GROUP BY AccountEntityId );
         ----CREATE CLUSTERED INDEX tt_Stock_25_IX ON tt_Stock_25(AccountEntityId)  
         ----CREATE NONCLUSTERED INDEX tt_Stock_25NON ON tt_Stock_25(AccountEntityId,StkSmtDt)  
         ----IF OBJECT_ID('Tempdb..tt_Stock_252') IS NOT NULL  
         ----DROP TABLE tt_Stock_252  
         ...
         ----   GROUP BY AccountEntityId  
         ----CREATE CLUSTERED INDEX tt_Stock_252_IX ON tt_Stock_252(AccountEntityId)  
         ----CREATE NONCLUSTERED INDEX tt_Stock_252NON ON tt_Stock_252(AccountEntityId,StkSmtDt)  
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor
            SET ENDTIME = SYSDATE,
                MODE_ = 'COMPLETE'
          WHERE  IDENTITYKEY = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR') /*END:SQLDEV*/ 
         ...
         /*-----UPDATE STOCK STATEMENT DATE IN tt_ACCOUNTCAL_33----------------------------------------------------*/
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor
           ( UserID, DESCRIPTION, MODE_, StartTime, EndTime, TimeKey, SetID )
           ( SELECT USER ,
                    'update stock statement date in tt_ACCOUNTCAL_33' ,
         ...
         --FROM tt_ACCOUNTCAL_33 A   
         --INNER  JOIN tt_Stock_25 SD ON A.AccountEntityId=SD.AccountEntityId  
         ...
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor
          ...
          WHERE  IdentityKey = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR') /*END:SQLDEV*/ 
                                   FROM DUAL  )
           AND TIMEKEY = v_TIMEKEY
           AND DESCRIPTION = 'update stock statement date in tt_ACCOUNTCAL_33';
         /*------UPDATE DerecognisedInterest1 AMT IN tt_ACCOUNTCAL_33---------------------*/
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor
           ( UserID, DESCRIPTION, MODE_, StartTime, EndTime, TimeKey, SetID )
           ( SELECT USER ,
                    'UPDATE DerecognisedInterest1 AMT IN tt_ACCOUNTCAL_33' ,
                    ...
                    v_SetID 
               FROM DUAL  );
         IF utils.object_id('TEMPDB..tt_TEMPDerecognisedInterest_49') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TEMPDerecognisedInterest_49 ';
         END IF;
         DELETE FROM tt_TEMPDerecognisedInterest_49;
         INSERT INTO tt_TEMPDerecognisedInterest_49
         ...
         /*-----UPDATE DerecognisedInterest1 IN tt_ACCOUNTCAL_33 TABLE ----------------------------*/
         MERGE INTO A 
         USING (SELECT A.ROWID row_id, B.DerecognisedInterest1
         FROM A ,tt_ACCOUNTCAL_33 A
                JOIN tt_TEMPDerecognisedInterest_49 B   ON A.ACCOUNTENTITYID = B.ACCOUNTENTITYID ) src
         ON ( A.ROWID = src.row_id )
         ...
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor
          ...
          WHERE  IdentityKey = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR') /*END:SQLDEV*/ 
                                   FROM DUAL  )
           AND TIMEKEY = v_TIMEKEY
           AND DESCRIPTION = 'UPDATE DerecognisedInterest1 AMT IN tt_ACCOUNTCAL_33';
         /*------UPDATE DerecognisedInterest2 AMT IN tt_ACCOUNTCAL_33---------------------*/
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor
           ( UserID, DESCRIPTION, MODE_, StartTime, EndTime, TimeKey, SetID )
           ( SELECT USER ,
                    'UPDATE DerecognisedInterest2 AMT IN tt_ACCOUNTCAL_33' ,
                    ...
                    v_SetID 
               FROM DUAL  );
         IF utils.object_id('TEMPDB..tt_TEMPDerecognisedInterest_50') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TEMPDerecognisedInterest_50 ';
         END IF;
         DELETE FROM tt_TEMPDerecognisedInterest_50;
         INSERT INTO tt_TEMPDerecognisedInterest_50
           ...
           ( SELECT A.ACCOUNTENTITYID ,
             ...
             FROM RBL_MISDB_PROD.ADVFACDLDETAIL C
              WHERE  ( C.EFFECTIVEFROMTIMEKEY <= v_TIMEKEY
                       ...
                       AND NVL(DerecognisedInterest2, 0) > 0
               GROUP BY C.ACCOUNTENTITYID );
         /*-----UPDATE DerecognisedInterest2 IN tt_ACCOUNTCAL_33 TABLE ----------------------------*/
         MERGE INTO A 
         USING (SELECT A.ROWID row_id, B.DerecognisedInterest2
         FROM A ,tt_ACCOUNTCAL_33 A
                JOIN tt_TEMPDerecognisedInterest_50 B   ON A.ACCOUNTENTITYID = B.ACCOUNTENTITYID ) src
         ON ( A.ROWID = src.row_id )
         ...
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor
          ...
          WHERE  IdentityKey = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR') /*END:SQLDEV*/ 
                                   FROM DUAL  )
           AND TIMEKEY = v_TIMEKEY
           AND DESCRIPTION = 'UPDATE DerecognisedInterest2 AMT IN tt_ACCOUNTCAL_33';
         ...
         */
         ...
         /*------------------UPDATE FRAUD ACCOUNT MARKING  IN tt_ACCOUNTCAL_33------------------*/
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor
           ( USERID, DESCRIPTION, MODE_, STARTTIME, ENDTIME, TIMEKEY, SETID )
           ( SELECT USER ,
                    'UPDATE FRAUD ACCOUNT MARKING  IN tt_ACCOUNTCAL_33' ,
         ...
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor
          ...
          WHERE  IDENTITYKEY = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR') /*END:SQLDEV*/ 
                                   FROM DUAL  )
           AND TIMEKEY = v_TIMEKEY
           AND DESCRIPTION = 'UPDATE FRAUD ACCOUNT MARKING  IN tt_ACCOUNTCAL_33';
         /*------------------UPDATE FRAUD ACCOUNT MARKING  IN tt_CUSTOMERCAL_30------------------*/
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor
           ( USERID, DESCRIPTION, MODE_, STARTTIME, ENDTIME, TIMEKEY, SETID )
           ( SELECT USER ,
                    'UPDATE FRAUD ACCOUNT MARKING  IN tt_CUSTOMERCAL_30' ,
         ...
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor
          ...
          WHERE  IDENTITYKEY = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR') /*END:SQLDEV*/ 
                                   FROM DUAL  )
           AND TIMEKEY = v_TIMEKEY
           AND DESCRIPTION = 'UPDATE FRAUD ACCOUNT MARKING  IN tt_CUSTOMERCAL_30';
         /*------------------UPDATE IBPC MARKING  IN tt_ACCOUNTCAL_33------------------*/
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor
           ( USERID, DESCRIPTION, MODE_, STARTTIME, ENDTIME, TIMEKEY, SETID )
           ( SELECT USER ,
                    'UPDATE IBPC MARKING  IN tt_ACCOUNTCAL_33' ,
         ...
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor
          ...
          WHERE  IDENTITYKEY = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR') /*END:SQLDEV*/ 
                                   FROM DUAL  )
           AND TIMEKEY = v_TIMEKEY
           AND DESCRIPTION = 'UPDATE IBPC MARKING  IN tt_ACCOUNTCAL_33';
         /*------------------UPDATE Securitised MARKING  IN tt_ACCOUNTCAL_33------------------*/
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor
           ( USERID, DESCRIPTION, MODE_, STARTTIME, ENDTIME, TIMEKEY, SETID )
           ( SELECT USER ,
                    'UPDATE Securitised MARKING  IN tt_ACCOUNTCAL_33' ,
         ...
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor
          ...
          WHERE  IDENTITYKEY = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR') /*END:SQLDEV*/ 
                                   FROM DUAL  )
           AND TIMEKEY = v_TIMEKEY
           AND DESCRIPTION = 'UPDATE Securitised MARKING  IN tt_ACCOUNTCAL_33';
         /*------------------UPDATE PUI MARKING  IN tt_ACCOUNTCAL_33------------------*/
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor
           ( USERID, DESCRIPTION, MODE_, STARTTIME, ENDTIME, TIMEKEY, SETID )
           ( SELECT USER ,
                    'UPDATE PUI MARKING  IN tt_ACCOUNTCAL_33' ,
         ...
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor
          ...
          WHERE  IDENTITYKEY = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR') /*END:SQLDEV*/ 
                                   FROM DUAL  )
           AND TIMEKEY = v_TIMEKEY
           AND DESCRIPTION = 'UPDATE PUI MARKING  IN tt_ACCOUNTCAL_33';
         /*------------------UPDATE RFA MARKING  IN tt_ACCOUNTCAL_33------------------*/
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor
           ( USERID, DESCRIPTION, MODE_, STARTTIME, ENDTIME, TIMEKEY, SETID )
           ( SELECT USER ,
                    'UPDATE RFA MARKING  IN tt_ACCOUNTCAL_33' ,
         ...
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor
          ...
          WHERE  IDENTITYKEY = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR') /*END:SQLDEV*/ 
                                   FROM DUAL  )
           AND TIMEKEY = v_TIMEKEY
           AND DESCRIPTION = 'UPDATE RFA MARKING  IN tt_ACCOUNTCAL_33';
         /*------------------UPDATE NonCooperative MARKING  IN tt_ACCOUNTCAL_33------------------*/
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor
           ( USERID, DESCRIPTION, MODE_, STARTTIME, ENDTIME, TIMEKEY, SETID )
           ( SELECT USER ,
                    'UPDATE NonCooperative MARKING  IN tt_ACCOUNTCAL_33' ,
         ...
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor
          ...
          WHERE  IDENTITYKEY = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR') /*END:SQLDEV*/ 
                                   FROM DUAL  )
           AND TIMEKEY = v_TIMEKEY
           AND DESCRIPTION = 'UPDATE NonCooperative MARKING  IN tt_ACCOUNTCAL_33';
         /*------------------UPDATE Repossessed ACCOUNT MARKING  IN tt_ACCOUNTCAL_33------------------*/
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor
           ( USERID, DESCRIPTION, MODE_, STARTTIME, ENDTIME, TIMEKEY, SETID )
           ( SELECT USER ,
                    'UPDATE Repossessed ACCOUNT MARKING  IN tt_ACCOUNTCAL_33' ,
         ...
         FROM a ,tt_CUSTOMERCAL_30 a
                JOIN tt_ACCOUNTCAL_33 b   ON a.CustomerEntityID = b.CustomerEntityID 
         ...
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor
          ...
          WHERE  IDENTITYKEY = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR') /*END:SQLDEV*/ 
                                   FROM DUAL  )
           AND TIMEKEY = v_TIMEKEY
           AND DESCRIPTION = 'UPDATE Repossessed ACCOUNT MARKING  IN tt_ACCOUNTCAL_33';
         /*------------------UPDATE Inherent Weakness  ACCOUNT MARKING  IN tt_ACCOUNTCAL_33------------------*/
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor
           ( USERID, DESCRIPTION, MODE_, STARTTIME, ENDTIME, TIMEKEY, SETID )
           ( SELECT USER ,
                    'UPDATE Inherent Weakness ACCOUNT MARKING  IN tt_ACCOUNTCAL_33' ,
         ...
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor
          ...
          WHERE  IDENTITYKEY = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR') /*END:SQLDEV*/ 
                                   FROM DUAL  )
           AND TIMEKEY = v_TIMEKEY
           AND DESCRIPTION = 'UPDATE Inherent Weakness ACCOUNT MARKING  IN tt_ACCOUNTCAL_33';
         /*------------------UPDATE SARFAESI ACCOUNT MARKING IN tt_ACCOUNTCAL_33------------------*/
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor
           ( USERID, DESCRIPTION, MODE_, STARTTIME, ENDTIME, TIMEKEY, SETID )
           ( SELECT USER ,
                    'UPDATE SARFAESI ACCOUNT MARKING IN tt_ACCOUNTCAL_33' ,
         ...
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor
          ...
          WHERE  IDENTITYKEY = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR') /*END:SQLDEV*/ 
                                   FROM DUAL  )
           AND TIMEKEY = v_TIMEKEY
           AND DESCRIPTION = 'UPDATE SARFAESI ACCOUNT MARKING IN tt_ACCOUNTCAL_33';
         /*------------------UPDATE RC-Pending MARKING  IN tt_ACCOUNTCAL_33------------------*/
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor
           ( USERID, DESCRIPTION, MODE_, STARTTIME, ENDTIME, TIMEKEY, SETID )
           ( SELECT USER ,
                    'UPDATE RC-Pending MARKING  IN tt_ACCOUNTCAL_33' ,
         ...
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor
          ...
          WHERE  IDENTITYKEY = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR') /*END:SQLDEV*/ 
                                   FROM DUAL  )
           AND TIMEKEY = v_TIMEKEY
           AND DESCRIPTION = 'UPDATE RC-Pending MARKING  IN tt_ACCOUNTCAL_33';
         /*------------------UPDATE Written-Off Accounts ACCOUNT MARKING  IN tt_ACCOUNTCAL_33------------------*/
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor
           ( USERID, DESCRIPTION, MODE_, STARTTIME, ENDTIME, TIMEKEY, SETID )
           ( SELECT USER ,
                    'UPDATE Written-Off Accounts MARKING IN tt_ACCOUNTCAL_33' ,
                    'RUNNING' ,
                    SYSDATE ,
                    NULL ,
                    v_TIMEKEY ,
         ...
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor
          ...
          WHERE  IDENTITYKEY = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR') /*END:SQLDEV*/ 
                                   FROM DUAL  )
           AND TIMEKEY = v_TIMEKEY
           AND DESCRIPTION = 'UPDATE Written-Off Accounts MARKING IN tt_ACCOUNTCAL_33';
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor
           ( USERID, DESCRIPTION, MODE_, STARTTIME, ENDTIME, TIMEKEY, SETID )
           ( SELECT USER ,
                    'UPDATE CONDI_STD IN tt_ACCOUNTCAL_33' ,
                    'RUNNING' ,
                    SYSDATE ,
                    NULL ,
                    v_TIMEKEY ,
         ...
         UPDATE A SET A.Asset_Norm='CONDI_STD'   
            ...
            INNER  JOIN dbo.AdvSecurityDetail Advsec on Advsec.SecurityEntityID=b.SecurityEntityID  
             INNER JOIN tt_ACCOUNTCAL_33 C ON Advsec.AccountEntityID=C.AccountEntityID    
         ...
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor
          ...
          WHERE  IDENTITYKEY = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR') /*END:SQLDEV*/ 
                                   FROM DUAL  )
           AND TIMEKEY = v_TIMEKEY
           AND DESCRIPTION = 'UPDATE CONDI_STD IN tt_ACCOUNTCAL_33';
         ...
         --                   DA.EFFECTIVETOTIMEKEY>=@TIMEKEY  
         --WHERE B.MOCTYPE='AUTO' AND  B.EFFECTIVEFROMTIMEKEY<=@TIMEKEY AND  B.EFFECTIVETOTIMEKEY>=@TIMEKEY  
         --UPDATE  A SET DBTDT=@PROCESSINGDATE FROM tt_CUSTOMERCAL_30 A    
         ...
         INSERT INTO PRO_RBL_MISDB_PROD.BuyoutUploadDetailsCal
           ...
           ( SELECT A.DateofData ,
             ...
             FROM BuyoutUploadDetails A
                    JOIN tt_ACCOUNTCAL_33 B   ON A.CustomerAcID = B.CustomerAcID
              WHERE  A.EffectiveFromTimeKey <= v_TIMEKEY
                       AND A.EffectiveToTimeKey >= v_TIMEkEY );
         MERGE INTO A 
         ...
         /*
           ...
           FROM tt_ACCOUNTCAL_33 A  
            INNER JOIN PRO.BuyoutUploadDetailsCal B  
            ON A.CustomerAcID=B.CustomerAcID  
            inner join tt_CUSTOMERCAL_30 C  
         ...
         ELSE C.DegReason
            END AS pos_5
         FROM C ,tt_ACCOUNTCAL_33 A
                JOIN PRO_RBL_MISDB_PROD.BuyoutUploadDetailsCal B   ON A.CustomerAcID = B.CustomerAcID
                JOIN tt_CUSTOMERCAL_30 C   ON A.CustomerEntityID = C.CustomerEntityID ) src
         ON ( C.ROWID = src.row_id )
         ...
         IF  --SQLDEV: NOT RECOGNIZED
         IF tt_ADHOC_UcifEntityID_STD_11  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_ADHOC_UcifEntityID_STD_11;
         UTILS.IDENTITY_RESET('tt_ADHOC_UcifEntityID_STD_11');

         INSERT INTO tt_ADHOC_UcifEntityID_STD_11 ( 
         	SELECT UcifEntityID 
         ...
         WITH CTE_A AS ( SELECT CUSTOMERENTITYID 
           FROM tt_ADHOC_UcifEntityID_STD_11 A
         ...
         IF  --SQLDEV: NOT RECOGNIZED
         IF tt_MOC_DATA_24  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_MOC_DATA_24;
         UTILS.IDENTITY_RESET('tt_MOC_DATA_24');

         INSERT INTO tt_MOC_DATA_24 ( 
         	SELECT UcifEntityID ,
         ...
         FROM A ,tt_CUSTOMERCAL_30 A
                JOIN tt_MOC_DATA_24 B   ON A.UcifEntityID = B.UcifEntityID ) src
         ON ( A.ROWID = src.row_id )
         ...
         /*	  UPDATE A
         	  ...
         	  FROM tt_CUSTOMERCAL_30 c
         	  inner join tt_ACCOUNTCAL_33 A  
         	  on         a.CustomerEntityID=c.CustomerEntityID
         	  INNER JOIN PRO.BuyoutUploadDetailsCal B  
         			ON A.AccountEntityID=B.AccountEntityID
         ...
         --IF OBJECT_ID('TEMPDB..tt_UpdateTempAssetclassAsse_22') IS NOT NULL  
         -- DROP TABLE  tt_UpdateTempAssetclassAsse_22  
         --select a.CustomerEntityID, count(a.CustomerAcID) CNT
         --into          tt_UpdateTempAssetclassAsse_22
         --from		  tt_ACCOUNTCAL_33 a
         --inner join    tt_CUSTOMERCAL_30 b
         --on            a.CustomerEntityID=b.CustomerEntityID
         --group by      a.CustomerEntityID
         ...
         --INNER JOIN	   tt_ACCOUNTCAL_33  B
         --ON             A.CustomerEntityID=B.CustomerEntityID
         --INNER JOIN     tt_UpdateTempAssetclassAsse_22 C
         --ON             A.CustomerEntityID=C.CustomerEntityID
         ...
         IF utils.object_id('TEMPDB..tt_UpdateTempAssetclassAsse_22') IS NOT NULL THEN
          --------------------------COBORROWER WORK ADDED BY MANDEEP -------------------------------------------------------------------------
         EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_UpdateTempAssetclassAsse_22 ';
         END IF;
         DELETE FROM tt_UpdateTempAssetclassAsse_22;
         UTILS.IDENTITY_RESET('tt_UpdateTempAssetclassAsse_22');

         INSERT INTO tt_UpdateTempAssetclassAsse_22 ( 
         	SELECT a.CustomerEntityID ,
         ...
         FROM A ,tt_ACCOUNTCAL_33 A
                JOIN tt_UpdateTempAssetclassAsse_22 C   ON A.CustomerEntityID = C.CustomerEntityID 
...
/
  ...
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_27062024" TO "ADF_CDR_RBL_STGDB";
