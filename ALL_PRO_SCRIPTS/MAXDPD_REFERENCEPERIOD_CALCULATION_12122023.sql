--------------------------------------------------------
--  DDL for Procedure MAXDPD_REFERENCEPERIOD_CALCULATION_12122023
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" /*=========================================================
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         IF utils.object_id('TEMPDB..tt_TEMPTABLE_79') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TEMPTABLE_79 ';
         END IF;
         DELETE FROM tt_TEMPTABLE_79;
         UTILS.IDENTITY_RESET('tt_TEMPTABLE_79');

         INSERT INTO tt_TEMPTABLE_79 ( 
         ...
         /*-------Update REFPeriodMax---------------------------*/
         IF utils.object_id('TEMPDB..tt_TEMPTABLE_792') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TEMPTABLE2_4 ';
         END IF;
         DELETE FROM tt_TEMPTABLE2_4;
         UTILS.IDENTITY_RESET('tt_TEMPTABLE2_4');

         INSERT INTO tt_TEMPTABLE2_4 ( 
         	SELECT A.CustomerAcID ,
                 CASE 
                      WHEN ( NVL(A.DPD_IntService, 0) >= NVL(A.DPD_NoCredit, 0)
                        AND NVL(A.DPD_IntService, 0) >= NVL(A.DPD_Overdrawn, 0)
...
/
  ...
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."MAXDPD_REFERENCEPERIOD_CALCULATION_12122023" TO "ADF_CDR_RBL_STGDB";
