--------------------------------------------------------
--  DDL for Procedure ACCTCALHISTMERGE_LOOP_21082024
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" 
----USE [RBL_MISDB]
 ----GO
...
BEGIN
   ...
   IF tt_TIMEKEY_3  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_TIMEKEY_3;
   UTILS.IDENTITY_RESET('tt_TIMEKEY_3');

   INSERT INTO tt_TIMEKEY_3 SELECT Timekey ,
                                   DATE_ ,
   ...
   LOOP 
      ...
      BEGIN
         ...
         IF tt_acdata_3  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_acdata_3;
         UTILS.IDENTITY_RESET('tt_acdata_3');

         INSERT INTO tt_acdata_3 ( 
         	SELECT * ,
                 'N' IsChanged  ,
         ...
         BEGIN
            ...
            FROM T ,PRO_RBL_MISDB_PROD.AccountCal_Hist_new O
                   JOIN tt_acdata_3 T   ON O.AccountEntityID = T.AccountEntityID
            ...
            FROM A ,tt_acdata_3 A
                   JOIN PRO_RBL_MISDB_PROD.AccountCal_Hist_new B   ON B.AccountEntityID = A.AccountEntityID 
            ...
            FROM O ,PRO_RBL_MISDB_PROD.AccountCal_Hist_new O
                   JOIN tt_acdata_3 T   ON O.AccountEntityID = T.AccountEntityID 
            ...
            FROM AA ,PRO_RBL_MISDB_PROD.AccountCal_Hist_new AA 
            ...
            SELECT MAX(EntityKey)  
              ...
              INTO v_EntityKeyAc
              FROM PRO_RBL_MISDB_PROD.AccountCal_Hist_new ;
            ...
            FROM TEMP ,tt_acdata_3 TEMP
                   JOIN ( SELECT tt_acdata_3.AccountEntityId ,
                                 (v_EntityKeyAc + ROW_NUMBER() OVER ( ORDER BY ( SELECT 1 
                                                                                   FROM DUAL  )  )) EntityKeyNew  
                          FROM tt_acdata_3 
                           WHERE  tt_acdata_3.IsChanged IN ( 'C','N' )
            ...
            /***************************************************************************************************************/
            INSERT INTO PRO_RBL_MISDB_PROD.AccountCal_Hist_new
            ...
            WITH CTE_Reccount AS ( SELECT v_timekey timekey  ,
             ...
             WHERE  EffectiveFromTimeKey <= v_timekey
               ...
               FROM A ,ACCAHIST_TIMEKEY_REC_COUNT a
...
/
  ...
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_21082024" TO "ADF_CDR_RBL_STGDB";
