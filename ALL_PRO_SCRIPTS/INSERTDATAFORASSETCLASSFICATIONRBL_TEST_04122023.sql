--------------------------------------------------------
--  DDL for Procedure INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" /*=========================================
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         EXECUTE IMMEDIATE ' TRUNCATE TABLE PRO_RBL_MISDB_PROD.CUSTOMERCAL_test ';
         EXECUTE IMMEDIATE ' TRUNCATE TABLE PRO_RBL_MISDB_PROD.ACCOUNTCAL_test ';
         DELETE PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
         ...
         UPDATE PRO_RBL_MISDB_PROD.AclRunningProcessStatus_TEST
            SET COMPLETED = 'N',
                ...
                ERRORDATE = NULL;
         --ALTER INDEX INDEX_CUSTOMERENTITYID ON PRO.CUSTOMERCAL_test DISABLE
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
           ( UserID, DESCRIPTION, MODE_, StartTime, EndTime, TimeKey, SetID )
           ( SELECT USER ,
                    'INSERT DATA FOR PRO.CUSTOMERCAL_test CAL TABLE' ,
                    'RUNNING' ,
                    SYSDATE ,
                    NULL ,
                    v_TIMEKEY ,
               ...
               FROM DUAL  );
         /*--------------INSERT DATA FOR PRO.CUSTOMERCAL_test CAL TABLE--------------------------*/
         INSERT INTO PRO_RBL_MISDB_PROD.CUSTOMERCAL_test
           ...
           ( SELECT v_TIMEKEY EffectiveFromTimeKey  ,
             ...
             WHERE  ( CBD.EffectiveFromTimeKey <= v_TIMEKEY
                      ...
                      AND CBD.UcifEntityID IN ( SELECT UcifEntityID 
         ...
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
          ...
          WHERE  IdentityKey = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR_test') /*END:SQLDEV*/ 
           ...
           AND DESCRIPTION = 'INSERT DATA FOR PRO.CUSTOMERCAL_test CAL TABLE';
         /*------------------ACCOUNT DATA INSERT------------------*/
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
           ( USERID, DESCRIPTION, MODE_, STARTTIME, ENDTIME, TIMEKEY, SETID )
           ( SELECT USER ,
                    'INSERT DATA IN ACCOUNTCAL_test TABLE' ,
                    'RUNNING' ,
                    SYSDATE ,
                    NULL ,
                    v_TIMEKEY ,
                    v_SETID 
               FROM DUAL  );
         INSERT INTO PRO_RBL_MISDB_PROD.ACCOUNTCAL_TEST
           ...
           ( SELECT ACCOUNTENTITYID ACCOUNTENTITYID  ,
             ...
             FROM RBL_MISDB_PROD.AdvAcBasicDetail ABD
                    JOIN PRO_RBL_MISDB_PROD.CUSTOMERCAL_test CBD   ON abd.CUSTOMERENTITYID = CBD.CUSTOMERENTITYID
         ...
         --select count(1)
          ...
          WHERE ROWID IN 
         ( SELECT A.ROWID
           FROM PRO_RBL_MISDB_PROD.CUSTOMERCAL_test A
                  LEFT JOIN PRO_RBL_MISDB_PROD.ACCOUNTCAL_TEST B   ON A.CustomerEntityID = B.CustomerEntityID,
                A
                --select count(1)

          WHERE  B.CustomerEntityID IS NULL );
         /* */
         --alter index all on PRO.CUSTOMERCAL_test  rebuild
         --alter index all on PRO.ACCOUNTCAL_test   rebuild	 
         /* update ucifentityid from  customerentityid in case of ucifeentity is not  present */
         ----update pro.ACCOUNTCAL_test set UcifEntityID=CustomerEntityID	 where isnull(ucifentityid,0)=0
         ----update pro.CUSTOMERCAL_test set UcifEntityID=CustomerEntityID where isnull(ucifentityid,0)=0
         ----update pro.ACCOUNTCAL_test set UCIF_ID=RefCustomerID	 where UCIF_ID IS NULL
         ----update pro.CUSTOMERCAL_test set UCIF_ID=RefCustomerID where UCIF_ID IS NULL
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
            SET ENDTIME = SYSDATE,
                MODE_ = 'COMPLETE'
          WHERE  IdentityKey = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR_test') /*END:SQLDEV*/ 
                                   FROM DUAL  )
           AND TIMEKEY = v_TIMEKEY
           AND DESCRIPTION = 'INSERT DATA IN ACCOUNTCAL_test TABLE';
         ...
         /*-------------UPDATE ProductCode IN ACCOUNTCAL_test-------------------------------------*/
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
           ( UserID, DESCRIPTION, MODE_, StartTime, EndTime, TimeKey, SetID )
           ( SELECT USER ,
                    'UPDATE ProductCode IN ACCOUNTCAL_test' ,
         ...
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
          ...
          WHERE  IdentityKey = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR_test') /*END:SQLDEV*/ 
                                   FROM DUAL  )
           AND TIMEKEY = v_TIMEKEY
           AND DESCRIPTION = 'UPDATE ProductCode IN ACCOUNTCAL_test';
         ---Condition Change Required  Modification Done--- 
         ...
         /*-------------UPDATE BANK ASSET CLASSIFICATION IN ACCOUNTCAL_testL------------------------------------*/
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
           ( UserID, DESCRIPTION, MODE_, StartTime, EndTime, TimeKey, SetID )
           ( SELECT USER ,
                    'UPDATE BANK ASSET CLASSIFICATION IN ACCOUNTCAL_test' ,
                    'RUNNING' ,
                    SYSDATE ,
                    NULL ,
                    v_TIMEKEY ,
         ...
         WHEN MATCHED THEN UPDATE SET B.AccountStatus = src.SourceAssetClass,
                                      B.BankAssetClass = src.AssetClassMappingAlt_Key;
         ----------UPDATE  pro.ACCOUNTCAL_test
         ----------SET pro.ACCOUNTCAL_test.BankAssetClass =C.AssetClassAlt_Key
         ---------- 	 FROM pro.ACCOUNTCAL_test A
         ...
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
          ...
          WHERE  IdentityKey = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR_test') /*END:SQLDEV*/ 
                                   FROM DUAL  )
           AND TIMEKEY = v_TIMEKEY
           AND DESCRIPTION = 'UPDATE BANK ASSET CLASSIFICATION IN ACCOUNTCAL_test';
         ...
         --update a
         --        set  FacilityType='CC'
         --from pro.ACCOUNTCAL_test a WHERE FacilityType='CCOD'
         ------
         --UPDATE A SET A.OVERDUESINCEDT=DATEADD(DAY,-b.CD,@PROCESSINGDATE)
         --FROM PRO.ACCOUNTCAL_test A INNER  JOIN RBL_STGDB.DBO.ACCOUNT_ALL_SOURCE_SYSTEM b	on a.customeracid=b.CustomerAcID
         ...
         BEGIN
            MERGE INTO A 
            USING (SELECT A.ROWID row_id, NVL(c.SysAssetClassAlt_Key, 1) AS pos_2, NVL(c.SysAssetClassAlt_Key, 1) AS pos_3, NVL(C.SrcNPA_Dt, NULL) AS pos_4, NVL(C.SysNPA_Dt, NULL) AS pos_5, NVL(C.DbtDt, NULL) AS pos_6, NVL(C.LossDt, NULL) AS pos_7
            FROM A ,PRO_RBL_MISDB_PROD.CUSTOMERCAL_test A
         ...
         ----FROM PRO.CUSTOMERCAL_test A INNER JOIN #TEMPTABLE_VISIONPLUS_ASSETCLASS B
         ...
         BEGIN
            IF utils.object_id('TEMPDB..tt_TEMPTABLEPANCARD_34') IS NOT NULL THEN
             EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TEMPTABLEPANCARD_34 ';
            END IF;
            DELETE FROM tt_TEMPTABLEPANCARD_34;
            UTILS.IDENTITY_RESET('tt_TEMPTABLEPANCARD_34');

            INSERT INTO tt_TEMPTABLEPANCARD_34 ( 
            	SELECT PANNO ,
            ...
            EXECUTE IMMEDIATE ' ALTER TABLE tt_TEMPTABLEPANCARD_34 
               ADD ( SOURCEDBNAME VARCHAR2(20)  ) ';
            MERGE INTO A 
            USING (SELECT A.ROWID row_id, C.SOURCEDBNAME
            FROM A ,tt_TEMPTABLEPANCARD_34 A
                   JOIN PRO_RBL_MISDB_PROD.CUSTOMERCAL_test B   ON A.PANNO = B.PANNO
            ...
            FROM A ,PRO_RBL_MISDB_PROD.CUSTOMERCAL_test A
                   JOIN tt_TEMPTABLEPANCARD_34 B   ON A.PANNO = B.PANNO ) src
            ON ( A.ROWID = src.row_id )
            ...
            FROM A ,PRO_RBL_MISDB_PROD.CUSTOMERCAL_test A
                   JOIN tt_TEMPTABLEPANCARD_34 B   ON A.PANNO = B.PANNO 
         ...
         BEGIN
            IF utils.object_id('TEMPDB..tt_TEMPTABLE_ADHARCARD_34') IS NOT NULL THEN
             EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TEMPTABLE_ADHARCARD_34 ';
            END IF;
            DELETE FROM tt_TEMPTABLE_ADHARCARD_34;
            UTILS.IDENTITY_RESET('tt_TEMPTABLE_ADHARCARD_34');

            INSERT INTO tt_TEMPTABLE_ADHARCARD_34 ( 
            	SELECT AADHARCARDNO ,
                    MAX(NVL(SYSASSETCLASSALT_KEY, 1))  SYSASSETCLASSALT_KEY  ,
                    MIN(SYSNPA_DT)  SYSNPA_DT  ,
                    B.SOURCEDBNAME 
            ...
            USING (SELECT A.ROWID row_id, B.SYSASSETCLASSALT_KEY, B.SYSNPA_DT
            FROM A ,PRO_RBL_MISDB_PROD.CUSTOMERCAL_test A
                   JOIN tt_TEMPTABLE_ADHARCARD_34 B   ON A.AadharCardNO = B.AADHARCARDNO ) src
            ON ( A.ROWID = src.row_id )
            WHEN MATCHED THEN UPDATE SET A.SYSASSETCLASSALT_KEY = src.SYSASSETCLASSALT_KEY,
                                         A.SYSNPA_DT = src.SYSNPA_DT;
            MERGE INTO A 
            ...
            FROM A ,PRO_RBL_MISDB_PROD.CUSTOMERCAL_test A
                   JOIN tt_TEMPTABLE_ADHARCARD_34 B   ON A.AadharCardNO = B.AADHARCARDNO 
             WHERE A.SrcAssetClassAlt_Key = 1
              AND A.SysAssetClassAlt_Key > 1
              AND A.DegReason IS NULL) src
            ON ( A.ROWID = src.row_id )
         ...
         FROM ACL ,PRO_RBL_MISDB_PROD.ACCOUNTCAL_TEST ACL
         ...
         FROM ABD ,PRO_RBL_MISDB_PROD.ACCOUNTCAL_TEST ABD
                JOIN PRO_RBL_MISDB_PROD.CUSTOMERCAL_test CBD   ON ABD.CustomerEntityID = CBD.CustomerEntityID 
         ...
         ------FROM PRO.ACCOUNTCAL_test A LEFT  OUTER JOIN   PRO.CUSTOMERCAL_test  B 
         ...
         BEGIN
            ...
            FROM C ,PRO_RBL_MISDB_PROD.CUSTOMERCAL_test A
                   JOIN tt_TEMPTABLEPANCARD_34 B   ON A.PANNO = B.PANNO
                   JOIN PRO_RBL_MISDB_PROD.ACCOUNTCAL_TEST C   ON C.UcifEntityID = A.UcifEntityID ) src
         ...
         /*
         		...
         		BEGIN
         			UPDATE A SET  A.InitialNpaDt=isnull(C.NPADt,null)
         					   FROM PRO.ACCOUNTCAL_test A  LEFT hash JOIN dbo.AdvCustNPAdetail C
         		...
         		BEGIN
         			UPDATE A SET  A.InitialNpaDt=isnull(C.FinalNpaDt,null)
         					   FROM PRO.ACCOUNTCAL_test A  LEFT hash JOIN PRO.ACCOUNTCAL_Hist C
         ...
         */
         ...
         FROM A ,PRO_RBL_MISDB_PROD.ACCOUNTCAL_TEST A
                JOIN PRO_RBL_MISDB_PROD.CUSTOMERCAL_test B   ON A.CustomerEntityID = B.CustomerEntityID ) src
         ON ( A.ROWID = src.row_id )
         ...
         USING (SELECT A.ROWID row_id, B.SysNPA_Dt
         FROM A ,PRO_RBL_MISDB_PROD.ACCOUNTCAL_TEST A
                JOIN PRO_RBL_MISDB_PROD.CUSTOMERCAL_test B   ON A.UcifEntityID = B.UcifEntityID ) src
         ON ( A.ROWID = src.row_id )
         WHEN MATCHED THEN UPDATE SET A.FinalNpaDt = src.SysNPA_Dt;
         --WHERE A.INITIALASSETCLASSALT_KEY<>1
         IF v_PANCARDFLAG = 'Y' THEN
         ...
         MERGE INTO A 
         USING (SELECT A.ROWID row_id, 'ALWYS_NPA', 'NPA DUE TO WRITEOFF MARKING' AS pos_3, 2
         ----,A.SysNPA_Dt=CASE WHEN StatusDate IS NOT NULL THEN StatusDate ELSE @ProcessingDate END

         FROM A ,PRO_RBL_MISDB_PROD.CUSTOMERCAL_test A
                JOIN ExceptionFinalStatusType b   ON A.RefCustomerID = B.CustomerID
                AND b.EFFECTIVEFROMTIMEKEY <= v_TIMEKEY
                AND b.EffectiveToTimeKey >= v_TIMEKEY 
          WHERE B.StatusType IN ( 'TWO','WO' )
         ...
         WHEN MATCHED THEN UPDATE SET A.Asset_Norm = 'ALWYS_NPA',
                                      A.DegReason
                                      --,A.SysNPA_Dt=CASE WHEN StatusDate IS NOT NULL AND SysNPA_Dt>StatusDate THEN StatusDate
                                       --				ELSE SysNPA_Dt  END
                                       = pos_3;
         --Update ACL 
         --set Asset_Norm='ALWYS_NPA'
         ...
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
           ...
           ( SELECT USER ,
               ...
               FROM DUAL  );
         ---Condition Change Required  Modification Done--- 
         IF utils.object_id('TEMPDB..tt_PRVQTRRV_34') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_PRVQTRRV_34 ';
         END IF;
         DELETE FROM tt_PRVQTRRV_34;
         UTILS.IDENTITY_RESET('tt_PRVQTRRV_34');

         INSERT INTO tt_PRVQTRRV_34 ( 
         	SELECT * 
         ...
         FROM A ,PRO_RBL_MISDB_PROD.CUSTOMERCAL_test A
                JOIN tt_PRVQTRRV_34 B   ON A.CustomerEntityID = B.CUSTOMERENTITYID ) src
         ON ( A.ROWID = src.row_id )
         ...
         IF utils.object_id('TEMPDB..tt_CurntQtrRv_34') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_CurntQtrRv_34 ';
         END IF;
         DELETE FROM tt_CurntQtrRv_34;
         UTILS.IDENTITY_RESET('tt_CurntQtrRv_34');

         INSERT INTO tt_CurntQtrRv_34 ( 
         	SELECT * 
         ...
         FROM A ,PRO_RBL_MISDB_PROD.CUSTOMERCAL_test A
                JOIN tt_CurntQtrRv_34 B   ON A.CustomerEntityID = B.CUSTOMERENTITYID ) src
         ON ( A.ROWID = src.row_id )
         ...
         ----UPDATE A SET A.SecurityValue= ISNULL(B.Total_PriSec,0)+ISNULL(B.Total_CollSec,0)  FROM PRO.ACCOUNTCAL_test A INNER  JOIN #TEMPSECURITY B
         ----ON A.AccountEntityID=B.AccountEntityID




         UPDATE PRO.PROCESSMONITOR_test SET ENDTIME=GETDATE() ,MODE='COMPLETE' WHERE IdentityKey = (SELECT IDENT_CURRENT('PRO.PROCESSMONITOR_test')) AND TIMEKEY=@TIMEKEY AND DESCRIPTION='update security value at account level'
         ...
         ----UPDATE A SET A.CURNTQTRRV=ISNULL(A.CURNTQTRRV,0) FROM PRO.CUSTOMERCAL_test A  INNER JOIN 
         ----(
         ----SELECT A.CUSTOMERENTITYID,SUM(ISNULL(A.SecurityValue,0)) as CURNTQTRRV FROM PRO.ACCOUNTCAL_test A 
         ...
         ----UPDATE PRO.PROCESSMONITOR_test SET ENDTIME=GETDATE() ,MODE='COMPLETE' WHERE IdentityKey = (SELECT IDENT_CURRENT('PRO.PROCESSMONITOR_test')) AND TIMEKEY=@TIMEKEY AND DESCRIPTION='UPDATE FINAL CURNTQTRRV AT  CUSTOMER LEVEL'
         ...
         ------FROM PRO.ACCOUNTCAL_test A INNER  JOIN dbo.AdvAcBasicDetail B ON A.AccountEntityID=B.AccountEntityID
         ------WHERE  (B.EffectiveFromTimeKey<=@TIMEKEY and B.EffectiveToTimeKey>=@TIMEKEY)
         ------AND B.FlgSecured='S'
         ------AND A.FlgSecured='U'

         --UPDATE B SET SecApp='S'
         --FROM  PRO.ACCOUNTCAL_test B
         ...
         */
         ...
         FROM B ,PRO_RBL_MISDB_PROD.ACCOUNTCAL_TEST B
                JOIN PRO_RBL_MISDB_PROD.CUSTOMERCAL_test a   ON A.CustomerEntityID = B.CustomerEntityID 
         ...
         IF utils.object_id('TEMPDB..tt_BILL_OVERDUE_34') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_BILL_OVERDUE_34 ';
         END IF;
         DELETE FROM tt_BILL_OVERDUE_34;
         UTILS.IDENTITY_RESET('tt_BILL_OVERDUE_34');

         INSERT INTO tt_BILL_OVERDUE_34 ( 
         ...
         IF utils.object_id('TEMPDB..tt_BILL_OVERDUE_34_FINAL') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_BILL_OVERDUE_FINAL_32 ';
         END IF;
         DELETE FROM tt_BILL_OVERDUE_FINAL_32;
         UTILS.IDENTITY_RESET('tt_BILL_OVERDUE_FINAL_32');

         INSERT INTO tt_BILL_OVERDUE_FINAL_32 ( 
         	SELECT AccountEntityId ,
                 SUM(BALANCE)  BILOVERDUE  ,
                 MIN(BILLDUEDT)  BILLOVERDUEDT  
         	  FROM tt_BILL_OVERDUE_34 
         	  GROUP BY AccountEntityId );
         MERGE INTO PRO_RBL_MISDB_PROD.ACCOUNTCAL_TEST 
         USING (SELECT PRO_RBL_MISDB_PROD.ACCOUNTCAL_TEST.ROWID row_id, B.BILLOVERDUEDT, B.BILOVERDUE
         FROM PRO_RBL_MISDB_PROD.ACCOUNTCAL_TEST A
                JOIN tt_BILL_OVERDUE_FINAL_32 B   ON A.AccountEntityID = B.AccountEntityId ) src
         ...
         IF utils.object_id('TEMPDB..tt_PC_OVERDUE_34') IS NOT NULL THEN
          --update a
         ...
         /*RESTRUCTURE UPDATES */
         EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_PC_OVERDUE_34 ';
         END IF;
         DELETE FROM tt_PC_OVERDUE_34;
         UTILS.IDENTITY_RESET('tt_PC_OVERDUE_34');

         INSERT INTO tt_PC_OVERDUE_34 ( 
         	SELECT AccountEntityID ,
                 PCRefNo ,
                 BALANCE ,
                 CASE 
         	 ...
         	 WHERE  EFFECTIVEFROMTIMEKEY <= v_TIMEKEY
                  ...
                  ELSE PCExtendedDueDt
                     END) < v_PROCESSINGDATE );
         IF utils.object_id('TEMPDB..tt_PC_OVERDUE_34_FINAL') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_PC_OVERDUE_FINAL_34 ';
         END IF;
         DELETE FROM tt_PC_OVERDUE_FINAL_34;
         UTILS.IDENTITY_RESET('tt_PC_OVERDUE_FINAL_34');

         INSERT INTO tt_PC_OVERDUE_FINAL_34 ( 
         	SELECT AccountEntityId ,
                 SUM(BALANCE)  PCOVERDUE  ,
                 MIN(PCOVERDUEDUEDT)  PCOVERDUEDUEDT  
         	  FROM tt_PC_OVERDUE_34 
         	  GROUP BY AccountEntityId );
         MERGE INTO PRO_RBL_MISDB_PROD.ACCOUNTCAL_TEST 
         USING (SELECT PRO_RBL_MISDB_PROD.ACCOUNTCAL_TEST.ROWID row_id, B.PCOVERDUEDUEDT, B.PCOVERDUE
         FROM PRO_RBL_MISDB_PROD.ACCOUNTCAL_TEST A
                JOIN tt_PC_OVERDUE_FINAL_34 B   ON A.AccountEntityID = B.AccountEntityId ) src
         ON ( PRO_RBL_MISDB_PROD.ACCOUNTCAL_TEST.ROWID = src.row_id )
         ...
         --END
         --UPDATE PRO.PROCESSMONITOR_test SET ENDTIME=GETDATE() ,MODE='COMPLETE' WHERE IdentityKey = (SELECT IDENT_CURRENT('PRO.PROCESSMONITOR_test')) AND  TIMEKEY=@TIMEKEY AND DESCRIPTION='UPDATE PrvQtrInt,CurQtrInt,CurQtrCredit,PreQtrCredit'
         /*------------------UPDATE INTSERVICESDT IN PRO.ACCOUNTCAL_test------------------*/
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
           ( USERID, DESCRIPTION, MODE_, STARTTIME, ENDTIME, TIMEKEY, SETID )
           ( SELECT USER ,
                    'UPDATE INTNOTSERVICEDDT IN PRO.ACCOUNTCAL_test' ,
                    'RUNNING' ,
                    SYSDATE ,
                    NULL ,
                    v_TIMEKEY ,
         ...
         IF ( ( utils.month_(v_ProcessingDate) IN ( 3,12 )

           AND utils.day_(v_ProcessingDate) = 31 )
           OR ( utils.month_(v_ProcessingDate) IN ( 6,9 )

           AND utils.day_(v_ProcessingDate) = 30 ) ) THEN
         ...
         --FROM PRO.ACCOUNTCAL_test A  INNER JOIN DimProduct C 
         ...
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
          ...
          WHERE  IDENTITYKEY = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR_test') /*END:SQLDEV*/ 
                                   FROM DUAL  )
           AND TIMEKEY = v_TIMEKEY
           AND DESCRIPTION = 'UPDATE INTNOTSERVICEDDT IN PRO.ACCOUNTCAL_test';
         ...
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
           ...
           ( SELECT USER ,
                    ...
                    v_SetID 
               FROM DUAL  );
         IF utils.object_id('Tempdb..tt_Stock_34') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Stock_34 ';
         END IF;
         DELETE FROM tt_Stock_34;
         UTILS.IDENTITY_RESET('tt_Stock_34');

         INSERT INTO tt_Stock_34 ( 
         	SELECT AccountEntityId ,
         	  ...
         	  GROUP BY AccountEntityId );
         ----CREATE CLUSTERED INDEX tt_Stock_34_IX ON tt_Stock_34(AccountEntityId)
         ----CREATE NONCLUSTERED INDEX tt_Stock_34NON ON tt_Stock_34(AccountEntityId,StkSmtDt)
         ----IF OBJECT_ID('Tempdb..tt_Stock_342') IS NOT NULL
         ----DROP TABLE tt_Stock_342
         ...
         ----			GROUP BY AccountEntityId
         ----CREATE CLUSTERED INDEX tt_Stock_342_IX ON tt_Stock_342(AccountEntityId)
         ----CREATE NONCLUSTERED INDEX tt_Stock_342NON ON tt_Stock_342(AccountEntityId,StkSmtDt)
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
            SET ENDTIME = SYSDATE,
                MODE_ = 'COMPLETE'
          WHERE  IDENTITYKEY = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR_test') /*END:SQLDEV*/ 
         ...
         /*-----UPDATE STOCK STATEMENT DATE IN PRO.ACCOUNTCAL_test----------------------------------------------------*/
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
           ( UserID, DESCRIPTION, MODE_, StartTime, EndTime, TimeKey, SetID )
           ( SELECT USER ,
                    'update stock statement date in pro.ACCOUNTCAL_test' ,
         ...
         --FROM PRO.ACCOUNTCAL_test A 
         --INNER  JOIN tt_Stock_34 SD ON A.AccountEntityId=SD.AccountEntityId
         ...
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
          ...
          WHERE  IdentityKey = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR_test') /*END:SQLDEV*/ 
                                   FROM DUAL  )
           AND TIMEKEY = v_TIMEKEY
           AND DESCRIPTION = 'update stock statement date in pro.ACCOUNTCAL_test';
         /*------UPDATE DerecognisedInterest1 AMT IN PRO.ACCOUNTCAL_test---------------------*/
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
           ( UserID, DESCRIPTION, MODE_, StartTime, EndTime, TimeKey, SetID )
           ( SELECT USER ,
                    'UPDATE DerecognisedInterest1 AMT IN PRO.ACCOUNTCAL_test' ,
                    ...
                    v_SetID 
               FROM DUAL  );
         IF utils.object_id('TEMPDB..tt_TEMPDerecognisedInterest_67') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TEMPDerecognisedInterest_67 ';
         END IF;
         DELETE FROM tt_TEMPDerecognisedInterest_67;
         INSERT INTO tt_TEMPDerecognisedInterest_67
         ...
         /*-----UPDATE DerecognisedInterest1 IN PRO.ACCOUNTCAL_test TABLE ----------------------------*/
         MERGE INTO A 
         USING (SELECT A.ROWID row_id, B.DerecognisedInterest1
         FROM A ,PRO_RBL_MISDB_PROD.ACCOUNTCAL_TEST A
                JOIN tt_TEMPDerecognisedInterest_67 B   ON A.AccountEntityID = B.ACCOUNTENTITYID ) src
         ON ( A.ROWID = src.row_id )
         ...
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
          ...
          WHERE  IdentityKey = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR_test') /*END:SQLDEV*/ 
                                   FROM DUAL  )
           AND TIMEKEY = v_TIMEKEY
           AND DESCRIPTION = 'UPDATE DerecognisedInterest1 AMT IN PRO.ACCOUNTCAL_test';
         /*------UPDATE DerecognisedInterest2 AMT IN PRO.ACCOUNTCAL_test---------------------*/
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
           ( UserID, DESCRIPTION, MODE_, StartTime, EndTime, TimeKey, SetID )
           ( SELECT USER ,
                    'UPDATE DerecognisedInterest2 AMT IN PRO.ACCOUNTCAL_test' ,
                    ...
                    v_SetID 
               FROM DUAL  );
         IF utils.object_id('TEMPDB..tt_TEMPDerecognisedInterest_68') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TEMPDerecognisedInterest_68 ';
         END IF;
         DELETE FROM tt_TEMPDerecognisedInterest_68;
         INSERT INTO tt_TEMPDerecognisedInterest_68
           ...
           ( SELECT A.ACCOUNTENTITYID ,
             ...
             FROM RBL_MISDB_PROD.ADVFACDLDETAIL C
              WHERE  ( C.EFFECTIVEFROMTIMEKEY <= v_TIMEKEY
                       ...
                       AND NVL(DerecognisedInterest2, 0) > 0
               GROUP BY C.ACCOUNTENTITYID );
         /*-----UPDATE DerecognisedInterest2 IN PRO.ACCOUNTCAL_test TABLE ----------------------------*/
         MERGE INTO A 
         USING (SELECT A.ROWID row_id, B.DerecognisedInterest2
         FROM A ,PRO_RBL_MISDB_PROD.ACCOUNTCAL_TEST A
                JOIN tt_TEMPDerecognisedInterest_68 B   ON A.AccountEntityID = B.ACCOUNTENTITYID ) src
         ON ( A.ROWID = src.row_id )
         ...
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
          ...
          WHERE  IdentityKey = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR_test') /*END:SQLDEV*/ 
                                   FROM DUAL  )
           AND TIMEKEY = v_TIMEKEY
           AND DESCRIPTION = 'UPDATE DerecognisedInterest2 AMT IN PRO.ACCOUNTCAL_test';
         ...
         */
         ...
         /*------------------UPDATE FRAUD ACCOUNT MARKING  IN PRO.ACCOUNTCAL_test------------------*/
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
           ( USERID, DESCRIPTION, MODE_, STARTTIME, ENDTIME, TIMEKEY, SETID )
           ( SELECT USER ,
                    'UPDATE FRAUD ACCOUNT MARKING  IN PRO.ACCOUNTCAL_test' ,
         ...
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
          ...
          WHERE  IDENTITYKEY = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR_test') /*END:SQLDEV*/ 
                                   FROM DUAL  )
           AND TIMEKEY = v_TIMEKEY
           AND DESCRIPTION = 'UPDATE FRAUD ACCOUNT MARKING  IN PRO.ACCOUNTCAL_test';
         /*------------------UPDATE FRAUD ACCOUNT MARKING  IN PRO.CUSTOMERCAL_test------------------*/
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
           ( USERID, DESCRIPTION, MODE_, STARTTIME, ENDTIME, TIMEKEY, SETID )
           ( SELECT USER ,
                    'UPDATE FRAUD ACCOUNT MARKING  IN PRO.CUSTOMERCAL_test' ,
         ...
         ELSE StatusDate
            END AS pos_5, 'NPA DUE TO FRAUD MARKING' AS pos_6
         FROM C ,PRO_RBL_MISDB_PROD.CUSTOMERCAL_test c
         ...
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
          ...
          WHERE  IDENTITYKEY = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR_test') /*END:SQLDEV*/ 
                                   FROM DUAL  )
           AND TIMEKEY = v_TIMEKEY
           AND DESCRIPTION = 'UPDATE FRAUD ACCOUNT MARKING  IN PRO.CUSTOMERCAL_test';
         /*------------------UPDATE IBPC MARKING  IN PRO.ACCOUNTCAL_test------------------*/
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
           ( USERID, DESCRIPTION, MODE_, STARTTIME, ENDTIME, TIMEKEY, SETID )
           ( SELECT USER ,
                    'UPDATE IBPC MARKING  IN PRO.ACCOUNTCAL_test' ,
         ...
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
          ...
          WHERE  IDENTITYKEY = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR_test') /*END:SQLDEV*/ 
                                   FROM DUAL  )
           AND TIMEKEY = v_TIMEKEY
           AND DESCRIPTION = 'UPDATE IBPC MARKING  IN PRO.ACCOUNTCAL_test';
         /*------------------UPDATE Securitised MARKING  IN PRO.ACCOUNTCAL_test------------------*/
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
           ( USERID, DESCRIPTION, MODE_, STARTTIME, ENDTIME, TIMEKEY, SETID )
           ( SELECT USER ,
                    'UPDATE Securitised MARKING  IN PRO.ACCOUNTCAL_test' ,
         ...
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
          ...
          WHERE  IDENTITYKEY = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR_test') /*END:SQLDEV*/ 
                                   FROM DUAL  )
           AND TIMEKEY = v_TIMEKEY
           AND DESCRIPTION = 'UPDATE Securitised MARKING  IN PRO.ACCOUNTCAL_test';
         /*------------------UPDATE PUI MARKING  IN PRO.ACCOUNTCAL_test------------------*/
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
           ( USERID, DESCRIPTION, MODE_, STARTTIME, ENDTIME, TIMEKEY, SETID )
           ( SELECT USER ,
                    'UPDATE PUI MARKING  IN PRO.ACCOUNTCAL_test' ,
         ...
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
          ...
          WHERE  IDENTITYKEY = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR_test') /*END:SQLDEV*/ 
                                   FROM DUAL  )
           AND TIMEKEY = v_TIMEKEY
           AND DESCRIPTION = 'UPDATE PUI MARKING  IN PRO.ACCOUNTCAL_test';
         /*------------------UPDATE RFA MARKING  IN PRO.ACCOUNTCAL_test------------------*/
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
           ( USERID, DESCRIPTION, MODE_, STARTTIME, ENDTIME, TIMEKEY, SETID )
           ( SELECT USER ,
                    'UPDATE RFA MARKING  IN PRO.ACCOUNTCAL_test' ,
         ...
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
          ...
          WHERE  IDENTITYKEY = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR_test') /*END:SQLDEV*/ 
                                   FROM DUAL  )
           AND TIMEKEY = v_TIMEKEY
           AND DESCRIPTION = 'UPDATE RFA MARKING  IN PRO.ACCOUNTCAL_test';
         /*------------------UPDATE NonCooperative MARKING  IN PRO.ACCOUNTCAL_test------------------*/
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
           ( USERID, DESCRIPTION, MODE_, STARTTIME, ENDTIME, TIMEKEY, SETID )
           ( SELECT USER ,
                    'UPDATE NonCooperative MARKING  IN PRO.ACCOUNTCAL_test' ,
         ...
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
          ...
          WHERE  IDENTITYKEY = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR_test') /*END:SQLDEV*/ 
                                   FROM DUAL  )
           AND TIMEKEY = v_TIMEKEY
           AND DESCRIPTION = 'UPDATE NonCooperative MARKING  IN PRO.ACCOUNTCAL_test';
         /*------------------UPDATE Repossessed ACCOUNT MARKING  IN PRO.ACCOUNTCAL_test------------------*/
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
           ( USERID, DESCRIPTION, MODE_, STARTTIME, ENDTIME, TIMEKEY, SETID )
           ( SELECT USER ,
                    'UPDATE Repossessed ACCOUNT MARKING  IN PRO.ACCOUNTCAL_test' ,
         ...
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
          ...
          WHERE  IDENTITYKEY = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR_test') /*END:SQLDEV*/ 
                                   FROM DUAL  )
           AND TIMEKEY = v_TIMEKEY
           AND DESCRIPTION = 'UPDATE Repossessed ACCOUNT MARKING  IN PRO.ACCOUNTCAL_test';
         /*------------------UPDATE Inherent Weakness  ACCOUNT MARKING  IN PRO.ACCOUNTCAL_test------------------*/
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
           ( USERID, DESCRIPTION, MODE_, STARTTIME, ENDTIME, TIMEKEY, SETID )
           ( SELECT USER ,
                    'UPDATE Inherent Weakness ACCOUNT MARKING  IN PRO.ACCOUNTCAL_test' ,
         ...
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
          ...
          WHERE  IDENTITYKEY = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR_test') /*END:SQLDEV*/ 
                                   FROM DUAL  )
           AND TIMEKEY = v_TIMEKEY
           AND DESCRIPTION = 'UPDATE Inherent Weakness ACCOUNT MARKING  IN PRO.ACCOUNTCAL_test';
         /*------------------UPDATE SARFAESI ACCOUNT MARKING IN PRO.ACCOUNTCAL_test------------------*/
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
           ( USERID, DESCRIPTION, MODE_, STARTTIME, ENDTIME, TIMEKEY, SETID )
           ( SELECT USER ,
                    'UPDATE SARFAESI ACCOUNT MARKING IN PRO.ACCOUNTCAL_test' ,
         ...
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
          ...
          WHERE  IDENTITYKEY = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR_test') /*END:SQLDEV*/ 
                                   FROM DUAL  )
           AND TIMEKEY = v_TIMEKEY
           AND DESCRIPTION = 'UPDATE SARFAESI ACCOUNT MARKING IN PRO.ACCOUNTCAL_test';
         /*------------------UPDATE RC-Pending MARKING  IN PRO.ACCOUNTCAL_test------------------*/
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
           ( USERID, DESCRIPTION, MODE_, STARTTIME, ENDTIME, TIMEKEY, SETID )
           ( SELECT USER ,
                    'UPDATE RC-Pending MARKING  IN PRO.ACCOUNTCAL_test' ,
         ...
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
          ...
          WHERE  IDENTITYKEY = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR_test') /*END:SQLDEV*/ 
                                   FROM DUAL  )
           AND TIMEKEY = v_TIMEKEY
           AND DESCRIPTION = 'UPDATE RC-Pending MARKING  IN PRO.ACCOUNTCAL_test';
         /*------------------UPDATE Written-Off Accounts ACCOUNT MARKING  IN PRO.ACCOUNTCAL_test------------------*/
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
           ( USERID, DESCRIPTION, MODE_, STARTTIME, ENDTIME, TIMEKEY, SETID )
           ( SELECT USER ,
                    'UPDATE Written-Off Accounts MARKING IN PRO.ACCOUNTCAL_test' ,
                    'RUNNING' ,
                    SYSDATE ,
                    NULL ,
                    v_TIMEKEY ,
         ...
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
          ...
          WHERE  IDENTITYKEY = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR_test') /*END:SQLDEV*/ 
                                   FROM DUAL  )
           AND TIMEKEY = v_TIMEKEY
           AND DESCRIPTION = 'UPDATE Written-Off Accounts MARKING IN PRO.ACCOUNTCAL_test';
         INSERT INTO PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
           ( USERID, DESCRIPTION, MODE_, STARTTIME, ENDTIME, TIMEKEY, SETID )
           ( SELECT USER ,
                    'UPDATE CONDI_STD IN PRO.ACCOUNTCAL_test' ,
                    'RUNNING' ,
                    SYSDATE ,
                    NULL ,
                    v_TIMEKEY ,
         ...
         FROM A ,PRO_RBL_MISDB_PROD.ACCOUNTCAL_TEST A
                JOIN ( SELECT C.AccountEntityID ,
                       ...
                       FROM RBL_MISDB_PROD.AdvSecurityValueDetail B
                              ...
                              JOIN PRO_RBL_MISDB_PROD.ACCOUNTCAL_TEST C   ON Advsec.AccountEntityID = C.AccountEntityID
         ...
         FROM A ,PRO_RBL_MISDB_PROD.ACCOUNTCAL_TEST A
                JOIN PRO_RBL_MISDB_PROD.ContinousExcessSecDtACCOUNTCAL_test B   ON A.CustomerAcID = B.CustomerAcID 
          WHERE B.EffectiveFromTimeKey <= v_TIMEKEY
           AND B.EffectiveToTimeKey >= v_TIMEKEY) src
         ON ( A.ROWID = src.row_id )
         ...
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
          ...
          WHERE  IDENTITYKEY = ( SELECT /*TODO:SQLDEV*/ IDENT_CURRENT('PRO.PROCESSMONITOR_test') /*END:SQLDEV*/ 
                                   FROM DUAL  )
           AND TIMEKEY = v_TIMEKEY
           AND DESCRIPTION = 'UPDATE CONDI_STD IN PRO.ACCOUNTCAL_test';
         ...
         FROM A ,PRO_RBL_MISDB_PROD.ACCOUNTCAL_TEST A
                JOIN PRO_RBL_MISDB_PROD.LastCreditDtACCOUNTCAL_test B   ON ( B.EFFECTIVEFROMTIMEKEY <= v_TIMEKEY
                AND B.EFFECTIVETOTIMEKEY >= v_TIMEKEY )
         ...
         --INNER JOIN PRO.ACCOUNTCAL_test B
         --ON A.CUSTOMERACID=B.CUSTOMERACID
         UPDATE PRO_RBL_MISDB_PROD.ProcessMonitor_TEST
            SET ENDTIME = SYSDATE,
                MODE_ = 'COMPLETE'
         ...
         --                   DA.EFFECTIVETOTIMEKEY>=@TIMEKEY
         --WHERE B.MOCTYPE='AUTO' AND  B.EFFECTIVEFROMTIMEKEY<=@TIMEKEY AND  B.EFFECTIVETOTIMEKEY>=@TIMEKEY
         --UPDATE  A SET DBTDT=@PROCESSINGDATE FROM PRO.CUSTOMERCAL_test A  
         ...
         IF tt_MOC_DATA_34  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_MOC_DATA_34;
         UTILS.IDENTITY_RESET('tt_MOC_DATA_34');

         INSERT INTO tt_MOC_DATA_34 ( 
         	SELECT UcifEntityID ,
         ...
         ELSE 'ALWYS_NPA'
            END AS pos_2, b.MOCTYPE, B.SysAssetClassAlt_Key, B.SysNPA_Dt
         FROM A ,PRO_RBL_MISDB_PROD.CUSTOMERCAL_test A
                JOIN tt_MOC_DATA_34 B   ON A.UcifEntityID = B.UcifEntityID ) src
         ON ( A.ROWID = src.row_id )
         ...
         WHEN MATCHED THEN UPDATE SET A.Asset_Norm = pos_2,
                                      A.MOCTYPE = src.MOCTYPE,
                                      A.FinalAssetClassAlt_Key = src.SysAssetClassAlt_Key,
...
/
  ...
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAFORASSETCLASSFICATIONRBL_TEST_04122023" TO "ADF_CDR_RBL_STGDB";
