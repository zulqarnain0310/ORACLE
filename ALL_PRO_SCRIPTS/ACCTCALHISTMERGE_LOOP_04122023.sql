--------------------------------------------------------
--  DDL for Procedure ACCTCALHISTMERGE_LOOP_04122023
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" 
----USE [RBL_MISDB]
 ----GO
...
BEGIN
   ...
   IF tt_TIMEKEY_2  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_TIMEKEY_2;
   UTILS.IDENTITY_RESET('tt_TIMEKEY_2');

   INSERT INTO tt_TIMEKEY_2 SELECT Timekey ,
                                   DATE_ ,
   ...
   LOOP 
      ...
      BEGIN
         ...
         IF tt_acdata_2  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_acdata_2;
         UTILS.IDENTITY_RESET('tt_acdata_2');

         INSERT INTO tt_acdata_2 ( 
         	SELECT * ,
                 'N' IsChanged  ,
         ...
         BEGIN
            ...
            FROM T ,PRO_RBL_MISDB_PROD.AccountCal_Hist_new O
                   JOIN tt_acdata_2 T   ON O.AccountEntityID = T.AccountEntityID
            ...
            FROM TEMP ,tt_acdata_2 TEMP
                   JOIN ( SELECT tt_acdata_2.AccountEntityId ,
                                 (v_EntityKeyAc + ROW_NUMBER() OVER ( ORDER BY ( SELECT 1 
                                                                                   FROM DUAL  )  )) EntityKeyNew  
                          FROM tt_acdata_2 
                           WHERE  tt_acdata_2.IsChanged IN ( 'C','N' )
...
/
  ...
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."ACCTCALHISTMERGE_LOOP_04122023" TO "ADF_CDR_RBL_STGDB";
