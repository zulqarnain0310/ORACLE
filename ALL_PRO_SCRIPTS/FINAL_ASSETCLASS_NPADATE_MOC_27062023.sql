--------------------------------------------------------
--  DDL for Procedure FINAL_ASSETCLASS_NPADATE_MOC_27062023
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" /*=========================================
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         --IF OBJECT_ID('TEMPDB..tt_TEMPTABLE_UCFIC1_18') IS NOT NULL
         --   DROP TABLE tt_TEMPTABLE_UCFIC1_18
         ...
         -- INTO tt_TEMPTABLE_UCFIC1_18 FROM PRO.CUSTOMERCAL A
         ...
         IF utils.object_id('TEMPDB..tt_CTE_PERC_17') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_CTE_PERC_17 ';
         END IF;
         DELETE FROM tt_CTE_PERC_17;
         UTILS.IDENTITY_RESET('tt_CTE_PERC_17');

         INSERT INTO tt_CTE_PERC_17 ( 
         	SELECT * 
         	  FROM (  /* ADVANCE DATA */
                   SELECT UCIF_ID ,
         ...
         IF utils.object_id('TEMPDB..tt_TEMPTABLE_UCFIC1_18') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TEMPTABLE_UCFIC1_18 ';
         END IF;
         DELETE FROM tt_TEMPTABLE_UCFIC1_18;
         UTILS.IDENTITY_RESET('tt_TEMPTABLE_UCFIC1_18');

         INSERT INTO tt_TEMPTABLE_UCFIC1_18 ( 
         	SELECT UCIF_ID ,
         ...
         FROM A ,tt_TEMPTABLE_UCFIC1_18 A
                JOIN tt_CTE_PERC_17 B   ON A.UCIF_ID = B.UCIF_ID
         ...
         IF tt_CTE_PERC_17  --SQLDEV: NOT RECOGNIZED
         MERGE INTO A 
         ...
         FROM A ,PRO_RBL_MISDB_PROD.CUSTOMERCAL A
                JOIN tt_TEMPTABLE_UCFIC1_18 B   ON A.UCIF_ID = B.UCIF_ID ) src
         ON ( A.ROWID = src.row_id )
         ...
         IF tt_TEMPTABLE_UCFIC1_18  --SQLDEV: NOT RECOGNIZED
         MERGE INTO A 
         ...
         ----FROM PRO.CustomerCal A INNER JOIN tt_TEMPTABLE_UCFIC1_18 B ON A.UCIF_ID=B.UCIF_ID
         ...
         IF utils.object_id('TEMPDB..tt_Data_18') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Data_18 ';
         END IF;
         DELETE FROM tt_Data_18;
         UTILS.IDENTITY_RESET('tt_Data_18');

         INSERT INTO tt_Data_18 ( 
         	SELECT DISTINCT DegReason ,
                          SourceSystemCustomerID 
         	  FROM PRO_RBL_MISDB_PROD.ACCOUNTCAL 
         	 WHERE  DegReason IS NOT NULL
                    AND FLGDEG = 'Y' );
         IF utils.object_id('TEMPDB..tt_DD_8') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_DD_8 ';
         END IF;
         DELETE FROM tt_DD_8;
         UTILS.IDENTITY_RESET('tt_DD_8');

         INSERT INTO tt_DD_8 SELECT SourceSystemCustomerID ,
                                    DegReason ,
                                    ROW_NUMBER() OVER ( PARTITION BY SourceSystemCustomerID ORDER BY SourceSystemCustomerID  ) RN  
              FROM tt_Data_18 ;
         IF utils.object_id('TEMPDB..tt_NPADegReason_18') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_NPADegReason_18 ';
         END IF;
         DELETE FROM tt_NPADegReason_18;
         UTILS.IDENTITY_RESET('tt_NPADegReason_18');

         INSERT INTO tt_NPADegReason_18 ( 
         	SELECT PivotTable.SourceSystemCustomerID,
         	  ...
         	  FROM ( 
         	     SELECT SourceSystemCustomerID ,
                      , 
                       aggregate
         	       FROM tt_DD_8 ( SELECT PivotTable.SourceSystemCustomerID,
         	         MAX( DECODE( , , PivotTable.aggregate, NULL) ) "Pivot Column"                                
         	  FROM ( 
         	     SELECT SourceSystemCustomerID ,
         	            , 
         ...
         USING (SELECT A.ROWID row_id, B.DegReason
         FROM A ,PRO_RBL_MISDB_PROD.CUSTOMERCAL A
                JOIN tt_NPADegReason_18 B   ON A.SourceSystemCustomerID = B.SourceSystemCustomerID
                AND A.FlgDeg = 'Y' ) src
         ON ( A.ROWID = src.row_id )
...
/
  ...
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."FINAL_ASSETCLASS_NPADATE_MOC_27062023" TO "ADF_CDR_RBL_STGDB";
