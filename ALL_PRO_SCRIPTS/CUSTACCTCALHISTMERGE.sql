...
BEGIN
   ...
   BEGIN
      DELETE FROM tt_AdvAcRestructureDetail;
      UTILS.IDENTITY_RESET('tt_AdvAcRestructureDetail');

      INSERT INTO tt_AdvAcRestructureDetail ( 
      	SELECT * ,
              ' ' IsChanged  
      ...
      FROM A ,tt_AdvAcRestructureDetail A
      ...
      FROM O ,CurDat_RBL_MISDB_PROD.AdvAcRestructureDetail O
             JOIN tt_AdvAcRestructureDetail T   ON O.AccountEntityID = T.AccountEntityID
             AND O.EffectiveToTimeKey = 49999
      ...
      FROM A ,CurDat_RBL_MISDB_PROD.AdvAcRestructureDetail A
             JOIN tt_AdvAcRestructureDetail B   ON A.AccountEntityId = B.AccountEntityId
      ...
      INSERT INTO CurDat_RBL_MISDB_PROD.AdvAcRestructureDetail
        ...
        ( SELECT AccountEntityId ,
                 ...
                 InvestmentGrade ,
                 POS_10PerPaidDate 
          FROM tt_AdvAcRestructureDetail T
