--------------------------------------------------------
--  DDL for Procedure REVERSEFEEDDATA_INSERT_21082024
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" /*==============================================
...
BEGIN
   ...
   IF utils.object_id('TEMPDB..tt_ReverseFeedData_3') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_ReverseFeedData_3 ';
   END IF;
   DELETE FROM tt_ReverseFeedData_3;
   INSERT INTO tt_ReverseFeedData_3
     ...
     ( SELECT v_DATE DateofData  ,
       ...
       FROM PRO_RBL_MISDB_PROD.ACCOUNTCAL A
              ...
              JOIN DimSourceDB D   ON A.SourceAlt_Key = D.SourceAlt_Key
   ...
   INSERT INTO ReverseFeedData
     ...
     ( SELECT A.DateofData ,
       ...
       FROM tt_ReverseFeedData_3 A );--					LEFT JOIN ReverseFeedData B ON A.AccountID=B.AccountID
   ...
   --LEFT JOIN tt_ReverseFeedData_3 B ON  AA.AccountID=B.AccountID AND B.EffectiveToTimeKey =49999
   ...
   --AND  EXISTS (SELECT 1 FROM tt_ReverseFeedData_3 BB
...
/
  ...
  GRANT EXECUTE ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."REVERSEFEEDDATA_INSERT_21082024" TO "ADF_CDR_RBL_STGDB";
