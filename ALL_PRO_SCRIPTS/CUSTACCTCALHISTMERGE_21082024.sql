--------------------------------------------------------
--  DDL for Procedure CUSTACCTCALHISTMERGE_21082024
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" 
-- =============================================
 -- Author:		<Author,,Name>
...
BEGIN
   ...
   BEGIN
      ...
      FROM TEMP ,PRO_RBL_MISDB_PROD.CUSTOMERCAL TEMP
             JOIN ( SELECT CUSTOMERCAL.CustomerEntityID ,
                    ...
                    FROM PRO_RBL_MISDB_PROD.CUSTOMERCAL  ) ACCT   ON TEMP.CustomerEntityID = ACCT.CustomerEntityID 
      ...
      FROM TEMP ,PRO_RBL_MISDB_PROD.ACCOUNTCAL TEMP
             JOIN ( SELECT ACCOUNTCAL.AccountEntityId ,
                           (v_EntityKeyAc + ROW_NUMBER() OVER ( ORDER BY ( SELECT 1 
                                                                             FROM DUAL  )  )) EntityKeyNew  
                    FROM PRO_RBL_MISDB_PROD.ACCOUNTCAL  ) ACCT   ON TEMP.AccountEntityID = ACCT.AccountEntityId 
       WHERE Temp.IsChanged IN ( 'C','N' )
      ) src
      ON ( TEMP.ROWID = src.row_id )
      WHEN MATCHED THEN UPDATE SET TEMP.EntityKeyNew = src.EntityKeyNew;
   ...
   BEGIN
      DELETE FROM tt_AdvAcRestructureDetail_3;
      UTILS.IDENTITY_RESET('tt_AdvAcRestructureDetail_3');

      INSERT INTO tt_AdvAcRestructureDetail_3 ( 
      	SELECT * ,
              ' ' IsChanged  
      ...
      FROM A ,tt_AdvAcRestructureDetail_3 A
      ...
      FROM O ,CurDat_RBL_MISDB_PROD.AdvAcRestructureDetail O
             JOIN tt_AdvAcRestructureDetail_3 T   ON O.AccountEntityID = T.AccountEntityID
             AND O.EffectiveToTimeKey = 49999
      ...
      FROM A ,CurDat_RBL_MISDB_PROD.AdvAcRestructureDetail A
             JOIN tt_AdvAcRestructureDetail_3 B   ON A.AccountEntityId = B.AccountEntityId
      ...
      INSERT INTO CurDat_RBL_MISDB_PROD.AdvAcRestructureDetail
        ...
        ( SELECT AccountEntityId ,
                 ...
                 InvestmentGrade ,
                 POS_10PerPaidDate 
          FROM tt_AdvAcRestructureDetail_3 T
   ...
   BEGIN
      MERGE INTO A 
      USING (SELECT A.ROWID row_id, 'N'
      FROM A ,PRO_RBL_MISDB_PROD.PUI_CAL A ) src
      ON ( A.ROWID = src.row_id )
      WHEN MATCHED THEN UPDATE SET A.IsChanged = 'N';
      MERGE INTO T 
      USING (SELECT T.ROWID row_id, 'C'
      FROM T ,PRO_RBL_MISDB_PROD.PUI_CAL_hist O
             JOIN PRO_RBL_MISDB_PROD.PUI_CAL T   ON O.AccountEntityId = T.AccountEntityId
             AND O.EffectiveToTimeKey = 49999 
      ...
      FROM A ,PRO_RBL_MISDB_PROD.PUI_CAL A
             JOIN PRO_RBL_MISDB_PROD.PUI_CAL_hist B   ON B.AccountEntityId = A.AccountEntityId 
       WHERE B.EffectiveFromTimeKey = v_TimeKey
        AND A.IsChanged = 'C') src
      ON ( A.ROWID = src.row_id )
      WHEN MATCHED THEN UPDATE SET A.IsChanged = 'U';
      ...
      FROM O ,PRO_RBL_MISDB_PROD.PUI_CAL_hist O
             JOIN PRO_RBL_MISDB_PROD.PUI_CAL T   ON O.AccountEntityId = T.AccountEntityId 
       WHERE O.EffectiveFromTimeKey = v_TimeKey
        AND T.IsChanged = 'U') src
      ON ( O.ROWID = src.row_id )
      ...
      INSERT INTO PRO_RBL_MISDB_PROD.PUI_CAL_hist
        ...
        ( SELECT CustomerEntityID ,
                 ...
                 EffectiveFromTimeKey ,
                 49999 EffectiveToTimeKey  
          FROM PRO_RBL_MISDB_PROD.PUI_CAL T
           WHERE  NVL(T.IsChanged, 'N') IN ( 'C','N' )
...
/
  ...
  GRANT EXECUTE ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."CUSTACCTCALHISTMERGE_21082024" TO "ADF_CDR_RBL_STGDB";
