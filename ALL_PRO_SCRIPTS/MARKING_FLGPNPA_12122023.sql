--------------------------------------------------------
--  DDL for Procedure MARKING_FLGPNPA_12122023
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "MAIN_PRO"."MARKING_FLGPNPA_12122023" /*=========================================
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         DELETE FROM tt_PNPA_REASON_DATE_3;
         ...
         IF tt_PNPA_REASON_DATE_3  --SQLDEV: NOT RECOGNIZED
         INSERT INTO tt_PNPA_REASON_DATE_3
         ...
         */
         ...
         IF utils.object_id('TEMPDB..tt_TEMPTABLEPNPA_4') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TEMPTABLEPNPA_4 ';
         END IF;
         DELETE FROM tt_TEMPTABLEPNPA_4;
         UTILS.IDENTITY_RESET('tt_TEMPTABLEPNPA_4');

         INSERT INTO tt_TEMPTABLEPNPA_4 ( 
         ...
         FROM A ,PRO_RBL_MISDB_PROD.CUSTOMERCAL A
                JOIN tt_TEMPTABLEPNPA_4 B   ON A.CustomerEntityID = B.CustomerEntityID ) src
         ON ( A.ROWID = src.row_id )
         ...
         ON ( B.ROWID = src.row_id )
         WHEN MATCHED THEN UPDATE SET B.FlgPNPA = 'Y';
         IF utils.object_id('TEMPDB..tt_CTE_CUSTOMERWISEBALANCEP_4') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_CTE_CUSTOMERWISEBALANCEP_4 ';
         END IF;
         DELETE FROM tt_CTE_CUSTOMERWISEBALANCEP_4;
         UTILS.IDENTITY_RESET('tt_CTE_CUSTOMERWISEBALANCEP_4');

         INSERT INTO tt_CTE_CUSTOMERWISEBALANCEP_4 ( 
         ...
         USING (SELECT A.ROWID row_id, B.PNPA_DATE, 'Y', b.PNPA_Class_Key
         FROM A ,PRO_RBL_MISDB_PROD.CUSTOMERCAL A
                JOIN tt_CTE_CUSTOMERWISEBALANCEP_4 B   ON A.UcifEntityID = B.UcifEntityID ) src
         ON ( A.ROWID = src.row_id )
         WHEN MATCHED THEN UPDATE SET A.PNPA_DT = src.PNPA_DATE,
                                      A.FlgPNPA = 'Y',
                                      a.PNPA_Class_Key = src.PNPA_Class_Key;
         ...
         USING (SELECT a.ROWID row_id, b.PNPA_DATE, 'Y', b.PNPA_Class_Key
         FROM a ,PRO_RBL_MISDB_PROD.ACCOUNTCAL a
                JOIN tt_CTE_CUSTOMERWISEBALANCEP_4 b   ON a.UcifEntityID = b.UcifEntityID
                AND ( NVL(A.Asset_Norm, 'NORMAL') <> 'ALWYS_STD' ) ) src
         ON ( a.ROWID = src.row_id )
         WHEN MATCHED THEN UPDATE SET a.PNPA_DATE = src.PNPA_DATE,
                                      a.FlgPNPA = 'Y',
         ...
         ------IF OBJECT_ID('TEMPDB..tt_CTE_CUSTOMERWISEBALANCEP_4') IS NOT NULL
         ------   DROP TABLE tt_CTE_CUSTOMERWISEBALANCEP_4
         ------SELECT A.UcifEntityID,SUM(ISNULL(A.BALANCE,0)) BALANCE INTO tt_CTE_CUSTOMERWISEBALANCEP_4
         ------ FROM PRO.ACCOUNTCAL A 
...
/
  ...
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."MARKING_FLGPNPA_12122023" TO "ADF_CDR_RBL_STGDB";
