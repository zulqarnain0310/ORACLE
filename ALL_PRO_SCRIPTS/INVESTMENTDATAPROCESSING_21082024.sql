--------------------------------------------------------
--  DDL for Procedure INVESTMENTDATAPROCESSING_21082024
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" 
----/*=========================================
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         IF tt_HISTORYDATA_5  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_HISTORYDATA_5;
         UTILS.IDENTITY_RESET('tt_HISTORYDATA_5');

         INSERT INTO tt_HISTORYDATA_5 ( 
         	...
         	SELECT DISTINCT A.ACID ,
         	 ...
         	 WHERE  B.RefInvID IS NULL
         	  ...
         	  GROUP BY A.ACID,A.StatusType,A.StatusDate );
         IF  --SQLDEV: NOT RECOGNIZED
         IF tt_HISTORYDATA_51  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_HISTORYDATA1_5;
         UTILS.IDENTITY_RESET('tt_HISTORYDATA1_5');

         INSERT INTO tt_HISTORYDATA1_5 ( 
         	SELECT A.UcifId ,
                 MIN(B.StatusDate)  StatusDate  ,
                 B.StatusType 
         	  FROM RBL_MISDB_PROD.InvestmentIssuerDetail A
                   JOIN tt_HISTORYDATA_5 B   ON A.IssuerID = B.ACID
         	...
         	SELECT C.UcifId ,
         	  ...
         	  FROM RBL_MISDB_PROD.InvestmentFinancialDetail A
                   ...
                   JOIN tt_HISTORYDATA_5 B   ON A.RefInvID = B.ACID
                   AND A.EffectiveFromTimeKey <= B.EffectiveFromTimeKey
                   AND A.EffectiveToTimeKey >= B.EffectiveFromTimeKeY
         ...
         IF  --SQLDEV: NOT RECOGNIZED
         IF tt_HISTORYDATA_52  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_HISTORYDATA2_5;
         UTILS.IDENTITY_RESET('tt_HISTORYDATA2_5');

         INSERT INTO tt_HISTORYDATA2_5 ( 
         	SELECT A.UcifId ,
                 B.ACID ,
                 B.StatusType 
         	  FROM RBL_MISDB_PROD.InvestmentIssuerDetail A
         ...
         FROM A ,InvestmentFinancialDetail A
                ...
                AND B.EffectiveFromTimeKey <= v_TIMEKEY
                AND B.EffectiveToTimeKey >= v_TIMEKEY
                JOIN tt_HISTORYDATA1_5 C   ON B.UcifId = C.UcifId
                AND C.StatusType = 'Settlement'
                LEFT JOIN tt_HISTORYDATA2_5 D   ON C.UcifId = D.UcifId 
          WHERE A.FINALASSETCLASSALT_KEY > 1) src
         ON ( A.ROWID = src.row_id )
         ...
         */
         ...
         ----IF OBJECT_ID('TEMPDB..tt_TEMPMINASSETCLASS_15') IS NOT NULL
         ----  DROP TABLE tt_TEMPMINASSETCLASS_15

         ----	SELECT UcifId,MAX(ISNULL(FinalAssetClassAlt_Key,1)) FinalAssetClassAlt_Key
         ----	,MIN(NPIDt) NPIDt 
         ----	 INTO tt_TEMPMINASSETCLASS_15 
         ...
         ----	  ALTER TABLE  tt_TEMPMINASSETCLASS_15 ADD RefInvID VARCHAR (200)


         ----	  UPDATE A SET RefInvID=B.RefInvID
         ----	 FROM tt_TEMPMINASSETCLASS_15  A
         ...
         */
         IF utils.object_id('TEMPDB..tt_TEMPMINASSETCLASS_15') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TEMPMINASSETCLASS_15 ';
         END IF;
         DELETE FROM tt_TEMPMINASSETCLASS_15;
         UTILS.IDENTITY_RESET('tt_TEMPMINASSETCLASS_15');

         INSERT INTO tt_TEMPMINASSETCLASS_15 ( 
         	SELECT UcifId ,
         ...
         FROM D ,tt_TEMPMINASSETCLASS_15 A
         ...
         ----------------------------------------------------------------
         --- SELECT * FROM tt_TEMPMINASSETCLASS_15  
         ...
         IF  --SQLDEV: NOT RECOGNIZED
         IF tt_ADHOC_UCICID_STD_5  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_ADHOC_UCICID_STD_5;
         UTILS.IDENTITY_RESET('tt_ADHOC_UCICID_STD_5');

         INSERT INTO tt_ADHOC_UCICID_STD_5 ( 
         	SELECT UCICID 
...
/
  ...
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_21082024" TO "ADF_CDR_RBL_STGDB";
