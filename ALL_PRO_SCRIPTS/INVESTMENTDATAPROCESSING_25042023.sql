--------------------------------------------------------
--  DDL for Procedure INVESTMENTDATAPROCESSING_25042023
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" 
----/*=========================================
   ...
   BEGIN
      ...
      BEGIN
         ...
         */
         ...
         ----IF OBJECT_ID('TEMPDB..tt_TEMPMINASSETCLASS_16') IS NOT NULL
         ----  DROP TABLE tt_TEMPMINASSETCLASS_16

         ----	SELECT UcifId,MAX(ISNULL(FinalAssetClassAlt_Key,1)) FinalAssetClassAlt_Key
         ----	,MIN(NPIDt) NPIDt 
         ----	 INTO tt_TEMPMINASSETCLASS_16 
         ...
         ----	  ALTER TABLE  tt_TEMPMINASSETCLASS_16 ADD RefInvID VARCHAR (200)


         ----	  UPDATE A SET RefInvID=B.RefInvID
         ----	 FROM tt_TEMPMINASSETCLASS_16  A
         ...
         */
         IF utils.object_id('TEMPDB..tt_TEMPMINASSETCLASS_16') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TEMPMINASSETCLASS_16 ';
         END IF;
         DELETE FROM tt_TEMPMINASSETCLASS_16;
         UTILS.IDENTITY_RESET('tt_TEMPMINASSETCLASS_16');

         INSERT INTO tt_TEMPMINASSETCLASS_16 ( 
         	SELECT UcifId ,
         ...
         FROM D ,tt_TEMPMINASSETCLASS_16 A
         ...
         WHEN MATCHED THEN UPDATE SET B.DEGREASON = src.DEGREASON;
         ----------------------------------------------------------------
         --- SELECT * FROM tt_TEMPMINASSETCLASS_16  
...
/
  ...
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."INVESTMENTDATAPROCESSING_25042023" TO "ADF_CDR_RBL_STGDB";
