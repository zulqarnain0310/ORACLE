--------------------------------------------------------
--  DDL for Procedure DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" 
--===============================================================================================
 -- Created by       : Amar
      ...
      BEGIN
              ...
              WHERE  NOT EXISTS ( SELECT 1 Expr1  
                                  FROM PreMoc_RBL_MISDB_PROD.CUSTOMERCAL 
                                   WHERE  ( CustomerEntityID = CustCal.CustomerEntityID )
                                            AND ( EffectiveFromTimeKey <= v_TimeKey )
                                            AND ( EffectiveToTimeKey >= v_TimeKey ) ) );
         INSERT INTO PreMoc_RBL_MISDB_PROD.ADVACCAL
         ...
         , RefPeriodOverdueUPG, RefPeriodOverDrawnUPG, RefPeriodNoCreditUPG, RefPeriodIntServiceUPG, RefPeriodStkStatementUPG, RefPeriodReviewUPG, CommonMocTypeAlt_Key, EffectiveFromTimeKey, EffectiveToTimeKey, FlgMoc, MOC_Dt )
           ( SELECT accal.AccountEntityID ,
                    accal.CustomerEntityID ,
                    accal.CustomerAcID ,
                    accal.CustomerAcID RefSystemACID  ,
                    accal.RefCustomerID ,
                    accal.BranchCode ,
                    accal.SecurityValue ,
                    accal.DFVAmt ,
             ...
             FROM PRO_RBL_MISDB_PROD.AccountCal_Hist AcCal
                    ...
                    AND AcCal.AccountEntityID = AcCurnt.AccountEntityID
              WHERE  NOT EXISTS ( SELECT 1 Expr1  
                                  FROM PreMoc_RBL_MISDB_PROD.ADVACCAL 
                                   WHERE  ( AccountEntityID = AcCal.AccountEntityID )
                                            AND ( EffectiveFromTimeKey <= v_TimeKey )
                                            AND ( EffectiveToTimeKey >= v_TimeKey ) ) );
         ---=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=INSERT DATA IN PREMOC CUSTOMERCALCAL-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
         INSERT INTO PreMoc_RBL_MISDB_PROD.ADVCUSTCAL
           ...
           ( SELECT custcal.BranchCode ,
             ...
             FROM PRO_RBL_MISDB_PROD.CustomerCal_Hist CustCal
                    ...
                    AND CustCal.CustomerEntityID = CustCurnt.CustomerEntityID
              WHERE  NOT EXISTS ( SELECT 1 Expr1  
                                  FROM PreMoc_RBL_MISDB_PROD.ADVCUSTCAL 
                                   WHERE  ( CustomerEntityID = CustCal.CustomerEntityID )
                                            AND ( EffectiveFromTimeKey <= v_TimeKey )
                                            AND ( EffectiveToTimeKey >= v_TimeKey ) ) );
...
/
  ...
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_BKUP" TO "ADF_CDR_RBL_STGDB";
