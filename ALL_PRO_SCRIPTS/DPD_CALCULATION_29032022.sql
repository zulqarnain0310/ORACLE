--------------------------------------------------------
--  DDL for Procedure DPD_CALCULATION_29032022
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "MAIN_PRO"."DPD_CALCULATION_29032022" /*=========================================
   ...
   BEGIN
      ...
      BEGIN
         ...
         BEGIN
            ...
            FROM A ,PRO_RBL_MISDB_PROD.ACCOUNTCAL A ) src
            ON ( A.ROWID = src.row_id )
            WHEN MATCHED THEN UPDATE SET A.DPD_IntService ----CASE WHEN @TIMEKEY >26382  --28032022 amar - implemmented 90 days summation ccod credit and intt logic
                                          --	THEN	
...
/
  ...
  GRANT EXECUTE ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."DPD_CALCULATION_29032022" TO "ADF_CDR_RBL_STGDB";
