--------------------------------------------------------
--  DDL for Procedure INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" 
(
  v_TIMEKEY IN NUMBER
)
AS
...
BEGIN
   ...
   UPDATE tt_CUSTOMERCAL_21
      SET IsChanged = NULL;
   UPDATE tt_AccountCal_22
      SET IsChanged = NULL;
   DELETE FROM tt_CustomerCal_Moc_4;
   UTILS.IDENTITY_RESET('tt_CustomerCal_Moc_4');

   INSERT INTO tt_CustomerCal_Moc_4 ( 
   	SELECT A.* ,
           UTILS.CONVERT_TO_NUMBER(0,19,0) EntityKeyNew  
   	  FROM PRO_RBL_MISDB_PROD.CustomerCal_Hist A
             JOIN tt_CUSTOMERCAL_21 B   ON A.CustomerEntityID = B.CustomerEntityID
   ...
   FROM O ,PRO_RBL_MISDB_PROD.CustomerCal_Hist O
          JOIN tt_CUSTOMERCAL_21 T   ON O.CustomerEntityId = T.CustomerEntityId 
   ...
   FROM TEMP ,tt_CUSTOMERCAL_21 TEMP
          JOIN ( SELECT tt_CUSTOMERCAL_21.CustomerEntityId ,
                        (v_EntityKeyCust + ROW_NUMBER() OVER ( ORDER BY ( SELECT 1 
                                                                            FROM DUAL  )  )) EntityKeyNew  
                 FROM tt_CUSTOMERCAL_21 ---Where IsChanged in ('C','N')
   ...
   MERGE INTO TEMP 
   USING (SELECT TEMP.ROWID row_id, ACCT.EntityKeyNew
   FROM TEMP ,tt_CustomerCal_Moc_4 TEMP
          JOIN ( SELECT tt_CustomerCal_Moc_4.CustomerEntityId ,
                        (v_EntityKeyCust1 + ROW_NUMBER() OVER ( ORDER BY ( SELECT 1 
                                                                             FROM DUAL  )  )) EntityKeyNew  
                 FROM tt_CustomerCal_Moc_4 ---Where IsChanged in ('C','N')
                        ) ACCT   ON TEMP.CustomerEntityId = ACCT.CustomerEntityId ) src
   ON ( TEMP.ROWID = src.row_id )
   WHEN MATCHED THEN UPDATE SET TEMP.EntityKeyNew = src.EntityKeyNew;
   --WHERE Temp.IsChanged in ('C','N')
   INSERT INTO PRO_RBL_MISDB_PROD.CustomerCal_Hist
     ...
     ( SELECT T.EntityKeyNew ,
              ...
              NULL ChangeFld  ,
              NULL ScreenFlag  
       FROM tt_CustomerCal_Moc_4 T
        WHERE  EffectiveToTimeKey > v_TIMEKEY );
   /* ACCOUNT - MOC */
   DELETE FROM tt_AccountCal_Moc_4;
   UTILS.IDENTITY_RESET('tt_AccountCal_Moc_4');

   INSERT INTO tt_AccountCal_Moc_4 ( 
   	SELECT A.* ,
           UTILS.CONVERT_TO_NUMBER(0,19,0) EntityKeyNew  
   	  FROM PRO_RBL_MISDB_PROD.AccountCal_Hist A
             JOIN tt_AccountCal_22 B   ON A.AccountEntityID = B.AccountEntityID
             AND A.EffectiveFromTimeKey <= v_TIMEKEY
             AND A.EffectiveToTimeKey >= v_TIMEKEY );
   /* EXPIRE RECORDS ARE LIVE FROM PREV EFFECTIVEFROTIMEKEY TO MOC OT GRATER THAN MOC TIMKEY*/
   MERGE INTO A 
   ...
   FROM O ,PRO_RBL_MISDB_PROD.AccountCal_Hist O
          JOIN tt_AccountCal_22 T   ON O.AccountEntityID = T.AccountEntityID 
    WHERE O.EffectiveFromTimeKey = v_TimeKey
     AND O.EffectiveToTimeKey = v_TIMEKEY) src
   ON ( O.ROWID = src.row_id )
   ...
   MERGE INTO TEMP 
   USING (SELECT TEMP.ROWID row_id, ACCT.EntityKeyNew
   FROM TEMP ,tt_AccountCal_22 TEMP
          JOIN ( SELECT tt_AccountCal_22.AccountEntityID ,
                        (v_EntityKeyAcct + ROW_NUMBER() OVER ( ORDER BY ( SELECT 1 
                                                                            FROM DUAL  )  )) EntityKeyNew  
                 FROM tt_AccountCal_22 ---Where IsChanged in ('C','N')
   ...
   MERGE INTO TEMP 
   USING (SELECT TEMP.ROWID row_id, ACCT.EntityKeyNew
   FROM TEMP ,tt_AccountCal_Moc_4 TEMP
          JOIN ( SELECT tt_AccountCal_Moc_4.AccountEntityID ,
                        (v_EntityKeyAcct1 + ROW_NUMBER() OVER ( ORDER BY ( SELECT 1 
                                                                             FROM DUAL  )  )) EntityKeyNew  
                 FROM tt_AccountCal_Moc_4 ---Where IsChanged in ('C','N')
                        ) ACCT   ON TEMP.AccountEntityID = ACCT.AccountEntityID ) src
   ON ( TEMP.ROWID = src.row_id )
   WHEN MATCHED THEN UPDATE SET TEMP.EntityKeyNew = src.EntityKeyNew;
   --WHERE Temp.IsChanged in ('C','N')
   INSERT INTO PRO_RBL_MISDB_PROD.AccountCal_Hist
     ...
     ( SELECT T.EntityKeyNew ,
              ...
              NULL ScreenFlag  ,
              NULL ChangeField  
       FROM tt_AccountCal_Moc_4 T
        WHERE  EffectiveToTimeKey > v_TIMEKEY );
   -----------------------------------------------------------
   /* AMAR - 29033023 -- RESTRUCTURE WORK FOR moc PROCESSING */
   DELETE FROM tt_AdvAcRestructureCal_Moc_3;
   UTILS.IDENTITY_RESET('tt_AdvAcRestructureCal_Moc_3');

   INSERT INTO tt_AdvAcRestructureCal_Moc_3 ( 
   	SELECT A.* ,
           UTILS.CONVERT_TO_NUMBER(0,19,0) EntityKeyNew  
   ...
   MERGE INTO TEMP 
   USING (SELECT TEMP.ROWID row_id, ACCT.EntityKeyNew
   FROM TEMP ,tt_AdvAcRestructureCal_Moc_3 TEMP
          JOIN ( SELECT tt_AdvAcRestructureCal_Moc_3.AccountEntityId ,
                        (v_EntityKeyRestr1 + ROW_NUMBER() OVER ( ORDER BY ( SELECT 1 
                                                                              FROM DUAL  )  )) EntityKeyNew  
                 FROM tt_AdvAcRestructureCal_Moc_3 ---Where IsChanged in ('C','N')
                        ) ACCT   ON TEMP.AccountEntityId = ACCT.AccountEntityId ) src
   ON ( TEMP.ROWID = src.row_id )
   WHEN MATCHED THEN UPDATE SET TEMP.EntityKeyNew = src.EntityKeyNew;
   --WHERE Temp.IsChanged in ('C','N')
   INSERT INTO PRO_RBL_MISDB_PROD.AdvAcRestructureCal_Hist
     ...
     ( SELECT T.AccountEntityId ,
              ...
              T.PreRestructureNPA_Prov ,
              T.RestructureFacilityTypeAlt_Key 
       FROM tt_AdvAcRestructureCal_Moc_3 T
        WHERE  EffectiveToTimeKey > v_TIMEKEY );
...
/
  ...
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."INSERTDATAINTOHIST_TABLE_OPT_MOC_21082024" TO "ADF_CDR_RBL_STGDB";
