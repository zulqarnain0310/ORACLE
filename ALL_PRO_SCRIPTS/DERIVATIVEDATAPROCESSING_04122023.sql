--------------------------------------------------------
--  DDL for Procedure DERIVATIVEDATAPROCESSING_04122023
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" 
----/*=========================================
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         IF utils.object_id('TEMPDB..tt_TEMPMINASSETCLASS_3') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TEMPMINASSETCLASS_3 ';
         END IF;
         DELETE FROM tt_TEMPMINASSETCLASS_3;
         UTILS.IDENTITY_RESET('tt_TEMPMINASSETCLASS_3');

         INSERT INTO tt_TEMPMINASSETCLASS_3 ( 
         	SELECT UCIC_ID ,
         ...
         FROM B ,tt_TEMPMINASSETCLASS_3 A
         ...
         ELSE NULL
            END AS pos_4
         FROM D ,CalypsoDervMOC_ChangeDetails A
...
/
  ...
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."DERIVATIVEDATAPROCESSING_04122023" TO "ADF_CDR_RBL_STGDB";
