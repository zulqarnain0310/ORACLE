...
BEGIN
   ...
   INSERT INTO PRO_RBL_MISDB_PROD.Package_AUDIT
     ...
     ( SELECT 5 ,
         ...
         FROM DUAL  );
   UPDATE PRO_RBL_MISDB_PROD.Package_AUDIT
   ...
   UPDATE PRO_RBL_MISDB_PROD.Package_AUDIT
    ...
    WHERE  IdentityKey = 5;
   DELETE PRO_RBL_MISDB_PROD.Package_AuditHist

    WHERE  TIMEKEY = v_TIMEKEY;
   INSERT INTO PRO_RBL_MISDB_PROD.Package_AuditHist
   ...
   FROM A ,PRO_RBL_MISDB_PROD.ProcessMonitor A
