--------------------------------------------------------
--  DDL for Procedure NPA_EROSION_AGING_21082024
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "MAIN_PRO"."NPA_EROSION_AGING_21082024" /*=========================================
...
BEGIN
   ...
   BEGIN
      DECLARE
         ...
         INNER JOIN tt_CTE_CustomerWiseBalance_10 C ON C.RefCustomerID=B.RefCustomerID
         ...
         */
         ...
         v_SUB_Months NUMBER(10,0) := ( SELECT RefValue 
           FROM DIMNPAAGEINGMASTER 
          WHERE  BusinessRule = 'Sub-Standard to Doubtful 1'
                   AND EffectiveFromTimeKey <= v_TIMEKEY
                   AND EffectiveToTimeKey >= v_TIMEKEY );
         v_DB1_Months NUMBER(10,0) := ( SELECT RefValue 
           FROM DIMNPAAGEINGMASTER 
          WHERE  BusinessRule = 'Doubtful 1 to Doubtful 2'
                   AND EffectiveFromTimeKey <= v_TIMEKEY
                   AND EffectiveToTimeKey >= v_TIMEKEY );
         v_DB2_Months NUMBER(10,0) := ( SELECT RefValue 
           FROM DIMNPAAGEINGMASTER 
          WHERE  BusinessRule = 'Doubtful 2 to Doubtful 3'
                   AND EffectiveFromTimeKey <= v_TIMEKEY
                   AND EffectiveToTimeKey >= v_TIMEKEY );
      ...
      BEGIN
         IF utils.object_id('TEMPDB..tt_CTE_CustomerWiseBalance_10') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_CTE_CustomerWiseBalance_10 ';
         END IF;
         DELETE FROM tt_CTE_CustomerWiseBalance_10;
         UTILS.IDENTITY_RESET('tt_CTE_CustomerWiseBalance_10');

         INSERT INTO tt_CTE_CustomerWiseBalance_10 ( 
         	SELECT A.RefCustomerID ,
                 SUM(NVL(A.PrincOutStd, 0))  NetBalance  
         	  FROM tt_ACCOUNTCAL_46 A
                   JOIN tt_CUSTOMERCAL_47 B   ON A.RefCustomerID = B.RefCustomerID
         ...
         FROM B ,tt_CUSTOMERCAL_47 B ) src
         ...
         ELSE B.ErosionDt
            END AS pos_6
         FROM B ,tt_ACCOUNTCAL_46 A
                JOIN tt_CUSTOMERCAL_47 B   ON A.RefCustomerID = B.RefCustomerID
                JOIN tt_CTE_CustomerWiseBalance_10 C   ON C.RefCustomerID = B.RefCustomerID
          ...
          THEN ( SELECT DIMASSETCLASS.AssetClassAlt_Key 
                 FROM DimAssetClass 
                  WHERE  DIMASSETCLASS.AssetClassShortName = 'DB2'
                           AND DIMASSETCLASS.EffectiveFromTimeKey <= v_TIMEKEY
                           AND DIMASSETCLASS.EffectiveToTimeKey >= v_TIMEKEY )
         WHEN utils.dateadd('MONTH', (v_DB1_Months + v_DB2_Months), A.DbtDt) <= v_PROCESSDATE THEN ( SELECT DIMASSETCLASS.AssetClassAlt_Key 
                                                                                                     FROM DimAssetClass 
                                                                                                      WHERE  DIMASSETCLASS.AssetClassShortName = 'DB3'
                                                                                                               AND DIMASSETCLASS.EffectiveFromTimeKey <= v_TIMEKEY
                                                                                                               AND DIMASSETCLASS.EffectiveToTimeKey >= v_TIMEKEY )
...
/
  ...
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."NPA_EROSION_AGING_21082024" TO "ADF_CDR_RBL_STGDB";
