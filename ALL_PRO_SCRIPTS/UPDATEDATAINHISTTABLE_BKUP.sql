--------------------------------------------------------
--  DDL for Procedure UPDATEDATAINHISTTABLE_BKUP
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" 
(
  v_TIMEKEY IN NUMBER
)
AS
...
BEGIN
   ...
   , A.CustMoveDescription, A.TotOsCust, A.MOCTYPE
   ...
   --,B.DateOfData	=	A.DateOfData
   , A.DerecognisedInterest1, A.DerecognisedInterest2, A.ProductCode, A.FlgLCBG, A.UnserviedInt, A.AdvanceRecovery, A.NotionalInttAmt, A.OriginalBranchcode, A.PrvAssetClassAlt_Key, A.MOCTYPE, A.FlgSecured, A.RePossession, A.RCPending, A.PaymentPending, A.WheelCase, A.CustomerLevelMaxPer, A.FinalProvisionPer, A.IsIBPC, A.IsSecuritised, A.RFA, A.IsNonCooperative, A.Sarfaesi, A.WeakAccount, A.PUI, A.FlgRestructure, A.RestructureDate, A.WeakAccountDate, A.SarfaesiDate, A.FlgUnusualBounce, A.UnusualBounceDate, A.FlgUnClearedEffect, A.UnClearedEffectDate, A.FlgFraud, A.FraudDate
   FROM B ,PRO_RBL_MISDB_PROD.ACCOUNTCAL A
          JOIN PRO_RBL_MISDB_PROD.AccountCal_Hist B   ON b.EffectiveFromTimeKey = v_TIMEKEY
          AND b.EffectiveToTimeKey = v_TIMEKEY
   ...
   WHEN MATCHED THEN UPDATE SET B.AccountEntityID = src.AccountEntityID,
                                ...
                                B.MOCTYPE = src.MOCTYPE,
                                B.FlgSecured = src.FlgSecured,
                                B.RePossession = src.RePossession,
                                B.RCPending = src.RCPending,
                                B.PaymentPending = src.PaymentPending,
                                B.WheelCase = src.WheelCase,
                                B.CustomerLevelMaxPer = src.CustomerLevelMaxPer,
                                B.FinalProvisionPer = src.FinalProvisionPer,
                                B.IsIBPC = src.IsIBPC,
                                B.IsSecuritised = src.IsSecuritised,
                                B.RFA = src.RFA,
                                B.IsNonCooperative = src.IsNonCooperative,
                                B.Sarfaesi = src.Sarfaesi,
                                B.WeakAccount = src.WeakAccount,
                                B.PUI = src.PUI,
                                B.FlgRestructure = src.FlgRestructure,
                                B.RestructureDate = src.RestructureDate,
                                B.WeakAccountDate = src.WeakAccountDate,
                                B.SarfaesiDate = src.SarfaesiDate,
                                B.FlgUnusualBounce = src.FlgUnusualBounce,
                                B.UnusualBounceDate = src.UnusualBounceDate,
                                B.FlgUnClearedEffect = src.FlgUnClearedEffect,
                                B.UnClearedEffectDate = src.UnClearedEffectDate,
                                B.FlgFraud = src.FlgFraud,
                                B.FraudDate = src.FraudDate;--ALTER TABLE PRO.ACCOUNTCAL DROP COLUMN DPD_IntService 
...
/
  ...
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEDATAINHISTTABLE_BKUP" TO "ADF_CDR_RBL_STGDB";
