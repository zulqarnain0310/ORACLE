--------------------------------------------------------
--  DDL for Procedure DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" 
--===============================================================================================
         ...
         , RelationshipNumber, AccountFlag, CommercialFlag_AltKey, Liability, CD, AccountStatus, AccountBlkCode1, AccountBlkCode2, ExposureType, Mtm_Value, BankAssetClass, NpaType, SecApp, BorrowerTypeID, LineCode, ProvPerSecured, ProvPerUnSecured, MOCReason, AddlProvisionPer, FlgINFRA, RepossessionDate, DerecognisedInterest1, DerecognisedInterest2, ProductCode, FlgLCBG, unserviedint, AdvanceRecovery, NotionalInttAmt, OriginalBranchcode, PrvAssetClassAlt_Key, MOCTYPE, FlgSecured, RePossession, RCPending, PaymentPending, WheelCase, CustomerLevelMaxPer, FinalProvisionPer, IsIBPC, IsSecuritised, RFA, IsNonCooperative, Sarfaesi, WeakAccount, PUI, FlgRestructure, RestructureDate, WeakAccountDate, SarfaesiDate, FlgUnusualBounce, UnusualBounceDate, FlgUnClearedEffect, UnClearedEffectDate, FlgFraud, FraudDate )
           ( SELECT AcCal.AccountEntityID ,
             ...
             FROM PRO_RBL_MISDB_PROD.AccountCal_Hist AcCal
                    JOIN tt_AccountCal_17 AcCurnt   ON AcCal.EffectiveFromTimeKey <= v_TimeKey
         ...
         INSERT INTO PreMoc_RBL_MISDB_PROD.CUSTOMERCAL
           ...
           ( SELECT CustCal.BranchCode ,
             ...
             FROM PRO_RBL_MISDB_PROD.CustomerCal_Hist CustCal
                    JOIN tt_CUSTOMERCAL_14 CustCurnt   ON CustCal.EffectiveFromTimeKey <= v_TimeKey
...
/
  ...
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."DATASHIFTINGINTOARCHIVEANDPREMOCTABLE_21082024" TO "ADF_CDR_RBL_STGDB";
