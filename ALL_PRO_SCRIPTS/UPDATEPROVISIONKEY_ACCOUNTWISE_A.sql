--------------------------------------------------------
--  DDL for Procedure UPDATEPROVISIONKEY_ACCOUNTWISE_A
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" /*=========================================
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         IF tt_AC_NPA_QTR_NO_17  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_AC_NPA_QTR_NO_17;
         UTILS.IDENTITY_RESET('tt_AC_NPA_QTR_NO_17');

         INSERT INTO tt_AC_NPA_QTR_NO_17 ( 
         ...
         FROM A ,PRO_RBL_MISDB_PROD.ACCOUNTCAL A
                ...
                JOIN tt_AC_NPA_QTR_NO_17 NP   ON NP.AccountEntityID = A.AccountEntityID
...
/
  ...
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_A" TO "ADF_CDR_RBL_STGDB";
