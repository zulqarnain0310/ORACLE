--------------------------------------------------------
--  DDL for Procedure UPDATEPROVISIONKEY_ACCOUNTWISE_04122023
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" /*=========================================
...
BEGIN
   ...
   BEGIN
      DECLARE
         ...
         IF tt_PrvQtrProv_2  --SQLDEV: NOT RECOGNIZED
      ...
      BEGIN
         ...
         IF  --SQLDEV: NOT RECOGNIZED
         IF tt_AC_NPA_QTR_NO_9  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_AC_NPA_QTR_NO_9;
         UTILS.IDENTITY_RESET('tt_AC_NPA_QTR_NO_9');

         INSERT INTO tt_AC_NPA_QTR_NO_9 ( 
              ...
              --inner JOIN DimProduct	dp
               ...
               --	and dp.ProductAlt_Key=a.ProductAlt_Key
                ...
                AND seg.Segment = CASE 
                 ...
                 END
                JOIN tt_AC_NPA_QTR_NO_9 NP   ON NP.AccountEntityID = A.AccountEntityID
         ...
         ON ( A.ROWID = src.row_id )
         WHEN MATCHED THEN UPDATE SET A.ProvisionAlt_Key = src.ProvisionAlt_Key;
         DELETE FROM tt_PrvQtrProv_2;
         UTILS.IDENTITY_RESET('tt_PrvQtrProv_2');

         INSERT INTO tt_PrvQtrProv_2 ( 
         	SELECT AccountEntityID ,
                 a.ProvisionAlt_Key ,
                 b.ProvisionSecured 
         ...
         FROM A ,PRO_RBL_MISDB_PROD.ACCOUNTCAL A
                ...
                JOIN tt_PrvQtrProv_2 C   ON A.AccountEntityID = C.AccountEntityID 
...
/
  ...
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."UPDATEPROVISIONKEY_ACCOUNTWISE_04122023" TO "ADF_CDR_RBL_STGDB";
