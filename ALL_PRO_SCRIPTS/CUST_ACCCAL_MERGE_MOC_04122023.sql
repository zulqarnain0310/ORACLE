--------------------------------------------------------
--  DDL for Procedure CUST_ACCCAL_MERGE_MOC_04122023
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" /*==============================          
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         BEGIN TRY DROP TABLE IF  --SQLDEV: NOT RECOGNIZED
         IF tt_AdvAcCal_2  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_AdvAcCal_2;
         UTILS.IDENTITY_RESET('tt_AdvAcCal_2');

         INSERT INTO tt_AdvAcCal_2 ( 
         	SELECT O.* 
         	  FROM CurDat_RBL_MISDB_PROD.ADVACCAL O
                   JOIN PRO_RBL_MISDB_PROD.ACCOUNTCAL T   ON ( O.EffectiveFromTimeKey <= v_TimeKey
         ...
         FROM O ,CurDat_RBL_MISDB_PROD.ADVACCAL O
                JOIN tt_AdvAcCal_2 B   ON O.EffectiveFromTimeKey <= v_TimeKey
                AND O.EffectiveToTimeKey >= v_TimeKey
                AND O.EffectiveFromTimeKey < v_TimeKey
                AND O.AccountEntityID = B.AccountEntityID
                JOIN PRO_RBL_MISDB_PROD.ACCOUNTCAL T   ON T.AccountEntityID = O.AccountEntityID ) src
         ...
         FROM O ,CurDat_RBL_MISDB_PROD.ADVACCAL O
                ...
                AND O.EffectiveToTimeKey = v_TimeKey
                AND O.AccountEntityID = B.AccountEntityID
                JOIN PRO_RBL_MISDB_PROD.ACCOUNTCAL T   ON O.AccountEntityID = T.AccountEntityID ) src
         ON ( O.ROWID = src.row_id )
         ...
         , REFPeriodMax, FinalNpaDt, FlgFITL, FlgAbinitio, FinalAssetClassAlt_Key, NPA_Days, RefPeriodOverdueUPG, RefPeriodOverDrawnUPG, RefPeriodNoCreditUPG, RefPeriodIntServiceUPG, RefPeriodStkStatementUPG, RefPeriodReviewUPG, CommonMocTypeAlt_Key, EffectiveFromTimeKey, EffectiveToTimeKey, FlgMoc, MOC_Dt )
           ( SELECT T.AccountEntityID ,
                    ...
                    T.FlgMoc ,
                    T.MOC_Dt 
             FROM tt_AdvAcCal_2 A
                    JOIN PRO_RBL_MISDB_PROD.ACCOUNTCAL T   ON A.AccountEntityID = T.AccountEntityID );
         INSERT INTO CurDat_RBL_MISDB_PROD.ADVACCAL
         ...
         IF tt_AdvCustCal_2  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_AdvCustCal_2;
         UTILS.IDENTITY_RESET('tt_AdvCustCal_2');

         INSERT INTO tt_AdvCustCal_2 ( 
         	SELECT O.* 
         	  FROM CurDat_RBL_MISDB_PROD.ADVCUSTCAL O
                   JOIN PRO_RBL_MISDB_PROD.CUSTOMERCAL T   ON ( O.EffectiveFromTimeKey <= v_TimeKey
                   AND O.EffectiveToTimeKey >= v_TimeKey )
         ...
         MERGE INTO O 
         USING (SELECT O.ROWID row_id, v_TimeKey - 1 AS EffectiveToTimeKey
         FROM O ,CurDat_RBL_MISDB_PROD.ADVCUSTCAL O
                JOIN tt_AdvCustCal_2 B   ON O.EffectiveFromTimeKey <= v_TimeKey
                AND O.EffectiveToTimeKey >= v_TimeKey
                AND O.EffectiveFromTimeKey < v_TimeKey
                AND O.CustomerEntityID = B.CustomerEntityID
                JOIN PRO_RBL_MISDB_PROD.CUSTOMERCAL T   ON T.CustomerEntityID = O.CustomerEntityID ) src
         ON ( O.ROWID = src.row_id )
         WHEN MATCHED THEN UPDATE SET O.EffectiveToTimeKey = src.EffectiveToTimeKey;
         DELETE O
          WHERE ROWID IN 
         ...
         FROM O ,CurDat_RBL_MISDB_PROD.ADVCUSTCAL O
                ...
                AND O.EffectiveToTimeKey = v_TimeKey
                AND O.CustomerEntityID = B.CustomerEntityID
                JOIN PRO_RBL_MISDB_PROD.CUSTOMERCAL T   ON O.CustomerEntityID = T.CustomerEntityID ) src
         ON ( O.ROWID = src.row_id )
         ...
         INSERT INTO CurDat_RBL_MISDB_PROD.ADVCUSTCAL
           ...
           ( SELECT T.BranchCode ,
                    ...
                    v_TimeKey EffectiveToTimeKey  ,
                    T.CommonMocTypeAlt_Key 
             FROM tt_AdvCustCal_2 A
                    JOIN PRO_RBL_MISDB_PROD.CUSTOMERCAL T   ON A.CustomerEntityID = T.CustomerEntityID );
         INSERT INTO CurDat_RBL_MISDB_PROD.ADVCUSTCAL
           ( BranchCode, UCIF_ID, CustomerEntityID, ParentCustomerID, RefCustomerID, CustSegmentCode, SrcAssetClassAlt_Key, SysAssetClassAlt_Key, SMA_Class_Key, PNPA_Class_Key, PrvQtrRV, CurntQtrRv, TotProvision, SrcNPA_Dt, SysNPA_Dt, DbtDt, LossDt, MOC_Dt, ErosionDt, SMA_Dt, PNPA_Dt, Asset_Norm, FlgDeg, FlgUpg, FlgMoc, FlgSMA, FlgProcessing, FlgErosion, FlgPNPA, FlgPercolation, FlgInMonth, FlgDirtyRow, DegDate, EffectiveFromTimeKey, EffectiveToTimeKey, CommonMocTypeAlt_Key )
           ( SELECT BranchCode ,
                    UCIF_ID ,
...
/
  ...
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "RBL_MISDB_PROD";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "MAIN_PRO"."CUST_ACCCAL_MERGE_MOC_04122023" TO "ADF_CDR_RBL_STGDB";
