--------------------------------------------------------
--  DDL for Procedure CUSTOMERBASICDETAIL_TEMP_17022024
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" 
-- =============================================
 -- Author:		<Author,,Name>
...
BEGIN
   ...
   */
   ...
   IF tt_CustEntityID_2  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_CustEntityID_2;
   UTILS.IDENTITY_RESET('tt_CustEntityID_2');

   INSERT INTO tt_CustEntityID_2 SELECT CustomerId ,
   ...
   FROM TEMP ,TempCustomerBasicDetail TEMP
          JOIN tt_CustEntityID_2 ACCT   ON TEMP.CustomerId = ACCT.CustomerId ) src
   ON ( TEMP.ROWID = src.row_id )
   WHEN MATCHED THEN UPDATE SET TEMP.CustomerEntityId = src.CustomerEntityId;
   ...
   END IF;
   TABLE IF  --SQLDEV: NOT RECOGNIZED
   IF tt_UcifEntityID_2  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_UcifEntityID_2;
   UTILS.IDENTITY_RESET('tt_UcifEntityID_2');

   INSERT INTO tt_UcifEntityID_2 SELECT UCIF_ID ,
   ...
   FROM TEMP ,TempCustomerBasicDetail TEMP
          JOIN tt_UcifEntityID_2 ACCT   ON TEMP.UCIF_ID = ACCT.UCIF_ID ) src
   ON ( TEMP.ROWID = src.row_id )
   WHEN MATCHED THEN UPDATE SET TEMP.UcifEntityID = src.UcifEntityID;
   IF  --SQLDEV: NOT RECOGNIZED
   /***********************************************************************************************************/
...
/
  ...
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "MAIN_PRO";
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "RBL_MISDB_PROD";
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "RBL_STGDB";
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "MAIN_PRO";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "RBL_MISDB_PROD";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "RBL_STGDB";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "RBL_TEMPDB";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."CUSTOMERBASICDETAIL_TEMP_17022024" TO "ADF_CDR_RBL_STGDB";
