--------------------------------------------------------
--  DDL for Procedure ADVSECURITYDETAIL_TEMP_06062023
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" 
-- =============================================  
 -- Author:  <Author,,Name>  
...
BEGIN
   ...
   IF tt_RBL_SECURITY_CAL_3  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_RBL_SECURITY_CAL_3;
   UTILS.IDENTITY_RESET('tt_RBL_SECURITY_CAL_3');

   INSERT INTO tt_RBL_SECURITY_CAL_3 ( 
   	SELECT * ,
   ...
   FROM A ,tt_RBL_SECURITY_CAL_3 A
          JOIN ( SELECT tt_RBL_SECURITY_CAL_3.CollateralID ,
                        COUNT(DISTINCT tt_RBL_SECURITY_CAL_3.CUSTOMER_ID)  COUNTS  
                 FROM tt_RBL_SECURITY_CAL_3 
                  WHERE  tt_RBL_SECURITY_CAL_3.COLLATERAL_TYPE = 'Immovable Property'
                           AND tt_RBL_SECURITY_CAL_3.ValuationExpiryDate > v_date
                   GROUP BY tt_RBL_SECURITY_CAL_3.CollateralID ) B   ON A.CollateralID = B.CollateralID ) src
   ...
   IF  --SQLDEV: NOT RECOGNIZED
   IF tt_CALC_3  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_CALC_3;
   UTILS.IDENTITY_RESET('tt_CALC_3');

   INSERT INTO tt_CALC_3 ( 
   	SELECT CUSTOMER_ID ,
           A.CollateralID ,
   ...
   WITH CTE_A AS ( SELECT CUSTOMER_ID ,
    ...
    WHERE  COLLATERAL_TYPE = 'Immovable Property'
      ...
      FROM A ,CTE_A A
             JOIN tt_CALC_3 B   ON A.Customer_ID = B.Customer_ID
   ...
   /* CLEANED DATA OUTPUT */
   /* STOCK DATA WORK */
   --select *  from tt_RBL_SECURITY_CAL_3_STOCK where SecValue_Final>0 and ValuationExpiryDate>='2022-03-19'
   IF  --SQLDEV: NOT RECOGNIZED
   IF tt_RBL_SECURITY_CAL_3_STOCK  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_RBL_SECURITY_CAL_STOCK_3;
   UTILS.IDENTITY_RESET('tt_RBL_SECURITY_CAL_STOCK_3');

   INSERT INTO tt_RBL_SECURITY_CAL_STOCK_3 ( 
   	SELECT * ,
   ...
   UPDATE tt_RBL_SECURITY_CAL_STOCK_3
      SET SecValue_Final = 0;
   ---select *  from tt_RBL_SECURITY_CAL_3_STOCK   where stock_audit_date
   ---		select * from tt_RBL_SECURITY_CAL_3_STOCK where Cust_OS<50000000 and ValuationExpiryDate>=@Date
   WITH CUST_OS AS ( SELECT A.RefCustomerId ,
     ...
     GROUP BY A.RefCustomerId ) 
      ...
      FROM A ,tt_RBL_SECURITY_CAL_STOCK_3 A
   ...
   --DELETE tt_RBL_SECURITY_CAL_3_STOCK WHERE stock_audit_date IS NULL and ISNULL(CUST_OS,0)>=50000000
   ...
   ---DELETE tt_RBL_SECURITY_CAL_3_STOCK WHERE  (ValuationExpiryDate_new<'2022-03-22' )
   --or ValuationExpiryDate_new is null )
   ----		SELECT * FROM tt_RBL_SECURITY_CAL_3_STOCK WHERE Customer_ID ='2098381'
   WITH CTE_A AS ( SELECT CUSTOMER_ID ,
                          SecValue_Final ,
                          CollateralID ,
                          ROW_NUMBER() OVER ( PARTITION BY CUSTOMER_ID, CollateralID ORDER BY Customer_ID, CollateralID, SecurityValue  ) RID  
     FROM tt_RBL_SECURITY_CAL_STOCK_3 
    WHERE  ( NVL(CUST_OS, 0) >= 50000000
      ...
      ;
   ----ALTER TABLE tt_RBL_SECURITY_CAL_3 add ValuationExpiryDate_new date
   UPDATE tt_RBL_SECURITY_CAL_3
      SET SecValue_Final = 0
    WHERE  ( ValuationExpiryDate <= v_Date
     OR ( SecurityValue = 0
   ...
   --select * from tt_RBL_SECURITY_CAL_3
   --select * from  tt_RBL_SECURITY_CAL_3_STOCK where ValuationExpiryDate_new<=@Date
...
/
  ...
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "MAIN_PRO";
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "RBL_MISDB_PROD";
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "RBL_STGDB";
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "MAIN_PRO";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "RBL_MISDB_PROD";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "RBL_STGDB";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "ETL_TEMP_RBL_TEMPDB"."ADVSECURITYDETAIL_TEMP_06062023" TO "ADF_CDR_RBL_STGDB";
